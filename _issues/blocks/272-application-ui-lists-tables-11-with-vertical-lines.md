...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-7a122c22da40836b00ab778182dd92ef

Catalog path: Application UI / lists / Tables / variant 11 of 19

## TPM Outcome

Ship `application-ui-lists-tables-11-with-vertical-lines` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `271` and `application-ui-lists-tables-11-with-vertical-lines` are the stable registry identity.
...
- Resolve `BlockId::from_index(271)`, or look up `application-ui-lists-tables-11-with-vertical-lines` with
...
- The registry resolves both block id `271` and slug `application-ui-lists-tables-11-with-vertical-lines` one-to-one.
...
- An isolated `block-application-ui-lists-tables-11-with-vertical-lines` story proves the fixture in both renderers.
