...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-3e6e7ccf78d75f9c513df4663795d6c4

Catalog path: Application UI / navigation / Navbars / variant 6 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-06-with-quick-action` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `381` and `application-ui-navigation-navbars-06-with-quick-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(381)`, or look up `application-ui-navigation-navbars-06-with-quick-action` with
...
- The registry resolves both block id `381` and slug `application-ui-navigation-navbars-06-with-quick-action` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-06-with-quick-action` story proves the fixture in both renderers.
