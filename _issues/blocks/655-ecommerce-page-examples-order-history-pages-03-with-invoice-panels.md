...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-036712a88c6db4f5399b6387356e119a

Catalog path: Ecommerce / page-examples / Order History Pages / variant 3 of 5

## TPM Outcome

Ship `ecommerce-page-examples-order-history-pages-03-with-invoice-panels` as a registered Rust-first block in the Order History Pages family. Preserve
...
- Block index `654` and `ecommerce-page-examples-order-history-pages-03-with-invoice-panels` are the stable registry identity.
...
- Resolve `BlockId::from_index(654)`, or look up `ecommerce-page-examples-order-history-pages-03-with-invoice-panels` with
...
- The registry resolves both block id `654` and slug `ecommerce-page-examples-order-history-pages-03-with-invoice-panels` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-history-pages-03-with-invoice-panels` story proves the fixture in both renderers.
