...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-b5eb58f5c8fd565cc54bf488d647f02b

Catalog path: Marketing / sections / Stats / variant 1 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-01-simple` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `67` and `marketing-sections-stats-sections-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(67)`, or look up `marketing-sections-stats-sections-01-simple` with
...
- The registry resolves both block id `67` and slug `marketing-sections-stats-sections-01-simple` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-01-simple` story proves the fixture in both renderers.
