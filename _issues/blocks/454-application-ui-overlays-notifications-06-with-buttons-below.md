...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/notifications#component-fc4d5d4d23fdbfd7bbd531edf250e93a

Catalog path: Application UI / overlays / Notifications / variant 6 of 6

## TPM Outcome

Ship `application-ui-overlays-notifications-06-with-buttons-below` as a registered Rust-first block in the Notifications family. Preserve
...
- Block index `453` and `application-ui-overlays-notifications-06-with-buttons-below` are the stable registry identity.
...
- Resolve `BlockId::from_index(453)`, or look up `application-ui-overlays-notifications-06-with-buttons-below` with
...
- The registry resolves both block id `453` and slug `application-ui-overlays-notifications-06-with-buttons-below` one-to-one.
...
- An isolated `block-application-ui-overlays-notifications-06-with-buttons-below` story proves the fixture in both renderers.
