...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/checkout-forms#component-b499102417cdeb5454814b13a7828673

Catalog path: Ecommerce / components / Checkout Forms / variant 3 of 5

## TPM Outcome

Ship `ecommerce-components-checkout-forms-03-multi-step` as a registered Rust-first block in the Checkout Forms family. Preserve
...
- Block index `604` and `ecommerce-components-checkout-forms-03-multi-step` are the stable registry identity.
...
- Resolve `BlockId::from_index(604)`, or look up `ecommerce-components-checkout-forms-03-multi-step` with
...
- The registry resolves both block id `604` and slug `ecommerce-components-checkout-forms-03-multi-step` one-to-one.
...
- An isolated `block-ecommerce-components-checkout-forms-03-multi-step` story proves the fixture in both renderers.
