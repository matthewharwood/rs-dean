...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-bd24b64e64a3f09b44de0dde1b76e28f

Catalog path: Application UI / overlays / Drawers / variant 6 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-06-with-sticky-footer` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `441` and `application-ui-overlays-drawers-06-with-sticky-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(441)`, or look up `application-ui-overlays-drawers-06-with-sticky-footer` with
...
- The registry resolves both block id `441` and slug `application-ui-overlays-drawers-06-with-sticky-footer` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-06-with-sticky-footer` story proves the fixture in both renderers.
