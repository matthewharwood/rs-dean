...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/select-menus#component-79592f355ca6f6e3b081e0158109981c

Catalog path: Application UI / forms / Select Menus / variant 1 of 7

## TPM Outcome

Ship `application-ui-forms-select-menus-01-simple-native` as a registered Rust-first block in the Select Menus family. Preserve
...
- Block index `315` and `application-ui-forms-select-menus-01-simple-native` are the stable registry identity.
...
- Resolve `BlockId::from_index(315)`, or look up `application-ui-forms-select-menus-01-simple-native` with
...
- The registry resolves both block id `315` and slug `application-ui-forms-select-menus-01-simple-native` one-to-one.
...
- An isolated `block-application-ui-forms-select-menus-01-simple-native` story proves the fixture in both renderers.
