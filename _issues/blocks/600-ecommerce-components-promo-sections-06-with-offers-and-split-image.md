...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-e63a2b290e3ca2bb6d910b37b4b9a46c

Catalog path: Ecommerce / components / Promo Sections / variant 6 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-06-with-offers-and-split-image` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `599` and `ecommerce-components-promo-sections-06-with-offers-and-split-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(599)`, or look up `ecommerce-components-promo-sections-06-with-offers-and-split-image` with
...
- The registry resolves both block id `599` and slug `ecommerce-components-promo-sections-06-with-offers-and-split-image` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-06-with-offers-and-split-image` story proves the fixture in both renderers.
