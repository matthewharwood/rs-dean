...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-aaed25b299f2015d2c4276b98d463cee

Catalog path: Application UI / navigation / Navbars / variant 5 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-05-simple` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `380` and `application-ui-navigation-navbars-05-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(380)`, or look up `application-ui-navigation-navbars-05-simple` with
...
- The registry resolves both block id `380` and slug `application-ui-navigation-navbars-05-simple` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-05-simple` story proves the fixture in both renderers.
