...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-dc0ccec5b37efa2e9d1407c9e1641077

Catalog path: Application UI / elements / Avatars / variant 3 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-03-circular-avatars-with-top-notification` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `456` and `application-ui-elements-avatars-03-circular-avatars-with-top-notification` are the stable registry identity.
...
- Resolve `BlockId::from_index(456)`, or look up `application-ui-elements-avatars-03-circular-avatars-with-top-notification` with
...
- The registry resolves both block id `456` and slug `application-ui-elements-avatars-03-circular-avatars-with-top-notification` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-03-circular-avatars-with-top-notification` story proves the fixture in both renderers.
