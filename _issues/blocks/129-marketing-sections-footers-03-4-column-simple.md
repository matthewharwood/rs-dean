...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-c5a3339d6971da22d5ffe67aa4fd168b

Catalog path: Marketing / sections / Footers / variant 3 of 7

## TPM Outcome

Ship `marketing-sections-footers-03-4-column-simple` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `128` and `marketing-sections-footers-03-4-column-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(128)`, or look up `marketing-sections-footers-03-4-column-simple` with
...
- The registry resolves both block id `128` and slug `marketing-sections-footers-03-4-column-simple` one-to-one.
...
- An isolated `block-marketing-sections-footers-03-4-column-simple` story proves the fixture in both renderers.
