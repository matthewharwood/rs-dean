...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-276936aa601c0ab9e065e66f22b6e6c0

Catalog path: Application UI / headings / Section Headings / variant 8 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-08-with-inline-tabs` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `224` and `application-ui-headings-section-headings-08-with-inline-tabs` are the stable registry identity.
...
- Resolve `BlockId::from_index(224)`, or look up `application-ui-headings-section-headings-08-with-inline-tabs` with
...
- The registry resolves both block id `224` and slug `application-ui-headings-section-headings-08-with-inline-tabs` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-08-with-inline-tabs` story proves the fixture in both renderers.
