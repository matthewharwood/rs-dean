...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-f9136c8bf0f235dddb7b984590146594

Catalog path: Application UI / navigation / Vertical Navigation / variant 3 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-03-with-icons-and-badges` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `401` and `application-ui-navigation-vertical-navigation-03-with-icons-and-badges` are the stable registry identity.
...
- Resolve `BlockId::from_index(401)`, or look up `application-ui-navigation-vertical-navigation-03-with-icons-and-badges` with
...
- The registry resolves both block id `401` and slug `application-ui-navigation-vertical-navigation-03-with-icons-and-badges` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-03-with-icons-and-badges` story proves the fixture in both renderers.
