...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-df0d5861ae02ee238e7754e835ef283d

Catalog path: Application UI / elements / Avatars / variant 4 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-04-rounded-avatars-with-top-notification` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `457` and `application-ui-elements-avatars-04-rounded-avatars-with-top-notification` are the stable registry identity.
...
- Resolve `BlockId::from_index(457)`, or look up `application-ui-elements-avatars-04-rounded-avatars-with-top-notification` with
...
- The registry resolves both block id `457` and slug `application-ui-elements-avatars-04-rounded-avatars-with-top-notification` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-04-rounded-avatars-with-top-notification` story proves the fixture in both renderers.
