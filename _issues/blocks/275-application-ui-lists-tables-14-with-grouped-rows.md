...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-3fc4f58b97988d00656bc99fbd1a81ae

Catalog path: Application UI / lists / Tables / variant 14 of 19

## TPM Outcome

Ship `application-ui-lists-tables-14-with-grouped-rows` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `274` and `application-ui-lists-tables-14-with-grouped-rows` are the stable registry identity.
...
- Resolve `BlockId::from_index(274)`, or look up `application-ui-lists-tables-14-with-grouped-rows` with
...
- The registry resolves both block id `274` and slug `application-ui-lists-tables-14-with-grouped-rows` one-to-one.
...
- An isolated `block-application-ui-lists-tables-14-with-grouped-rows` story proves the fixture in both renderers.
