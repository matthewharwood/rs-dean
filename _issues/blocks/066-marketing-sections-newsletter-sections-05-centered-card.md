...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/newsletter-sections#component-fc2ec9e02ab2fe1136ea7091f841e79c

Catalog path: Marketing / sections / Newsletter Sections / variant 5 of 6

## TPM Outcome

Ship `marketing-sections-newsletter-sections-05-centered-card` as a registered Rust-first block in the Newsletter Sections family. Preserve
...
- Block index `65` and `marketing-sections-newsletter-sections-05-centered-card` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Panel`, and `Form`
...
- Resolve `BlockId::from_index(65)`, or look up `marketing-sections-newsletter-sections-05-centered-card` with
...
- The registry resolves both block id `65` and slug `marketing-sections-newsletter-sections-05-centered-card` one-to-one.
...
- An isolated `block-marketing-sections-newsletter-sections-05-centered-card` story proves the fixture in both renderers.
