...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/storefront-pages#component-738c2f255a1993e2224c28c461972844

Catalog path: Ecommerce / page-examples / Storefront Pages / variant 3 of 4

## TPM Outcome

Ship `ecommerce-page-examples-storefront-pages-03-with-image-tiles-and-feature-sections` as a registered Rust-first block in the Storefront Pages family. Preserve
...
- Block index `629` and `ecommerce-page-examples-storefront-pages-03-with-image-tiles-and-feature-sections` are the stable registry identity.
...
- Resolve `BlockId::from_index(629)`, or look up `ecommerce-page-examples-storefront-pages-03-with-image-tiles-and-feature-sections` with
...
- The registry resolves both block id `629` and slug `ecommerce-page-examples-storefront-pages-03-with-image-tiles-and-feature-sections` one-to-one.
...
- An isolated `block-ecommerce-page-examples-storefront-pages-03-with-image-tiles-and-feature-sections` story proves the fixture in both renderers.
