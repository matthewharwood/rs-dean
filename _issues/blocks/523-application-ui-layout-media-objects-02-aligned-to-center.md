...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-ef9df725bf54aa2d268260c36ef2bbb5

Catalog path: Application UI / layout / Media Objects / variant 2 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-02-aligned-to-center` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `522` and `application-ui-layout-media-objects-02-aligned-to-center` are the stable registry identity.
...
- Resolve `BlockId::from_index(522)`, or look up `application-ui-layout-media-objects-02-aligned-to-center` with
...
- The registry resolves both block id `522` and slug `application-ui-layout-media-objects-02-aligned-to-center` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-02-aligned-to-center` story proves the fixture in both renderers.
