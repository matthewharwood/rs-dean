...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-a67a35130bba8e2d47e5aeae5a1a82bc

Catalog path: Application UI / forms / Action Panels / variant 8 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-08-with-well` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `359` and `application-ui-forms-action-panels-08-with-well` are the stable registry identity.
...
- Resolve `BlockId::from_index(359)`, or look up `application-ui-forms-action-panels-08-with-well` with
...
- The registry resolves both block id `359` and slug `application-ui-forms-action-panels-08-with-well` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-08-with-well` story proves the fixture in both renderers.
