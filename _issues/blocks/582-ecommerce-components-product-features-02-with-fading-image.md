...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-06554e4a18bf74da3a4d350601b3865d

Catalog path: Ecommerce / components / Product Features / variant 2 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-02-with-fading-image` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `581` and `ecommerce-components-product-features-02-with-fading-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(581)`, or look up `ecommerce-components-product-features-02-with-fading-image` with
...
- The registry resolves both block id `581` and slug `ecommerce-components-product-features-02-with-fading-image` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-02-with-fading-image` story proves the fixture in both renderers.
