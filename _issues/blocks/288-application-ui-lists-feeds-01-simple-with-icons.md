...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/feeds#component-a70becc0d3cc548c2205920a6aa78e94

Catalog path: Application UI / lists / Feeds / variant 1 of 3

## TPM Outcome

Ship `application-ui-lists-feeds-01-simple-with-icons` as a registered Rust-first block in the Feeds family. Preserve
...
- Block index `287` and `application-ui-lists-feeds-01-simple-with-icons` are the stable registry identity.
...
- Resolve `BlockId::from_index(287)`, or look up `application-ui-lists-feeds-01-simple-with-icons` with
...
- The registry resolves both block id `287` and slug `application-ui-lists-feeds-01-simple-with-icons` one-to-one.
...
- An isolated `block-application-ui-lists-feeds-01-simple-with-icons` story proves the fixture in both renderers.
