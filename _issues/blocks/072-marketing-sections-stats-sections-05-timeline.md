...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-7c3226d4ac1d256492e023fd64173099

Catalog path: Marketing / sections / Stats / variant 5 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-05-timeline` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `71` and `marketing-sections-stats-sections-05-timeline` are the stable registry identity.
...
- Resolve `BlockId::from_index(71)`, or look up `marketing-sections-stats-sections-05-timeline` with
...
- The registry resolves both block id `71` and slug `marketing-sections-stats-sections-05-timeline` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-05-timeline` story proves the fixture in both renderers.
