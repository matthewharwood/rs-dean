...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/sign-in-forms#component-55b9c2097342175b8ddfccf8a30fb68f

Catalog path: Application UI / forms / Sign-in and Registration / variant 2 of 4

## TPM Outcome

Ship `application-ui-forms-sign-in-forms-02-simple-no-labels` as a registered Rust-first block in the Sign-in and Registration family. Preserve
...
- Block index `323` and `application-ui-forms-sign-in-forms-02-simple-no-labels` are the stable registry identity.
...
- Resolve `BlockId::from_index(323)`, or look up `application-ui-forms-sign-in-forms-02-simple-no-labels` with
...
- The registry resolves both block id `323` and slug `application-ui-forms-sign-in-forms-02-simple-no-labels` one-to-one.
...
- An isolated `block-application-ui-forms-sign-in-forms-02-simple-no-labels` story proves the fixture in both renderers.
