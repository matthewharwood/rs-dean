...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-724313acc0fc44912588500e01b3c900

Catalog path: Ecommerce / components / Incentives / variant 7 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-07-3-column-with-icons-and-supporting-text` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `625` and `ecommerce-components-incentives-07-3-column-with-icons-and-supporting-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(625)`, or look up `ecommerce-components-incentives-07-3-column-with-icons-and-supporting-text` with
...
- The registry resolves both block id `625` and slug `ecommerce-components-incentives-07-3-column-with-icons-and-supporting-text` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-07-3-column-with-icons-and-supporting-text` story proves the fixture in both renderers.
