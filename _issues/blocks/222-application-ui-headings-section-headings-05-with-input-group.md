...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-df8f39d7313327ae424064d721e61dad

Catalog path: Application UI / headings / Section Headings / variant 5 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-05-with-input-group` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `221` and `application-ui-headings-section-headings-05-with-input-group` are the stable registry identity.
...
- Resolve `BlockId::from_index(221)`, or look up `application-ui-headings-section-headings-05-with-input-group` with
...
- The registry resolves both block id `221` and slug `application-ui-headings-section-headings-05-with-input-group` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-05-with-input-group` story proves the fixture in both renderers.
