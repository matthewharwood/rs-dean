...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-1148f0d6ac25e4cefffa045a48cb4142

Catalog path: Ecommerce / components / Promo Sections / variant 2 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-02-full-width-with-background-image` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `595` and `ecommerce-components-promo-sections-02-full-width-with-background-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(595)`, or look up `ecommerce-components-promo-sections-02-full-width-with-background-image` with
...
- The registry resolves both block id `595` and slug `ecommerce-components-promo-sections-02-full-width-with-background-image` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-02-full-width-with-background-image` story proves the fixture in both renderers.
