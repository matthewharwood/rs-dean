...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-b9407334ee0ee7eacb27cfbb5c08bb46

Catalog path: Application UI / lists / Tables / variant 5 of 19

## TPM Outcome

Ship `application-ui-lists-tables-05-with-striped-rows` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `265` and `application-ui-lists-tables-05-with-striped-rows` are the stable registry identity.
...
- Resolve `BlockId::from_index(265)`, or look up `application-ui-lists-tables-05-with-striped-rows` with
...
- The registry resolves both block id `265` and slug `application-ui-lists-tables-05-with-striped-rows` one-to-one.
...
- An isolated `block-application-ui-lists-tables-05-with-striped-rows` story proves the fixture in both renderers.
