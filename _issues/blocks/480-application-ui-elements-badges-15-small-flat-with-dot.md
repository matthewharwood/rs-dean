...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-8ddfebc65de554620058419c2fcb538d

Catalog path: Application UI / elements / Badges / variant 15 of 16

## TPM Outcome

Ship `application-ui-elements-badges-15-small-flat-with-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `479` and `application-ui-elements-badges-15-small-flat-with-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(479)`, or look up `application-ui-elements-badges-15-small-flat-with-dot` with
...
- The registry resolves both block id `479` and slug `application-ui-elements-badges-15-small-flat-with-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-15-small-flat-with-dot` story proves the fixture in both renderers.
