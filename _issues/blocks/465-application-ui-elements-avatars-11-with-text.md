...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-8b80f3012579843ce76c1c637705ddc8

Catalog path: Application UI / elements / Avatars / variant 11 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-11-with-text` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `464` and `application-ui-elements-avatars-11-with-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(464)`, or look up `application-ui-elements-avatars-11-with-text` with
...
- The registry resolves both block id `464` and slug `application-ui-elements-avatars-11-with-text` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-11-with-text` story proves the fixture in both renderers.
