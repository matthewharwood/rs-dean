...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-f55d785e34cd53505459e68e32af879f

Catalog path: Application UI / navigation / Command Palettes / variant 4 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-04-with-images-and-descriptions` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `425` and `application-ui-navigation-command-palettes-04-with-images-and-descriptions` are the stable registry identity.
...
- Resolve `BlockId::from_index(425)`, or look up `application-ui-navigation-command-palettes-04-with-images-and-descriptions` with
...
- The registry resolves both block id `425` and slug `application-ui-navigation-command-palettes-04-with-images-and-descriptions` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-04-with-images-and-descriptions` story proves the fixture in both renderers.
