...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-overviews#component-3304906f2c7f1cef35c787a7fb586015

Catalog path: Ecommerce / components / Product Overviews / variant 1 of 5

## TPM Outcome

Ship `ecommerce-components-product-overviews-01-with-tiered-images` as a registered Rust-first block in the Product Overviews family. Preserve
...
- Block index `543` and `ecommerce-components-product-overviews-01-with-tiered-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(543)`, or look up `ecommerce-components-product-overviews-01-with-tiered-images` with
...
- The registry resolves both block id `543` and slug `ecommerce-components-product-overviews-01-with-tiered-images` one-to-one.
...
- An isolated `block-ecommerce-components-product-overviews-01-with-tiered-images` story proves the fixture in both renderers.
