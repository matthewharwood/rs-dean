...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-2bdfc390b012b47b869db6a00774de44

Catalog path: Application UI / overlays / Drawers / variant 5 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-05-with-branded-header` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `440` and `application-ui-overlays-drawers-05-with-branded-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(440)`, or look up `application-ui-overlays-drawers-05-with-branded-header` with
...
- The registry resolves both block id `440` and slug `application-ui-overlays-drawers-05-with-branded-header` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-05-with-branded-header` story proves the fixture in both renderers.
