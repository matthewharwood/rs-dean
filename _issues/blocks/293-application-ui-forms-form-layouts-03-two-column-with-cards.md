...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/form-layouts#component-dcf2bee8aa4fbef0d4623df5b9718da8

Catalog path: Application UI / forms / Form Layouts / variant 3 of 4

## TPM Outcome

Ship `application-ui-forms-form-layouts-03-two-column-with-cards` as a registered Rust-first block in the Form Layouts family. Preserve
...
- Block index `292` and `application-ui-forms-form-layouts-03-two-column-with-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(292)`, or look up `application-ui-forms-form-layouts-03-two-column-with-cards` with
...
- The registry resolves both block id `292` and slug `application-ui-forms-form-layouts-03-two-column-with-cards` one-to-one.
...
- An isolated `block-application-ui-forms-form-layouts-03-two-column-with-cards` story proves the fixture in both renderers.
