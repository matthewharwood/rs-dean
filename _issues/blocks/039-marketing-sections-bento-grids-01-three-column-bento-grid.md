...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/bento-grids#component-dc65cfa183921e10d45c401610332cca

Catalog path: Marketing / sections / Bento Grids / variant 1 of 3

## TPM Outcome

Ship `marketing-sections-bento-grids-01-three-column-bento-grid` as a registered Rust-first block in the Bento Grids family. Preserve
...
- Block index `38` and `marketing-sections-bento-grids-01-three-column-bento-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(38)`, or look up `marketing-sections-bento-grids-01-three-column-bento-grid` with
...
- The registry resolves both block id `38` and slug `marketing-sections-bento-grids-01-three-column-bento-grid` one-to-one.
...
- An isolated `block-marketing-sections-bento-grids-01-three-column-bento-grid` story proves the fixture in both renderers.
