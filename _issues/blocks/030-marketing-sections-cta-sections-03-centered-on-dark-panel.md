...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-e96076d46250608ad1a5306c03921371

Catalog path: Marketing / sections / CTA Sections / variant 3 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-03-centered-on-dark-panel` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `29` and `marketing-sections-cta-sections-03-centered-on-dark-panel` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Dark`, and `Actions`
...
- Resolve `BlockId::from_index(29)`, or look up `marketing-sections-cta-sections-03-centered-on-dark-panel` with
...
- The registry resolves both block id `29` and slug `marketing-sections-cta-sections-03-centered-on-dark-panel` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-03-centered-on-dark-panel` story proves the fixture in both renderers.
