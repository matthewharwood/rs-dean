...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/reviews#component-8ccc03eda40cd313b874c7f7ec612f78

Catalog path: Ecommerce / components / Reviews / variant 4 of 4

## TPM Outcome

Ship `ecommerce-components-reviews-04-simple-with-avatars` as a registered Rust-first block in the Reviews family. Preserve
...
- Block index `610` and `ecommerce-components-reviews-04-simple-with-avatars` are the stable registry identity.
...
- Resolve `BlockId::from_index(610)`, or look up `ecommerce-components-reviews-04-simple-with-avatars` with
...
- The registry resolves both block id `610` and slug `ecommerce-components-reviews-04-simple-with-avatars` one-to-one.
...
- An isolated `block-ecommerce-components-reviews-04-simple-with-avatars` story proves the fixture in both renderers.
