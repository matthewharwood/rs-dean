...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-a942eb436b5cdbccfd682861afe44f06

Catalog path: Marketing / sections / Feature Sections / variant 3 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-03-with-large-bordered-screenshot` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `14` and `marketing-sections-feature-sections-03-with-large-bordered-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(14)`, or look up `marketing-sections-feature-sections-03-with-large-bordered-screenshot` with
...
- The registry resolves both block id `14` and slug `marketing-sections-feature-sections-03-with-large-bordered-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-03-with-large-bordered-screenshot` story proves the fixture in both renderers.
