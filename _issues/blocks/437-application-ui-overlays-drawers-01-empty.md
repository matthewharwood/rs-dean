...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-246e69b9fd06741940e3a0081a056868

Catalog path: Application UI / overlays / Drawers / variant 1 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-01-empty` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `436` and `application-ui-overlays-drawers-01-empty` are the stable registry identity.
...
- Resolve `BlockId::from_index(436)`, or look up `application-ui-overlays-drawers-01-empty` with
...
- The registry resolves both block id `436` and slug `application-ui-overlays-drawers-01-empty` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-01-empty` story proves the fixture in both renderers.
