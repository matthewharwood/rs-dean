...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-fb8133472e65a46eb2d7f1acc52f93e5

Catalog path: Application UI / navigation / Progress Bars / variant 8 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-08-progress-bar` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `421` and `application-ui-navigation-progress-bars-08-progress-bar` are the stable registry identity.
...
- The family maps to the `Navigation` composition pattern and the `Progress`
...
- Resolve `BlockId::from_index(421)`, or look up `application-ui-navigation-progress-bars-08-progress-bar` with
...
- The registry resolves both block id `421` and slug `application-ui-navigation-progress-bars-08-progress-bar` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-08-progress-bar` story proves the fixture in both renderers.
