...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-1f277327bc3a818c9212ddb202cc5e0f

Catalog path: Marketing / sections / Content Sections / variant 2 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-02-with-testimonial` as a registered Rust-first block in the Content Sections family. Preserve
...
- Block index `107` and `marketing-sections-content-sections-02-with-testimonial` are the stable registry identity.
...
- Resolve `BlockId::from_index(107)`, or look up `marketing-sections-content-sections-02-with-testimonial` with
...
- The registry resolves both block id `107` and slug `marketing-sections-content-sections-02-with-testimonial` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-02-with-testimonial` story proves the fixture in both renderers.
