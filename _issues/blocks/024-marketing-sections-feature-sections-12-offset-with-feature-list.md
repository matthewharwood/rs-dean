...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-a5dc894550bc75bd777e103badca9345

Catalog path: Marketing / sections / Feature Sections / variant 12 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-12-offset-with-feature-list` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `23` and `marketing-sections-feature-sections-12-offset-with-feature-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(23)`, or look up `marketing-sections-feature-sections-12-offset-with-feature-list` with
...
- The registry resolves both block id `23` and slug `marketing-sections-feature-sections-12-offset-with-feature-list` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-12-offset-with-feature-list` story proves the fixture in both renderers.
