...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-39dd57897ef8e6d37aa07fbbafc188b1

Catalog path: Marketing / elements / Banners / variant 8 of 13

## TPM Outcome

Ship `marketing-elements-banners-08-floating-at-bottom` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `158` and `marketing-elements-banners-08-floating-at-bottom` are the stable registry identity.
...
- Resolve `BlockId::from_index(158)`, or look up `marketing-elements-banners-08-floating-at-bottom` with
...
- The registry resolves both block id `158` and slug `marketing-elements-banners-08-floating-at-bottom` one-to-one.
...
- An isolated `block-marketing-elements-banners-08-floating-at-bottom` story proves the fixture in both renderers.
