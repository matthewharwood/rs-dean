...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-ea718dc11f2660ac97f40ca03b7456a4

Catalog path: Application UI / elements / Badges / variant 4 of 16

## TPM Outcome

Ship `application-ui-elements-badges-04-pill-with-border-and-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `468` and `application-ui-elements-badges-04-pill-with-border-and-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(468)`, or look up `application-ui-elements-badges-04-pill-with-border-and-dot` with
...
- The registry resolves both block id `468` and slug `application-ui-elements-badges-04-pill-with-border-and-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-04-pill-with-border-and-dot` story proves the fixture in both renderers.
