...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-d1e3b922b56cc8aa9454dc33217dda54

Catalog path: Application UI / navigation / Vertical Navigation / variant 1 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-01-simple` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `399` and `application-ui-navigation-vertical-navigation-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(399)`, or look up `application-ui-navigation-vertical-navigation-01-simple` with
...
- The registry resolves both block id `399` and slug `application-ui-navigation-vertical-navigation-01-simple` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-01-simple` story proves the fixture in both renderers.
