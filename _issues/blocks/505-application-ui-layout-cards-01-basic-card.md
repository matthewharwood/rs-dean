...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-59ac96978f0472ddd96179a713dc76bc

Catalog path: Application UI / layout / Cards / variant 1 of 10

## TPM Outcome

Ship `application-ui-layout-cards-01-basic-card` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `504` and `application-ui-layout-cards-01-basic-card` are the stable registry identity.
...
- Resolve `BlockId::from_index(504)`, or look up `application-ui-layout-cards-01-basic-card` with
...
- The registry resolves both block id `504` and slug `application-ui-layout-cards-01-basic-card` one-to-one.
...
- An isolated `block-application-ui-layout-cards-01-basic-card` story proves the fixture in both renderers.
