...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-e112c6098be3cddb51fdefe73581193d

Catalog path: Marketing / sections / Content Sections / variant 3 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-03-with-image-titles` as a registered Rust-first block in the Content Sections family. Preserve
...
- Block index `108` and `marketing-sections-content-sections-03-with-image-titles` are the stable registry identity.
...
- Resolve `BlockId::from_index(108)`, or look up `marketing-sections-content-sections-03-with-image-titles` with
...
- The registry resolves both block id `108` and slug `marketing-sections-content-sections-03-with-image-titles` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-03-with-image-titles` story proves the fixture in both renderers.
