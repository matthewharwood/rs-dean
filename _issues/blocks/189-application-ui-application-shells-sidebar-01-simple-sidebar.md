...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-4fc26b6ea5843dc9b7660d49f19fd5a4

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 1 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-01-simple-sidebar` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `188` and `application-ui-application-shells-sidebar-01-simple-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(188)`, or look up `application-ui-application-shells-sidebar-01-simple-sidebar` with
...
- The registry resolves both block id `188` and slug `application-ui-application-shells-sidebar-01-simple-sidebar` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-01-simple-sidebar` story proves the fixture in both renderers.
