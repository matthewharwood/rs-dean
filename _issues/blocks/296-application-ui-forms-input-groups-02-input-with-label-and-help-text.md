...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-676267bfc6ff8a0e1e198a25207a41d4

Catalog path: Application UI / forms / Input Groups / variant 2 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-02-input-with-label-and-help-text` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `295` and `application-ui-forms-input-groups-02-input-with-label-and-help-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(295)`, or look up `application-ui-forms-input-groups-02-input-with-label-and-help-text` with
...
- The registry resolves both block id `295` and slug `application-ui-forms-input-groups-02-input-with-label-and-help-text` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-02-input-with-label-and-help-text` story proves the fixture in both renderers.
