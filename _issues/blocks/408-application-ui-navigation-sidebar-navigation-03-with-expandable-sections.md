...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/sidebar-navigation#component-34180dd5b86e303286a8aa59b2ca9c34

Catalog path: Application UI / navigation / Sidebar Navigation / variant 3 of 5

## TPM Outcome

Ship `application-ui-navigation-sidebar-navigation-03-with-expandable-sections` as a registered Rust-first block in the Sidebar Navigation family. Preserve
...
- Block index `407` and `application-ui-navigation-sidebar-navigation-03-with-expandable-sections` are the stable registry identity.
...
- Resolve `BlockId::from_index(407)`, or look up `application-ui-navigation-sidebar-navigation-03-with-expandable-sections` with
...
- The registry resolves both block id `407` and slug `application-ui-navigation-sidebar-navigation-03-with-expandable-sections` one-to-one.
...
- An isolated `block-application-ui-navigation-sidebar-navigation-03-with-expandable-sections` story proves the fixture in both renderers.
