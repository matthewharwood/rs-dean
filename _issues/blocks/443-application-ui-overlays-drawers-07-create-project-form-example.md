...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-2036cb51318151226ce814d3e3efea91

Catalog path: Application UI / overlays / Drawers / variant 7 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-07-create-project-form-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `442` and `application-ui-overlays-drawers-07-create-project-form-example` are the stable registry identity.
...
- Resolve `BlockId::from_index(442)`, or look up `application-ui-overlays-drawers-07-create-project-form-example` with
...
- The registry resolves both block id `442` and slug `application-ui-overlays-drawers-07-create-project-form-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-07-create-project-form-example` story proves the fixture in both renderers.
