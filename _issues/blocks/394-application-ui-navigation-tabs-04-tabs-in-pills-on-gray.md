...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-2a66fc822e8ad55f59321825e5af0980

Catalog path: Application UI / navigation / Tabs / variant 4 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-04-tabs-in-pills-on-gray` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `393` and `application-ui-navigation-tabs-04-tabs-in-pills-on-gray` are the stable registry identity.
...
- Resolve `BlockId::from_index(393)`, or look up `application-ui-navigation-tabs-04-tabs-in-pills-on-gray` with
...
- The registry resolves both block id `393` and slug `application-ui-navigation-tabs-04-tabs-in-pills-on-gray` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-04-tabs-in-pills-on-gray` story proves the fixture in both renderers.
