...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-e56f750c63d4e53a24f5f0bf9fd7b52a

Catalog path: Application UI / lists / Tables / variant 7 of 19

## TPM Outcome

Ship `application-ui-lists-tables-07-with-stacked-columns-on-mobile` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `267` and `application-ui-lists-tables-07-with-stacked-columns-on-mobile` are the stable registry identity.
...
- Resolve `BlockId::from_index(267)`, or look up `application-ui-lists-tables-07-with-stacked-columns-on-mobile` with
...
- The registry resolves both block id `267` and slug `application-ui-lists-tables-07-with-stacked-columns-on-mobile` one-to-one.
...
- An isolated `block-application-ui-lists-tables-07-with-stacked-columns-on-mobile` story proves the fixture in both renderers.
