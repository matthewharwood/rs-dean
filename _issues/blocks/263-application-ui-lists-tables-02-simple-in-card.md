...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-4738eac883e67bf84a9f7db2446e838a

Catalog path: Application UI / lists / Tables / variant 2 of 19

## TPM Outcome

Ship `application-ui-lists-tables-02-simple-in-card` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `262` and `application-ui-lists-tables-02-simple-in-card` are the stable registry identity.
...
- Resolve `BlockId::from_index(262)`, or look up `application-ui-lists-tables-02-simple-in-card` with
...
- The registry resolves both block id `262` and slug `application-ui-lists-tables-02-simple-in-card` one-to-one.
...
- An isolated `block-application-ui-lists-tables-02-simple-in-card` story proves the fixture in both renderers.
