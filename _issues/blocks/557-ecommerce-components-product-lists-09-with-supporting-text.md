...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-6fbcf064f526c02be04d422925dfa1df

Catalog path: Ecommerce / components / Product Lists / variant 9 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-09-with-supporting-text` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `556` and `ecommerce-components-product-lists-09-with-supporting-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(556)`, or look up `ecommerce-components-product-lists-09-with-supporting-text` with
...
- The registry resolves both block id `556` and slug `ecommerce-components-product-lists-09-with-supporting-text` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-09-with-supporting-text` story proves the fixture in both renderers.
