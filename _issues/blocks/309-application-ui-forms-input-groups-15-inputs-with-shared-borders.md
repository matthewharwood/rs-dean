...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-647f942cb06b0d760b381e93f3270b7d

Catalog path: Application UI / forms / Input Groups / variant 15 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-15-inputs-with-shared-borders` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `308` and `application-ui-forms-input-groups-15-inputs-with-shared-borders` are the stable registry identity.
...
- Resolve `BlockId::from_index(308)`, or look up `application-ui-forms-input-groups-15-inputs-with-shared-borders` with
...
- The registry resolves both block id `308` and slug `application-ui-forms-input-groups-15-inputs-with-shared-borders` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-15-inputs-with-shared-borders` story proves the fixture in both renderers.
