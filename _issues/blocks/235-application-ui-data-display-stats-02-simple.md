...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/stats#component-0784024584e9897ccb13d2932456484b

Catalog path: Application UI / data-display / Stats / variant 2 of 5

## TPM Outcome

Ship `application-ui-data-display-stats-02-simple` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `234` and `application-ui-data-display-stats-02-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(234)`, or look up `application-ui-data-display-stats-02-simple` with
...
- The registry resolves both block id `234` and slug `application-ui-data-display-stats-02-simple` one-to-one.
...
- An isolated `block-application-ui-data-display-stats-02-simple` story proves the fixture in both renderers.
