...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/feedback/404-pages#component-aed9589b7fc7f9b79887962b5e52b68c

Catalog path: Marketing / feedback / 404 Pages / variant 2 of 5

## TPM Outcome

Ship `marketing-feedback-404-pages-02-split-with-image` as a registered Rust-first block in the 404 Pages family. Preserve
...
- Block index `165` and `marketing-feedback-404-pages-02-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(165)`, or look up `marketing-feedback-404-pages-02-split-with-image` with
...
- The registry resolves both block id `165` and slug `marketing-feedback-404-pages-02-split-with-image` one-to-one.
...
- An isolated `block-marketing-feedback-404-pages-02-split-with-image` story proves the fixture in both renderers.
