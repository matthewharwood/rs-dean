...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-54294e7b86ddf5371565dbdfd133d79c

Catalog path: Marketing / sections / Hero Sections / variant 2 of 12

## TPM Outcome

Ship `marketing-sections-heroes-02-split-with-screenshot` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `1` and `marketing-sections-heroes-02-split-with-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(1)`, or look up `marketing-sections-heroes-02-split-with-screenshot` with
...
- The registry resolves both block id `1` and slug `marketing-sections-heroes-02-split-with-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-heroes-02-split-with-screenshot` story proves the fixture in both renderers.
