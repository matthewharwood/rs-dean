...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-ee415bff6f75c6724103ac0b507c54e2

Catalog path: Application UI / navigation / Progress Bars / variant 3 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-03-bullets` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `416` and `application-ui-navigation-progress-bars-03-bullets` are the stable registry identity.
...
- Resolve `BlockId::from_index(416)`, or look up `application-ui-navigation-progress-bars-03-bullets` with
...
- The registry resolves both block id `416` and slug `application-ui-navigation-progress-bars-03-bullets` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-03-bullets` story proves the fixture in both renderers.
