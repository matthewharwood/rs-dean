...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-63e98de50900fa979f5a327cb209baf0

Catalog path: Marketing / sections / Feature Sections / variant 2 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-02-with-large-screenshot` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `13` and `marketing-sections-feature-sections-02-with-large-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(13)`, or look up `marketing-sections-feature-sections-02-with-large-screenshot` with
...
- The registry resolves both block id `13` and slug `marketing-sections-feature-sections-02-with-large-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-02-with-large-screenshot` story proves the fixture in both renderers.
