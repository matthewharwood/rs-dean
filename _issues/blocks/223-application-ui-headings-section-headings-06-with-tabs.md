...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-0174a6f43f8fd733c731085e1f8f009a

Catalog path: Application UI / headings / Section Headings / variant 6 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-06-with-tabs` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `222` and `application-ui-headings-section-headings-06-with-tabs` are the stable registry identity.
...
- Resolve `BlockId::from_index(222)`, or look up `application-ui-headings-section-headings-06-with-tabs` with
...
- The registry resolves both block id `222` and slug `application-ui-headings-section-headings-06-with-tabs` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-06-with-tabs` story proves the fixture in both renderers.
