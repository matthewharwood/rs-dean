...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-515b7da735d10f08492eeb525b0fac38

Catalog path: Application UI / lists / Stacked Lists / variant 13 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-13-narrow-with-truncated-content` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `258` and `application-ui-lists-stacked-lists-13-narrow-with-truncated-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(258)`, or look up `application-ui-lists-stacked-lists-13-narrow-with-truncated-content` with
...
- The registry resolves both block id `258` and slug `application-ui-lists-stacked-lists-13-narrow-with-truncated-content` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-13-narrow-with-truncated-content` story proves the fixture in both renderers.
