...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/notifications#component-8960ebee918a39c1a753da4d378c0f96

Catalog path: Application UI / overlays / Notifications / variant 2 of 6

## TPM Outcome

Ship `application-ui-overlays-notifications-02-condensed` as a registered Rust-first block in the Notifications family. Preserve
...
- Block index `449` and `application-ui-overlays-notifications-02-condensed` are the stable registry identity.
...
- Resolve `BlockId::from_index(449)`, or look up `application-ui-overlays-notifications-02-condensed` with
...
- The registry resolves both block id `449` and slug `application-ui-overlays-notifications-02-condensed` one-to-one.
...
- An isolated `block-application-ui-overlays-notifications-02-condensed` story proves the fixture in both renderers.
