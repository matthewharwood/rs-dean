...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-1b6c2fdf05472f8dcea7057074492fd6

Catalog path: Application UI / application-shells / Stacked Layouts / variant 4 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-04-branded-nav-with-compact-lighter-page-header` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `182` and `application-ui-application-shells-stacked-04-branded-nav-with-compact-lighter-page-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(182)`, or look up `application-ui-application-shells-stacked-04-branded-nav-with-compact-lighter-page-header` with
...
- The registry resolves both block id `182` and slug `application-ui-application-shells-stacked-04-branded-nav-with-compact-lighter-page-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-04-branded-nav-with-compact-lighter-page-header` story proves the fixture in both renderers.
