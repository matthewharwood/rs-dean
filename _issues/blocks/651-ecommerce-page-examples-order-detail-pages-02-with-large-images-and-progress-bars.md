...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-detail-pages#component-4138a5d042bc0fa0df5e8f86d25b1151

Catalog path: Ecommerce / page-examples / Order Detail Pages / variant 2 of 3

## TPM Outcome

Ship `ecommerce-page-examples-order-detail-pages-02-with-large-images-and-progress-bars` as a registered Rust-first block in the Order Detail Pages family. Preserve
...
- Block index `650` and `ecommerce-page-examples-order-detail-pages-02-with-large-images-and-progress-bars` are the stable registry identity.
...
- Resolve `BlockId::from_index(650)`, or look up `ecommerce-page-examples-order-detail-pages-02-with-large-images-and-progress-bars` with
...
- The registry resolves both block id `650` and slug `ecommerce-page-examples-order-detail-pages-02-with-large-images-and-progress-bars` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-detail-pages-02-with-large-images-and-progress-bars` story proves the fixture in both renderers.
