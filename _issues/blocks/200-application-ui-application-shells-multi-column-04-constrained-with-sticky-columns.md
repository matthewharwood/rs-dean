...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-00881f00b48af67e0054c54fd18cad58

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 4 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-04-constrained-with-sticky-columns` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
...
- Block index `199` and `application-ui-application-shells-multi-column-04-constrained-with-sticky-columns` are the stable registry identity.
...
- Resolve `BlockId::from_index(199)`, or look up `application-ui-application-shells-multi-column-04-constrained-with-sticky-columns` with
...
- The registry resolves both block id `199` and slug `application-ui-application-shells-multi-column-04-constrained-with-sticky-columns` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-04-constrained-with-sticky-columns` story proves the fixture in both renderers.
