...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/reviews#component-8507b37851ab6df2d36b6ae3f4e7c8cf

Catalog path: Ecommerce / components / Reviews / variant 3 of 4

## TPM Outcome

Ship `ecommerce-components-reviews-03-avatars-with-separate-description` as a registered Rust-first block in the Reviews family. Preserve
...
- Block index `609` and `ecommerce-components-reviews-03-avatars-with-separate-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(609)`, or look up `ecommerce-components-reviews-03-avatars-with-separate-description` with
...
- The registry resolves both block id `609` and slug `ecommerce-components-reviews-03-avatars-with-separate-description` one-to-one.
...
- An isolated `block-ecommerce-components-reviews-03-avatars-with-separate-description` story proves the fixture in both renderers.
