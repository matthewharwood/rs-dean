...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-2d5d20e54ee541d2b42b7c02457850df

Catalog path: Ecommerce / components / Incentives / variant 3 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-03-3-column-with-illustrations-and-header` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `621` and `ecommerce-components-incentives-03-3-column-with-illustrations-and-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(621)`, or look up `ecommerce-components-incentives-03-3-column-with-illustrations-and-header` with
...
- The registry resolves both block id `621` and slug `ecommerce-components-incentives-03-3-column-with-illustrations-and-header` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-03-3-column-with-illustrations-and-header` story proves the fixture in both renderers.
