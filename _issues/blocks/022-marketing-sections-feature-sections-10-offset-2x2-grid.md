...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-a49bfb9517be12ba0fe0dd841c3a8766

Catalog path: Marketing / sections / Feature Sections / variant 10 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-10-offset-2x2-grid` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `21` and `marketing-sections-feature-sections-10-offset-2x2-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(21)`, or look up `marketing-sections-feature-sections-10-offset-2x2-grid` with
...
- The registry resolves both block id `21` and slug `marketing-sections-feature-sections-10-offset-2x2-grid` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-10-offset-2x2-grid` story proves the fixture in both renderers.
