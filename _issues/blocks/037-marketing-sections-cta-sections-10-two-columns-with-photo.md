...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-5f235b346d3762796ec90ba3246446fd

Catalog path: Marketing / sections / CTA Sections / variant 10 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-10-two-columns-with-photo` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `36` and `marketing-sections-cta-sections-10-two-columns-with-photo` are the stable registry identity.
...
- Resolve `BlockId::from_index(36)`, or look up `marketing-sections-cta-sections-10-two-columns-with-photo` with
...
- The registry resolves both block id `36` and slug `marketing-sections-cta-sections-10-two-columns-with-photo` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-10-two-columns-with-photo` story proves the fixture in both renderers.
