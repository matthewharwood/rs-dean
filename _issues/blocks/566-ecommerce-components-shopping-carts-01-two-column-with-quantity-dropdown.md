...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/shopping-carts#component-62d97a81daaa3dbe21ece61a58cdd0f8

Catalog path: Ecommerce / components / Shopping Carts / variant 1 of 6

## TPM Outcome

Ship `ecommerce-components-shopping-carts-01-two-column-with-quantity-dropdown` as a registered Rust-first block in the Shopping Carts family. Preserve
...
- Block index `565` and `ecommerce-components-shopping-carts-01-two-column-with-quantity-dropdown` are the stable registry identity.
...
- Resolve `BlockId::from_index(565)`, or look up `ecommerce-components-shopping-carts-01-two-column-with-quantity-dropdown` with
...
- The registry resolves both block id `565` and slug `ecommerce-components-shopping-carts-01-two-column-with-quantity-dropdown` one-to-one.
...
- An isolated `block-ecommerce-components-shopping-carts-01-two-column-with-quantity-dropdown` story proves the fixture in both renderers.
