...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-36f3508cee13455826b0b385df0d5b49

Catalog path: Application UI / lists / Stacked Lists / variant 9 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-09-full-width-with-constrained-content` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `254` and `application-ui-lists-stacked-lists-09-full-width-with-constrained-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(254)`, or look up `application-ui-lists-stacked-lists-09-full-width-with-constrained-content` with
...
- The registry resolves both block id `254` and slug `application-ui-lists-stacked-lists-09-full-width-with-constrained-content` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-09-full-width-with-constrained-content` story proves the fixture in both renderers.
