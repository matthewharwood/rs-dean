...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/feedback/404-pages#component-9e31dc71bccd709e04de0ed11a1328b0

Catalog path: Marketing / feedback / 404 Pages / variant 4 of 5

## TPM Outcome

Ship `marketing-feedback-404-pages-04-with-background-image` as a registered Rust-first block in the 404 Pages family. Preserve
...
- Block index `167` and `marketing-feedback-404-pages-04-with-background-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(167)`, or look up `marketing-feedback-404-pages-04-with-background-image` with
...
- The registry resolves both block id `167` and slug `marketing-feedback-404-pages-04-with-background-image` one-to-one.
...
- An isolated `block-marketing-feedback-404-pages-04-with-background-image` story proves the fixture in both renderers.
