...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/checkboxes#component-744ed4fa65ba36b925701eb4da5c6e31

Catalog path: Application UI / forms / Checkboxes / variant 2 of 4

## TPM Outcome

Ship `application-ui-forms-checkboxes-02-list-with-inline-description` as a registered Rust-first block in the Checkboxes family. Preserve
...
- Block index `344` and `application-ui-forms-checkboxes-02-list-with-inline-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(344)`, or look up `application-ui-forms-checkboxes-02-list-with-inline-description` with
...
- The registry resolves both block id `344` and slug `application-ui-forms-checkboxes-02-list-with-inline-description` one-to-one.
...
- An isolated `block-application-ui-forms-checkboxes-02-list-with-inline-description` story proves the fixture in both renderers.
