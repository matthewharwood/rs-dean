...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/about-pages#component-239fe694f775611a8953ef4b02d6a4da

Catalog path: Marketing / page-examples / About Pages / variant 1 of 3

## TPM Outcome

Ship `marketing-page-examples-about-pages-01-with-image-tiles` as a registered Rust-first block in the About Pages family. Preserve
...
- Block index `176` and `marketing-page-examples-about-pages-01-with-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(176)`, or look up `marketing-page-examples-about-pages-01-with-image-tiles` with
...
- The registry resolves both block id `176` and slug `marketing-page-examples-about-pages-01-with-image-tiles` one-to-one.
...
- An isolated `block-marketing-page-examples-about-pages-01-with-image-tiles` story proves the fixture in both renderers.
