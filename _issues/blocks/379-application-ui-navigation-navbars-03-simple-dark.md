...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-1f0fd3139f66c75457637ca3746e3384

Catalog path: Application UI / navigation / Navbars / variant 3 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-03-simple-dark` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `378` and `application-ui-navigation-navbars-03-simple-dark` are the stable registry identity.
...
- Resolve `BlockId::from_index(378)`, or look up `application-ui-navigation-navbars-03-simple-dark` with
...
- The registry resolves both block id `378` and slug `application-ui-navigation-navbars-03-simple-dark` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-03-simple-dark` story proves the fixture in both renderers.
