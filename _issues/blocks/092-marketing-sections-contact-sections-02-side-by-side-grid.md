...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-b7a60fe9c1034409a2af488d723701a9

Catalog path: Marketing / sections / Contact Sections / variant 2 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-02-side-by-side-grid` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `91` and `marketing-sections-contact-sections-02-side-by-side-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(91)`, or look up `marketing-sections-contact-sections-02-side-by-side-grid` with
...
- The registry resolves both block id `91` and slug `marketing-sections-contact-sections-02-side-by-side-grid` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-02-side-by-side-grid` story proves the fixture in both renderers.
