...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/empty-states#component-42930c785190e14c24b53ba822f4a92c

Catalog path: Application UI / feedback / Empty States / variant 1 of 6

## TPM Outcome

Ship `application-ui-feedback-empty-states-01-simple` as a registered Rust-first block in the Empty States family. Preserve
...
- Block index `370` and `application-ui-feedback-empty-states-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(370)`, or look up `application-ui-feedback-empty-states-01-simple` with
...
- The registry resolves both block id `370` and slug `application-ui-feedback-empty-states-01-simple` one-to-one.
...
- An isolated `block-application-ui-feedback-empty-states-01-simple` story proves the fixture in both renderers.
