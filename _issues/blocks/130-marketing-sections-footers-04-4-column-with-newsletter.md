...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-38c15f2c35def7c2c555175450d1448e

Catalog path: Marketing / sections / Footers / variant 4 of 7

## TPM Outcome

Ship `marketing-sections-footers-04-4-column-with-newsletter` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `129` and `marketing-sections-footers-04-4-column-with-newsletter` are the stable registry identity.
...
- Resolve `BlockId::from_index(129)`, or look up `marketing-sections-footers-04-4-column-with-newsletter` with
...
- The registry resolves both block id `129` and slug `marketing-sections-footers-04-4-column-with-newsletter` one-to-one.
...
- An isolated `block-marketing-sections-footers-04-4-column-with-newsletter` story proves the fixture in both renderers.
