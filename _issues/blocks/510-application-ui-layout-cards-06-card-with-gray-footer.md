...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-9a3fd87f12f86dde0c5be88a9af1f6d8

Catalog path: Application UI / layout / Cards / variant 6 of 10

## TPM Outcome

Ship `application-ui-layout-cards-06-card-with-gray-footer` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `509` and `application-ui-layout-cards-06-card-with-gray-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(509)`, or look up `application-ui-layout-cards-06-card-with-gray-footer` with
...
- The registry resolves both block id `509` and slug `application-ui-layout-cards-06-card-with-gray-footer` one-to-one.
...
- An isolated `block-application-ui-layout-cards-06-card-with-gray-footer` story proves the fixture in both renderers.
