...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/pricing-pages#component-fdbb8458107ec56935f49e41d1ebec70

Catalog path: Marketing / page-examples / Pricing Pages / variant 1 of 3

## TPM Outcome

Ship `marketing-page-examples-pricing-pages-01-with-four-tiers` as a registered Rust-first block in the Pricing Pages family. Preserve
...
- Block index `173` and `marketing-page-examples-pricing-pages-01-with-four-tiers` are the stable registry identity.
...
- Resolve `BlockId::from_index(173)`, or look up `marketing-page-examples-pricing-pages-01-with-four-tiers` with
...
- The registry resolves both block id `173` and slug `marketing-page-examples-pricing-pages-01-with-four-tiers` one-to-one.
...
- An isolated `block-marketing-page-examples-pricing-pages-01-with-four-tiers` story proves the fixture in both renderers.
