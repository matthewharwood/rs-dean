...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/containers#component-19e43f3ad1f1f984ec0c02bdb305353f

Catalog path: Application UI / layout / Containers / variant 5 of 5

## TPM Outcome

Ship `application-ui-layout-containers-05-narrow-constrained-with-padded-content` as a registered Rust-first block in the Containers family. Preserve
...
- Block index `503` and `application-ui-layout-containers-05-narrow-constrained-with-padded-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(503)`, or look up `application-ui-layout-containers-05-narrow-constrained-with-padded-content` with
...
- The registry resolves both block id `503` and slug `application-ui-layout-containers-05-narrow-constrained-with-padded-content` one-to-one.
...
- An isolated `block-application-ui-layout-containers-05-narrow-constrained-with-padded-content` story proves the fixture in both renderers.
