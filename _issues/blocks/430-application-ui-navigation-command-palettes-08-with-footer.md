...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-540bdf1e4a0e2ec2f667a2c7c123ff0f

Catalog path: Application UI / navigation / Command Palettes / variant 8 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-08-with-footer` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `429` and `application-ui-navigation-command-palettes-08-with-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(429)`, or look up `application-ui-navigation-command-palettes-08-with-footer` with
...
- The registry resolves both block id `429` and slug `application-ui-navigation-command-palettes-08-with-footer` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-08-with-footer` story proves the fixture in both renderers.
