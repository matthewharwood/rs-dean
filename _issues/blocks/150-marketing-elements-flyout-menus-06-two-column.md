...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-25601925ae83e51e1b31d3bd1c286515

Catalog path: Marketing / elements / Flyout Menus / variant 6 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-06-two-column` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `149` and `marketing-elements-flyout-menus-06-two-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(149)`, or look up `marketing-elements-flyout-menus-06-two-column` with
...
- The registry resolves both block id `149` and slug `marketing-elements-flyout-menus-06-two-column` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-06-two-column` story proves the fixture in both renderers.
