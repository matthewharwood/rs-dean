...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-fa5d8b35366e1921290491bd08878e0b

Catalog path: Application UI / lists / Tables / variant 12 of 19

## TPM Outcome

Ship `application-ui-lists-tables-12-with-condensed-content` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `272` and `application-ui-lists-tables-12-with-condensed-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(272)`, or look up `application-ui-lists-tables-12-with-condensed-content` with
...
- The registry resolves both block id `272` and slug `application-ui-lists-tables-12-with-condensed-content` one-to-one.
...
- An isolated `block-application-ui-lists-tables-12-with-condensed-content` story proves the fixture in both renderers.
