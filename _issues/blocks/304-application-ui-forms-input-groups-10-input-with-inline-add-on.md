...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-3620fb44e0a49ebce229526254018508

Catalog path: Application UI / forms / Input Groups / variant 10 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-10-input-with-inline-add-on` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `303` and `application-ui-forms-input-groups-10-input-with-inline-add-on` are the stable registry identity.
...
- Resolve `BlockId::from_index(303)`, or look up `application-ui-forms-input-groups-10-input-with-inline-add-on` with
...
- The registry resolves both block id `303` and slug `application-ui-forms-input-groups-10-input-with-inline-add-on` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-10-input-with-inline-add-on` story proves the fixture in both renderers.
