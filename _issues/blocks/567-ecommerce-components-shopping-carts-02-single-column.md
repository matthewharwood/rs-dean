...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/shopping-carts#component-8854bb30c830fd9b5a4838f3c11e8ce8

Catalog path: Ecommerce / components / Shopping Carts / variant 2 of 6

## TPM Outcome

Ship `ecommerce-components-shopping-carts-02-single-column` as a registered Rust-first block in the Shopping Carts family. Preserve
...
- Block index `566` and `ecommerce-components-shopping-carts-02-single-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(566)`, or look up `ecommerce-components-shopping-carts-02-single-column` with
...
- The registry resolves both block id `566` and slug `ecommerce-components-shopping-carts-02-single-column` one-to-one.
...
- An isolated `block-ecommerce-components-shopping-carts-02-single-column` story proves the fixture in both renderers.
