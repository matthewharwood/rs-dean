...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-1e154eaf2b7dec0fb78a1e71e77780ab

Catalog path: Application UI / forms / Input Groups / variant 5 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-05-input-with-hidden-label` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `298` and `application-ui-forms-input-groups-05-input-with-hidden-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(298)`, or look up `application-ui-forms-input-groups-05-input-with-hidden-label` with
...
- The registry resolves both block id `298` and slug `application-ui-forms-input-groups-05-input-with-hidden-label` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-05-input-with-hidden-label` story proves the fixture in both renderers.
