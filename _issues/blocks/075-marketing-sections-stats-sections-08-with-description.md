...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-d6e7447b0fced461b1de5660124a2311

Catalog path: Marketing / sections / Stats / variant 8 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-08-with-description` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `74` and `marketing-sections-stats-sections-08-with-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(74)`, or look up `marketing-sections-stats-sections-08-with-description` with
...
- The registry resolves both block id `74` and slug `marketing-sections-stats-sections-08-with-description` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-08-with-description` story proves the fixture in both renderers.
