...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/settings-screens#component-caa8ef7bf6e8809077b5f2d91a57dabb

Catalog path: Application UI / page-examples / Settings Screens / variant 2 of 2

## TPM Outcome

Ship `application-ui-page-examples-settings-screens-02-stacked` as a registered Rust-first block in the Settings Screens family. Preserve
...
- Block index `542` and `application-ui-page-examples-settings-screens-02-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(542)`, or look up `application-ui-page-examples-settings-screens-02-stacked` with
...
- The registry resolves both block id `542` and slug `application-ui-page-examples-settings-screens-02-stacked` one-to-one.
...
- An isolated `block-application-ui-page-examples-settings-screens-02-stacked` story proves the fixture in both renderers.
