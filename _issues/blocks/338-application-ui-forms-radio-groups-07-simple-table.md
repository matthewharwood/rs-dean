...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-4bf0d3a6dd46681182cd9e2d9bc2af66

Catalog path: Application UI / forms / Radio Groups / variant 7 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-07-simple-table` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `337` and `application-ui-forms-radio-groups-07-simple-table` are the stable registry identity.
...
- Resolve `BlockId::from_index(337)`, or look up `application-ui-forms-radio-groups-07-simple-table` with
...
- The registry resolves both block id `337` and slug `application-ui-forms-radio-groups-07-simple-table` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-07-simple-table` story proves the fixture in both renderers.
