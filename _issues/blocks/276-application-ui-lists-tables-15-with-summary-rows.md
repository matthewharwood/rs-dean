...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-78248cc564cd1fd14d6ff65b461cbab1

Catalog path: Application UI / lists / Tables / variant 15 of 19

## TPM Outcome

Ship `application-ui-lists-tables-15-with-summary-rows` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `275` and `application-ui-lists-tables-15-with-summary-rows` are the stable registry identity.
...
- Resolve `BlockId::from_index(275)`, or look up `application-ui-lists-tables-15-with-summary-rows` with
...
- The registry resolves both block id `275` and slug `application-ui-lists-tables-15-with-summary-rows` one-to-one.
...
- An isolated `block-application-ui-lists-tables-15-with-summary-rows` story proves the fixture in both renderers.
