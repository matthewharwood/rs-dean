...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/pagination#component-0797a02a34692167c369d134e7a6f9c5

Catalog path: Application UI / navigation / Pagination / variant 3 of 3

## TPM Outcome

Ship `application-ui-navigation-pagination-03-simple-card-footer` as a registered Rust-first block in the Pagination family. Preserve
...
- Block index `389` and `application-ui-navigation-pagination-03-simple-card-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(389)`, or look up `application-ui-navigation-pagination-03-simple-card-footer` with
...
- The registry resolves both block id `389` and slug `application-ui-navigation-pagination-03-simple-card-footer` one-to-one.
...
- An isolated `block-application-ui-navigation-pagination-03-simple-card-footer` story proves the fixture in both renderers.
