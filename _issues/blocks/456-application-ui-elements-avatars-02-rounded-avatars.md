...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-9cff93d948a6264de59b1ad670b22203

Catalog path: Application UI / elements / Avatars / variant 2 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-02-rounded-avatars` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `455` and `application-ui-elements-avatars-02-rounded-avatars` are the stable registry identity.
...
- Resolve `BlockId::from_index(455)`, or look up `application-ui-elements-avatars-02-rounded-avatars` with
...
- The registry resolves both block id `455` and slug `application-ui-elements-avatars-02-rounded-avatars` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-02-rounded-avatars` story proves the fixture in both renderers.
