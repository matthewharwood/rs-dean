...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/shopping-cart-pages#component-27394145c10deb90e94d468d3fcbb4c5

Catalog path: Ecommerce / page-examples / Shopping Cart Pages / variant 3 of 3

## TPM Outcome

Ship `ecommerce-page-examples-shopping-cart-pages-03-with-policy-grid-and-extended-summary` as a registered Rust-first block in the Shopping Cart Pages family. Preserve
...
- Block index `643` and `ecommerce-page-examples-shopping-cart-pages-03-with-policy-grid-and-extended-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(643)`, or look up `ecommerce-page-examples-shopping-cart-pages-03-with-policy-grid-and-extended-summary` with
...
- The registry resolves both block id `643` and slug `ecommerce-page-examples-shopping-cart-pages-03-with-policy-grid-and-extended-summary` one-to-one.
...
- An isolated `block-ecommerce-page-examples-shopping-cart-pages-03-with-policy-grid-and-extended-summary` story proves the fixture in both renderers.
