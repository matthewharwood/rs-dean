...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-history#component-c97bbf5844d75fd64a5a7572661a5b59

Catalog path: Ecommerce / components / Order History / variant 2 of 4

## TPM Outcome

Ship `ecommerce-components-order-history-02-invoice-table` as a registered Rust-first block in the Order History family. Preserve
...
- Block index `616` and `ecommerce-components-order-history-02-invoice-table` are the stable registry identity.
...
- Resolve `BlockId::from_index(616)`, or look up `ecommerce-components-order-history-02-invoice-table` with
...
- The registry resolves both block id `616` and slug `ecommerce-components-order-history-02-invoice-table` one-to-one.
...
- An isolated `block-ecommerce-components-order-history-02-invoice-table` story proves the fixture in both renderers.
