...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/select-menus#component-d47b46d3ffea1f6b159f51be4bcae2ff

Catalog path: Application UI / forms / Select Menus / variant 7 of 7

## TPM Outcome

Ship `application-ui-forms-select-menus-07-branded-with-supported-text` as a registered Rust-first block in the Select Menus family. Preserve
...
- Block index `321` and `application-ui-forms-select-menus-07-branded-with-supported-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(321)`, or look up `application-ui-forms-select-menus-07-branded-with-supported-text` with
...
- The registry resolves both block id `321` and slug `application-ui-forms-select-menus-07-branded-with-supported-text` one-to-one.
...
- An isolated `block-application-ui-forms-select-menus-07-branded-with-supported-text` story proves the fixture in both renderers.
