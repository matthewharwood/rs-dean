...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-2a69ab332ebd841f856edc339ceb654d

Catalog path: Ecommerce / components / Product Lists / variant 8 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-08-with-border-grid` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `555` and `ecommerce-components-product-lists-08-with-border-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(555)`, or look up `ecommerce-components-product-lists-08-with-border-grid` with
...
- The registry resolves both block id `555` and slug `ecommerce-components-product-lists-08-with-border-grid` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-08-with-border-grid` story proves the fixture in both renderers.
