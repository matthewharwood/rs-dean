...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-6bd457a8f982faa1eca40d712ab7278b

Catalog path: Marketing / sections / Contact Sections / variant 7 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-07-split-with-image` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `96` and `marketing-sections-contact-sections-07-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(96)`, or look up `marketing-sections-contact-sections-07-split-with-image` with
...
- The registry resolves both block id `96` and slug `marketing-sections-contact-sections-07-split-with-image` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-07-split-with-image` story proves the fixture in both renderers.
