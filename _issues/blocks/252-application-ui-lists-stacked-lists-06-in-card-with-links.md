...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-f0f183415de745e81fa742d6e1df9e04

Catalog path: Application UI / lists / Stacked Lists / variant 6 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-06-in-card-with-links` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `251` and `application-ui-lists-stacked-lists-06-in-card-with-links` are the stable registry identity.
...
- Resolve `BlockId::from_index(251)`, or look up `application-ui-lists-stacked-lists-06-in-card-with-links` with
...
- The registry resolves both block id `251` and slug `application-ui-lists-stacked-lists-06-in-card-with-links` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-06-in-card-with-links` story proves the fixture in both renderers.
