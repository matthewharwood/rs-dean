...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-4b1efed043d1ab5688c705f2e27524f3

Catalog path: Application UI / navigation / Progress Bars / variant 5 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-05-circles` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `418` and `application-ui-navigation-progress-bars-05-circles` are the stable registry identity.
...
- Resolve `BlockId::from_index(418)`, or look up `application-ui-navigation-progress-bars-05-circles` with
...
- The registry resolves both block id `418` and slug `application-ui-navigation-progress-bars-05-circles` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-05-circles` story proves the fixture in both renderers.
