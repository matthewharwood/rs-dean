...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/checkout-pages#component-e3be93f395963562b4832221362b6d58

Catalog path: Ecommerce / page-examples / Checkout Pages / variant 4 of 5

## TPM Outcome

Ship `ecommerce-page-examples-checkout-pages-04-multi-step` as a registered Rust-first block in the Checkout Pages family. Preserve
...
- Block index `647` and `ecommerce-page-examples-checkout-pages-04-multi-step` are the stable registry identity.
...
- Resolve `BlockId::from_index(647)`, or look up `ecommerce-page-examples-checkout-pages-04-multi-step` with
...
- The registry resolves both block id `647` and slug `ecommerce-page-examples-checkout-pages-04-multi-step` one-to-one.
...
- An isolated `block-ecommerce-page-examples-checkout-pages-04-multi-step` story proves the fixture in both renderers.
