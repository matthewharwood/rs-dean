...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-1f407cdd33b17a2fc24966b27bea7890

Catalog path: Ecommerce / components / Category Previews / variant 3 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-03-with-background-image-and-detail-overlay` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `561` and `ecommerce-components-category-previews-03-with-background-image-and-detail-overlay` are the stable registry identity.
...
- Variant behavior is constrained by `Background image`, `Plain`, and `Overlay`
...
- Resolve `BlockId::from_index(561)`, or look up `ecommerce-components-category-previews-03-with-background-image-and-detail-overlay` with
...
- The registry resolves both block id `561` and slug `ecommerce-components-category-previews-03-with-background-image-and-detail-overlay` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-03-with-background-image-and-detail-overlay` story proves the fixture in both renderers.
