...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-a04b3cc22764976dff2cca9f8f420e43

Catalog path: Ecommerce / page-examples / Order History Pages / variant 4 of 5

## TPM Outcome

Ship `ecommerce-page-examples-order-history-pages-04-with-invoice-tables` as a registered Rust-first block in the Order History Pages family. Preserve
...
- Block index `655` and `ecommerce-page-examples-order-history-pages-04-with-invoice-tables` are the stable registry identity.
...
- Resolve `BlockId::from_index(655)`, or look up `ecommerce-page-examples-order-history-pages-04-with-invoice-tables` with
...
- The registry resolves both block id `655` and slug `ecommerce-page-examples-order-history-pages-04-with-invoice-tables` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-history-pages-04-with-invoice-tables` story proves the fixture in both renderers.
