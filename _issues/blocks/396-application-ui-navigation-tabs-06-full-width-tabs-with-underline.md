...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-7c429fe94a1fc0801cfd429c3b507c12

Catalog path: Application UI / navigation / Tabs / variant 6 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-06-full-width-tabs-with-underline` as a registered Rust-first block in the Tabs family. Preserve
...
- Apply the typed `No media` media mode, `Plain` surface treatment, and
  `Tabs` interaction contract without adding one-off classes.
...
- Block index `395` and `application-ui-navigation-tabs-06-full-width-tabs-with-underline` are the stable registry identity.
...
- The family maps to the `Navigation` composition pattern and the `Tabs`
  primary UI component.
- Variant behavior is constrained by `No media`, `Plain`, and `Tabs`
...
- Resolve `BlockId::from_index(395)`, or look up `application-ui-navigation-tabs-06-full-width-tabs-with-underline` with
...
- The registry resolves both block id `395` and slug `application-ui-navigation-tabs-06-full-width-tabs-with-underline` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-06-full-width-tabs-with-underline` story proves the fixture in both renderers.
