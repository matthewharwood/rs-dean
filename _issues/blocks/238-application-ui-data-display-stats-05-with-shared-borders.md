...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/stats#component-72704cac437a06d94cdb941c274591ba

Catalog path: Application UI / data-display / Stats / variant 5 of 5

## TPM Outcome

Ship `application-ui-data-display-stats-05-with-shared-borders` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `237` and `application-ui-data-display-stats-05-with-shared-borders` are the stable registry identity.
...
- Resolve `BlockId::from_index(237)`, or look up `application-ui-data-display-stats-05-with-shared-borders` with
...
- The registry resolves both block id `237` and slug `application-ui-data-display-stats-05-with-shared-borders` one-to-one.
...
- An isolated `block-application-ui-data-display-stats-05-with-shared-borders` story proves the fixture in both renderers.
