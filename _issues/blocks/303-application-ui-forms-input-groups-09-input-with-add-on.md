...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-1ef4d534fa0cbcb38331bafa5c352ff8

Catalog path: Application UI / forms / Input Groups / variant 9 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-09-input-with-add-on` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `302` and `application-ui-forms-input-groups-09-input-with-add-on` are the stable registry identity.
...
- Resolve `BlockId::from_index(302)`, or look up `application-ui-forms-input-groups-09-input-with-add-on` with
...
- The registry resolves both block id `302` and slug `application-ui-forms-input-groups-09-input-with-add-on` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-09-input-with-add-on` story proves the fixture in both renderers.
