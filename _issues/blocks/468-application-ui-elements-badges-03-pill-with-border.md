...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-8bdde9754f5e091c9a72416417ff2c68

Catalog path: Application UI / elements / Badges / variant 3 of 16

## TPM Outcome

Ship `application-ui-elements-badges-03-pill-with-border` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `467` and `application-ui-elements-badges-03-pill-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(467)`, or look up `application-ui-elements-badges-03-pill-with-border` with
...
- The registry resolves both block id `467` and slug `application-ui-elements-badges-03-pill-with-border` one-to-one.
...
- An isolated `block-application-ui-elements-badges-03-pill-with-border` story proves the fixture in both renderers.
