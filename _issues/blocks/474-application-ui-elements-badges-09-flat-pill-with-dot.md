...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-78b26cb356fb02423d5da90b0e8fe645

Catalog path: Application UI / elements / Badges / variant 9 of 16

## TPM Outcome

Ship `application-ui-elements-badges-09-flat-pill-with-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `473` and `application-ui-elements-badges-09-flat-pill-with-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(473)`, or look up `application-ui-elements-badges-09-flat-pill-with-dot` with
...
- The registry resolves both block id `473` and slug `application-ui-elements-badges-09-flat-pill-with-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-09-flat-pill-with-dot` story proves the fixture in both renderers.
