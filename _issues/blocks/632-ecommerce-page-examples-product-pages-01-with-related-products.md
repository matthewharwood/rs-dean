...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/product-pages#component-b3ec374a846996da2c1176c10ad1c27a

Catalog path: Ecommerce / page-examples / Product Pages / variant 1 of 5

## TPM Outcome

Ship `ecommerce-page-examples-product-pages-01-with-related-products` as a registered Rust-first block in the Product Pages family. Preserve
...
- Block index `631` and `ecommerce-page-examples-product-pages-01-with-related-products` are the stable registry identity.
...
- Resolve `BlockId::from_index(631)`, or look up `ecommerce-page-examples-product-pages-01-with-related-products` with
...
- The registry resolves both block id `631` and slug `ecommerce-page-examples-product-pages-01-with-related-products` one-to-one.
...
- An isolated `block-ecommerce-page-examples-product-pages-01-with-related-products` story proves the fixture in both renderers.
