...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-eb296441dfb685d3aca6b82169d64dcb

Catalog path: Application UI / elements / Badges / variant 10 of 16

## TPM Outcome

Ship `application-ui-elements-badges-10-flat-with-remove-button` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `474` and `application-ui-elements-badges-10-flat-with-remove-button` are the stable registry identity.
...
- Resolve `BlockId::from_index(474)`, or look up `application-ui-elements-badges-10-flat-with-remove-button` with
...
- The registry resolves both block id `474` and slug `application-ui-elements-badges-10-flat-with-remove-button` one-to-one.
...
- An isolated `block-application-ui-elements-badges-10-flat-with-remove-button` story proves the fixture in both renderers.
