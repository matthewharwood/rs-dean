...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-cc1fc7c0898d134a5e03a53ede94f622

Catalog path: Application UI / elements / Buttons / variant 3 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-03-soft-buttons` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `488` and `application-ui-elements-buttons-03-soft-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(488)`, or look up `application-ui-elements-buttons-03-soft-buttons` with
...
- The registry resolves both block id `488` and slug `application-ui-elements-buttons-03-soft-buttons` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-03-soft-buttons` story proves the fixture in both renderers.
