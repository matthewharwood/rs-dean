...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/toggles#component-6ed378bcc4d9eb34a1789e77f0f44d16

Catalog path: Application UI / forms / Toggles / variant 4 of 5

## TPM Outcome

Ship `application-ui-forms-toggles-04-with-left-label-and-description` as a registered Rust-first block in the Toggles family. Preserve
...
- Block index `350` and `application-ui-forms-toggles-04-with-left-label-and-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(350)`, or look up `application-ui-forms-toggles-04-with-left-label-and-description` with
...
- The registry resolves both block id `350` and slug `application-ui-forms-toggles-04-with-left-label-and-description` one-to-one.
...
- An isolated `block-application-ui-forms-toggles-04-with-left-label-and-description` story proves the fixture in both renderers.
