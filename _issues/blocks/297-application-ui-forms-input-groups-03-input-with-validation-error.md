...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-7a5297f99a5ed22df80939dd1986de5f

Catalog path: Application UI / forms / Input Groups / variant 3 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-03-input-with-validation-error` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `296` and `application-ui-forms-input-groups-03-input-with-validation-error` are the stable registry identity.
...
- Resolve `BlockId::from_index(296)`, or look up `application-ui-forms-input-groups-03-input-with-validation-error` with
...
- The registry resolves both block id `296` and slug `application-ui-forms-input-groups-03-input-with-validation-error` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-03-input-with-validation-error` story proves the fixture in both renderers.
