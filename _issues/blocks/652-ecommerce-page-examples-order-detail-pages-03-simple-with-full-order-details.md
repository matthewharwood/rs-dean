...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-detail-pages#component-160a61caad7db64f953dc73ae38ba99a

Catalog path: Ecommerce / page-examples / Order Detail Pages / variant 3 of 3

## TPM Outcome

Ship `ecommerce-page-examples-order-detail-pages-03-simple-with-full-order-details` as a registered Rust-first block in the Order Detail Pages family. Preserve
...
- Block index `651` and `ecommerce-page-examples-order-detail-pages-03-simple-with-full-order-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(651)`, or look up `ecommerce-page-examples-order-detail-pages-03-simple-with-full-order-details` with
...
- The registry resolves both block id `651` and slug `ecommerce-page-examples-order-detail-pages-03-simple-with-full-order-details` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-detail-pages-03-simple-with-full-order-details` story proves the fixture in both renderers.
