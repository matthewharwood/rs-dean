...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-c94291a63bd63d01fd3ebf791093ab8d

Catalog path: Marketing / elements / Banners / variant 4 of 13

## TPM Outcome

Ship `marketing-elements-banners-04-with-background-glow` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `154` and `marketing-elements-banners-04-with-background-glow` are the stable registry identity.
...
- Resolve `BlockId::from_index(154)`, or look up `marketing-elements-banners-04-with-background-glow` with
...
- The registry resolves both block id `154` and slug `marketing-elements-banners-04-with-background-glow` one-to-one.
...
- An isolated `block-marketing-elements-banners-04-with-background-glow` story proves the fixture in both renderers.
