...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-fbb80c840a9674b8b49d86450938c32f

Catalog path: Marketing / sections / Testimonials / variant 6 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-06-with-star-rating` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `80` and `marketing-sections-testimonials-06-with-star-rating` are the stable registry identity.
...
- Resolve `BlockId::from_index(80)`, or look up `marketing-sections-testimonials-06-with-star-rating` with
...
- The registry resolves both block id `80` and slug `marketing-sections-testimonials-06-with-star-rating` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-06-with-star-rating` story proves the fixture in both renderers.
