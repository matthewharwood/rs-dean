...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-bd664362c1ab2e20c6dc4c0ee14c4984

Catalog path: Application UI / forms / Input Groups / variant 18 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-18-input-with-overlapping-label` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `311` and `application-ui-forms-input-groups-18-input-with-overlapping-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(311)`, or look up `application-ui-forms-input-groups-18-input-with-overlapping-label` with
...
- The registry resolves both block id `311` and slug `application-ui-forms-input-groups-18-input-with-overlapping-label` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-18-input-with-overlapping-label` story proves the fixture in both renderers.
