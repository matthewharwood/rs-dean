...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-05a1aec573d7b5cd3909323c6db6723f

Catalog path: Application UI / overlays / Drawers / variant 3 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-03-with-background-overlay` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `438` and `application-ui-overlays-drawers-03-with-background-overlay` are the stable registry identity.
...
- Resolve `BlockId::from_index(438)`, or look up `application-ui-overlays-drawers-03-with-background-overlay` with
...
- The registry resolves both block id `438` and slug `application-ui-overlays-drawers-03-with-background-overlay` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-03-with-background-overlay` story proves the fixture in both renderers.
