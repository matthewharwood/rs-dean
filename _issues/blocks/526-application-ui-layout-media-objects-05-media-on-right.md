...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-de6f24032eec6a97d91a05a42000ada6

Catalog path: Application UI / layout / Media Objects / variant 5 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-05-media-on-right` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `525` and `application-ui-layout-media-objects-05-media-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(525)`, or look up `application-ui-layout-media-objects-05-media-on-right` with
...
- The registry resolves both block id `525` and slug `application-ui-layout-media-objects-05-media-on-right` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-05-media-on-right` story proves the fixture in both renderers.
