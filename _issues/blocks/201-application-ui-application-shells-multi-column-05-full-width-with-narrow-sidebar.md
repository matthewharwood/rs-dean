...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-6e22fa5715141e2f842a9c887bcfb7a3

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 5 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-05-full-width-with-narrow-sidebar` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
...
- Block index `200` and `application-ui-application-shells-multi-column-05-full-width-with-narrow-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(200)`, or look up `application-ui-application-shells-multi-column-05-full-width-with-narrow-sidebar` with
...
- The registry resolves both block id `200` and slug `application-ui-application-shells-multi-column-05-full-width-with-narrow-sidebar` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-05-full-width-with-narrow-sidebar` story proves the fixture in both renderers.
