...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/empty-states#component-680f71a6b1841658956e1546648937d5

Catalog path: Application UI / feedback / Empty States / variant 2 of 6

## TPM Outcome

Ship `application-ui-feedback-empty-states-02-with-dashed-border` as a registered Rust-first block in the Empty States family. Preserve
...
- Block index `371` and `application-ui-feedback-empty-states-02-with-dashed-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(371)`, or look up `application-ui-feedback-empty-states-02-with-dashed-border` with
...
- The registry resolves both block id `371` and slug `application-ui-feedback-empty-states-02-with-dashed-border` one-to-one.
...
- An isolated `block-application-ui-feedback-empty-states-02-with-dashed-border` story proves the fixture in both renderers.
