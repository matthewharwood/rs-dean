...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-f3dd88b8abfd735d38873b8daa09d07d

Catalog path: Marketing / sections / Pricing Sections / variant 6 of 12

## TPM Outcome

Ship `marketing-sections-pricing-06-three-tiers` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `46` and `marketing-sections-pricing-06-three-tiers` are the stable registry identity.
...
- Resolve `BlockId::from_index(46)`, or look up `marketing-sections-pricing-06-three-tiers` with
...
- The registry resolves both block id `46` and slug `marketing-sections-pricing-06-three-tiers` one-to-one.
...
- An isolated `block-marketing-sections-pricing-06-three-tiers` story proves the fixture in both renderers.
