...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-446e3bebd49060a01c3f05189c4c09da

Catalog path: Application UI / headings / Section Headings / variant 9 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-09-with-label` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `225` and `application-ui-headings-section-headings-09-with-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(225)`, or look up `application-ui-headings-section-headings-09-with-label` with
...
- The registry resolves both block id `225` and slug `application-ui-headings-section-headings-09-with-label` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-09-with-label` story proves the fixture in both renderers.
