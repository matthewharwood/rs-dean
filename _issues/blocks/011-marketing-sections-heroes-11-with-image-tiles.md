...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-a4b2f622985371f413e0d6c13309d389

Catalog path: Marketing / sections / Hero Sections / variant 11 of 12

## TPM Outcome

Ship `marketing-sections-heroes-11-with-image-tiles` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `10` and `marketing-sections-heroes-11-with-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(10)`, or look up `marketing-sections-heroes-11-with-image-tiles` with
...
- The registry resolves both block id `10` and slug `marketing-sections-heroes-11-with-image-tiles` one-to-one.
...
- An isolated `block-marketing-sections-heroes-11-with-image-tiles` story proves the fixture in both renderers.
