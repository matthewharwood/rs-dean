...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-71bece8a145585e233f9ecbb2c2ddd86

Catalog path: Application UI / lists / Stacked Lists / variant 10 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-10-narrow` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `255` and `application-ui-lists-stacked-lists-10-narrow` are the stable registry identity.
...
- Resolve `BlockId::from_index(255)`, or look up `application-ui-lists-stacked-lists-10-narrow` with
...
- The registry resolves both block id `255` and slug `application-ui-lists-stacked-lists-10-narrow` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-10-narrow` story proves the fixture in both renderers.
