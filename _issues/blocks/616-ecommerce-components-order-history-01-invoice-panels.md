...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-history#component-90c39adb3053a6f09205e7f4e3e506d1

Catalog path: Ecommerce / components / Order History / variant 1 of 4

## TPM Outcome

Ship `ecommerce-components-order-history-01-invoice-panels` as a registered Rust-first block in the Order History family. Preserve
...
- Block index `615` and `ecommerce-components-order-history-01-invoice-panels` are the stable registry identity.
...
- Resolve `BlockId::from_index(615)`, or look up `ecommerce-components-order-history-01-invoice-panels` with
...
- The registry resolves both block id `615` and slug `ecommerce-components-order-history-01-invoice-panels` one-to-one.
...
- An isolated `block-ecommerce-components-order-history-01-invoice-panels` story proves the fixture in both renderers.
