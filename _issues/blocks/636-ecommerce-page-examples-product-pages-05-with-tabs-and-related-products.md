...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/product-pages#component-5d28bf260035512bddeb20cab56e052d

Catalog path: Ecommerce / page-examples / Product Pages / variant 5 of 5

## TPM Outcome

Ship `ecommerce-page-examples-product-pages-05-with-tabs-and-related-products` as a registered Rust-first block in the Product Pages family. Preserve
...
- Block index `635` and `ecommerce-page-examples-product-pages-05-with-tabs-and-related-products` are the stable registry identity.
...
- Resolve `BlockId::from_index(635)`, or look up `ecommerce-page-examples-product-pages-05-with-tabs-and-related-products` with
...
- The registry resolves both block id `635` and slug `ecommerce-page-examples-product-pages-05-with-tabs-and-related-products` one-to-one.
...
- An isolated `block-ecommerce-page-examples-product-pages-05-with-tabs-and-related-products` story proves the fixture in both renderers.
