...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-112b08cb1de2593034dfced08f67250d

Catalog path: Marketing / sections / Hero Sections / variant 6 of 12

## TPM Outcome

Ship `marketing-sections-heroes-06-with-bordered-app-screenshot` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `5` and `marketing-sections-heroes-06-with-bordered-app-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(5)`, or look up `marketing-sections-heroes-06-with-bordered-app-screenshot` with
...
- The registry resolves both block id `5` and slug `marketing-sections-heroes-06-with-bordered-app-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-heroes-06-with-bordered-app-screenshot` story proves the fixture in both renderers.
