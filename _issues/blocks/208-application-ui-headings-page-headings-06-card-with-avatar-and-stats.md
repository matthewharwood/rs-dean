...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-9a6c0d01eb626ce1c5a63141be2e5271

Catalog path: Application UI / headings / Page Headings / variant 6 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-06-card-with-avatar-and-stats` as a registered Rust-first block in the Page Headings family. Preserve
...
- Apply the typed `Avatar` media mode, `Panel` surface treatment, and
...
- Block index `207` and `application-ui-headings-page-headings-06-card-with-avatar-and-stats` are the stable registry identity.
...
- Variant behavior is constrained by `Avatar`, `Panel`, and `Static`
...
- Resolve `BlockId::from_index(207)`, or look up `application-ui-headings-page-headings-06-card-with-avatar-and-stats` with
...
- The registry resolves both block id `207` and slug `application-ui-headings-page-headings-06-card-with-avatar-and-stats` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-06-card-with-avatar-and-stats` story proves the fixture in both renderers.
