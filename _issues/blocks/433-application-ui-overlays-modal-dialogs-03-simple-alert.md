...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-5b2215402125bb9b2fa926f9af38e494

Catalog path: Application UI / overlays / Modal Dialogs / variant 3 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-03-simple-alert` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `432` and `application-ui-overlays-modal-dialogs-03-simple-alert` are the stable registry identity.
...
- Resolve `BlockId::from_index(432)`, or look up `application-ui-overlays-modal-dialogs-03-simple-alert` with
...
- The registry resolves both block id `432` and slug `application-ui-overlays-modal-dialogs-03-simple-alert` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-03-simple-alert` story proves the fixture in both renderers.
