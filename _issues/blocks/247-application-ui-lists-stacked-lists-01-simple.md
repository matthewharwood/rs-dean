...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-3c51b92eef57b177f3ea356305fdbe71

Catalog path: Application UI / lists / Stacked Lists / variant 1 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-01-simple` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `246` and `application-ui-lists-stacked-lists-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(246)`, or look up `application-ui-lists-stacked-lists-01-simple` with
...
- The registry resolves both block id `246` and slug `application-ui-lists-stacked-lists-01-simple` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-01-simple` story proves the fixture in both renderers.
