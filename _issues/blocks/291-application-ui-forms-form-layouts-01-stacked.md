...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/form-layouts#component-1c3f9860d66ce5cd9fb35ba7fde6721a

Catalog path: Application UI / forms / Form Layouts / variant 1 of 4

## TPM Outcome

Ship `application-ui-forms-form-layouts-01-stacked` as a registered Rust-first block in the Form Layouts family. Preserve
...
- Block index `290` and `application-ui-forms-form-layouts-01-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(290)`, or look up `application-ui-forms-form-layouts-01-stacked` with
...
- The registry resolves both block id `290` and slug `application-ui-forms-form-layouts-01-stacked` one-to-one.
...
- An isolated `block-application-ui-forms-form-layouts-01-stacked` story proves the fixture in both renderers.
