...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/detail-screens#component-b2e0bc6412fac1eed5e63be299388d58

Catalog path: Application UI / page-examples / Detail Screens / variant 1 of 2

## TPM Outcome

Ship `application-ui-page-examples-detail-screens-01-sidebar` as a registered Rust-first block in the Detail Screens family. Preserve
...
- Block index `539` and `application-ui-page-examples-detail-screens-01-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(539)`, or look up `application-ui-page-examples-detail-screens-01-sidebar` with
...
- The registry resolves both block id `539` and slug `application-ui-page-examples-detail-screens-01-sidebar` one-to-one.
...
- An isolated `block-application-ui-page-examples-detail-screens-01-sidebar` story proves the fixture in both renderers.
