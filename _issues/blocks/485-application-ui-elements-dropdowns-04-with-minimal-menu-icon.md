...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/dropdowns#component-c9d423234fd92f72951b96480518868a

Catalog path: Application UI / elements / Dropdowns / variant 4 of 5

## TPM Outcome

Ship `application-ui-elements-dropdowns-04-with-minimal-menu-icon` as a registered Rust-first block in the Dropdowns family. Preserve
...
- Block index `484` and `application-ui-elements-dropdowns-04-with-minimal-menu-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(484)`, or look up `application-ui-elements-dropdowns-04-with-minimal-menu-icon` with
...
- The registry resolves both block id `484` and slug `application-ui-elements-dropdowns-04-with-minimal-menu-icon` one-to-one.
...
- An isolated `block-application-ui-elements-dropdowns-04-with-minimal-menu-icon` story proves the fixture in both renderers.
