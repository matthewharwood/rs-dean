...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-a8d111fef35bfae4c800af505ea0d276

Catalog path: Application UI / forms / Input Groups / variant 14 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-14-input-with-leading-icon-and-trailing-button` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `307` and `application-ui-forms-input-groups-14-input-with-leading-icon-and-trailing-button` are the stable registry identity.
...
- Variant behavior is constrained by `Icon`, `Plain`, and `Form`
...
- Resolve `BlockId::from_index(307)`, or look up `application-ui-forms-input-groups-14-input-with-leading-icon-and-trailing-button` with
...
- The registry resolves both block id `307` and slug `application-ui-forms-input-groups-14-input-with-leading-icon-and-trailing-button` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-14-input-with-leading-icon-and-trailing-button` story proves the fixture in both renderers.
