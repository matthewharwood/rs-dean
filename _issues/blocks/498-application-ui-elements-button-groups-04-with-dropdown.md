...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/button-groups#component-bfc7e9cc9d7b5762cb139096ac3266c1

Catalog path: Application UI / elements / Button Groups / variant 4 of 5

## TPM Outcome

Ship `application-ui-elements-button-groups-04-with-dropdown` as a registered Rust-first block in the Button Groups family. Preserve
...
- Block index `497` and `application-ui-elements-button-groups-04-with-dropdown` are the stable registry identity.
...
- Resolve `BlockId::from_index(497)`, or look up `application-ui-elements-button-groups-04-with-dropdown` with
...
- The registry resolves both block id `497` and slug `application-ui-elements-button-groups-04-with-dropdown` one-to-one.
...
- An isolated `block-application-ui-elements-button-groups-04-with-dropdown` story proves the fixture in both renderers.
