...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-07e889de48dabb9e22d20353d7c02d16

Catalog path: Application UI / navigation / Tabs / variant 5 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-05-tabs-in-pills-with-brand-color` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `394` and `application-ui-navigation-tabs-05-tabs-in-pills-with-brand-color` are the stable registry identity.
...
- Resolve `BlockId::from_index(394)`, or look up `application-ui-navigation-tabs-05-tabs-in-pills-with-brand-color` with
...
- The registry resolves both block id `394` and slug `application-ui-navigation-tabs-05-tabs-in-pills-with-brand-color` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-05-tabs-in-pills-with-brand-color` story proves the fixture in both renderers.
