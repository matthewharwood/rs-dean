...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-c514bd50feabd9311204463df38ea764

Catalog path: Application UI / headings / Section Headings / variant 1 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-01-simple` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `217` and `application-ui-headings-section-headings-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(217)`, or look up `application-ui-headings-section-headings-01-simple` with
...
- The registry resolves both block id `217` and slug `application-ui-headings-section-headings-01-simple` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-01-simple` story proves the fixture in both renderers.
