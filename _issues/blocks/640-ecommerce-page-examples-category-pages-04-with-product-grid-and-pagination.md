...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/category-pages#component-01e6cce6c6c0b0de6f399049b2f512cc

Catalog path: Ecommerce / page-examples / Category Pages / variant 4 of 5

## TPM Outcome

Ship `ecommerce-page-examples-category-pages-04-with-product-grid-and-pagination` as a registered Rust-first block in the Category Pages family. Preserve
...
- Apply the typed `Product media` media mode, `Plain` surface treatment, and
  `Pagination` interaction contract without adding one-off classes.
...
- Block index `639` and `ecommerce-page-examples-category-pages-04-with-product-grid-and-pagination` are the stable registry identity.
...
- Variant behavior is constrained by `Product media`, `Plain`, and `Pagination`
...
- Resolve `BlockId::from_index(639)`, or look up `ecommerce-page-examples-category-pages-04-with-product-grid-and-pagination` with
...
- The registry resolves both block id `639` and slug `ecommerce-page-examples-category-pages-04-with-product-grid-and-pagination` one-to-one.
...
- An isolated `block-ecommerce-page-examples-category-pages-04-with-product-grid-and-pagination` story proves the fixture in both renderers.
