...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-fed988a810519f7aefef13224b3a814d

Catalog path: Marketing / sections / Header Sections / variant 5 of 8

## TPM Outcome

Ship `marketing-sections-header-05-simple` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `57` and `marketing-sections-header-05-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(57)`, or look up `marketing-sections-header-05-simple` with
...
- The registry resolves both block id `57` and slug `marketing-sections-header-05-simple` one-to-one.
...
- An isolated `block-marketing-sections-header-05-simple` story proves the fixture in both renderers.
