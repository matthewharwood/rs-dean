...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-97989af9f246f530d9dee5b94b076654

Catalog path: Application UI / navigation / Navbars / variant 9 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-09-dark-with-centered-search-and-secondary-links` as a registered Rust-first block in the Navbars family. Preserve
...
- Apply the typed `No media` media mode, `Dark` surface treatment, and
  `Search` interaction contract without adding one-off classes.
...
- Block index `384` and `application-ui-navigation-navbars-09-dark-with-centered-search-and-secondary-links` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Dark`, and `Search`
...
- Resolve `BlockId::from_index(384)`, or look up `application-ui-navigation-navbars-09-dark-with-centered-search-and-secondary-links` with
...
- The registry resolves both block id `384` and slug `application-ui-navigation-navbars-09-dark-with-centered-search-and-secondary-links` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-09-dark-with-centered-search-and-secondary-links` story proves the fixture in both renderers.
