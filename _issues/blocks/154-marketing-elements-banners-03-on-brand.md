...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-4375397fcc9712be608b21b9d8f355c8

Catalog path: Marketing / elements / Banners / variant 3 of 13

## TPM Outcome

Ship `marketing-elements-banners-03-on-brand` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `153` and `marketing-elements-banners-03-on-brand` are the stable registry identity.
...
- Resolve `BlockId::from_index(153)`, or look up `marketing-elements-banners-03-on-brand` with
...
- The registry resolves both block id `153` and slug `marketing-elements-banners-03-on-brand` one-to-one.
...
- An isolated `block-marketing-elements-banners-03-on-brand` story proves the fixture in both renderers.
