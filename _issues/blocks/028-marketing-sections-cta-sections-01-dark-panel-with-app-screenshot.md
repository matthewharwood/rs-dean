...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-0763876148e2fa400b4f1cf13cdf0093

Catalog path: Marketing / sections / CTA Sections / variant 1 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-01-dark-panel-with-app-screenshot` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Apply the typed `Screenshot` media mode, `Dark` surface treatment, and
...
- Block index `27` and `marketing-sections-cta-sections-01-dark-panel-with-app-screenshot` are the stable registry identity.
...
- Variant behavior is constrained by `Screenshot`, `Dark`, and `Actions`
...
- Resolve `BlockId::from_index(27)`, or look up `marketing-sections-cta-sections-01-dark-panel-with-app-screenshot` with
...
- The registry resolves both block id `27` and slug `marketing-sections-cta-sections-01-dark-panel-with-app-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-01-dark-panel-with-app-screenshot` story proves the fixture in both renderers.
