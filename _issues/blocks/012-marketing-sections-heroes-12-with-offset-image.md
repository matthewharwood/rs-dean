...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-1e0bb85307a6f85f730eb5cf8a813837

Catalog path: Marketing / sections / Hero Sections / variant 12 of 12

## TPM Outcome

Ship `marketing-sections-heroes-12-with-offset-image` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `11` and `marketing-sections-heroes-12-with-offset-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(11)`, or look up `marketing-sections-heroes-12-with-offset-image` with
...
- The registry resolves both block id `11` and slug `marketing-sections-heroes-12-with-offset-image` one-to-one.
...
- An isolated `block-marketing-sections-heroes-12-with-offset-image` story proves the fixture in both renderers.
