...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/empty-states#component-42312e49c9887a27078b43874d164f48

Catalog path: Application UI / feedback / Empty States / variant 3 of 6

## TPM Outcome

Ship `application-ui-feedback-empty-states-03-with-starting-points` as a registered Rust-first block in the Empty States family. Preserve
...
- Block index `372` and `application-ui-feedback-empty-states-03-with-starting-points` are the stable registry identity.
...
- Resolve `BlockId::from_index(372)`, or look up `application-ui-feedback-empty-states-03-with-starting-points` with
...
- The registry resolves both block id `372` and slug `application-ui-feedback-empty-states-03-with-starting-points` one-to-one.
...
- An isolated `block-application-ui-feedback-empty-states-03-with-starting-points` story proves the fixture in both renderers.
