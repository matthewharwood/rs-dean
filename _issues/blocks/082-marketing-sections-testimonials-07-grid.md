...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-1d4641d9b778e6e47e5cb664d4d8a683

Catalog path: Marketing / sections / Testimonials / variant 7 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-07-grid` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `81` and `marketing-sections-testimonials-07-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(81)`, or look up `marketing-sections-testimonials-07-grid` with
...
- The registry resolves both block id `81` and slug `marketing-sections-testimonials-07-grid` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-07-grid` story proves the fixture in both renderers.
