...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-f380d45911d89e9f8e781164e162cbb4

Catalog path: Application UI / elements / Avatars / variant 7 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-07-circular-avatars-with-placeholder-icon` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `460` and `application-ui-elements-avatars-07-circular-avatars-with-placeholder-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(460)`, or look up `application-ui-elements-avatars-07-circular-avatars-with-placeholder-icon` with
...
- The registry resolves both block id `460` and slug `application-ui-elements-avatars-07-circular-avatars-with-placeholder-icon` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-07-circular-avatars-with-placeholder-icon` story proves the fixture in both renderers.
