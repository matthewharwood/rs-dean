...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-3c540cf65bd29ea737f1d08de55c59f1

Catalog path: Application UI / navigation / Command Palettes / variant 2 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-02-simple-with-padding` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `423` and `application-ui-navigation-command-palettes-02-simple-with-padding` are the stable registry identity.
...
- Resolve `BlockId::from_index(423)`, or look up `application-ui-navigation-command-palettes-02-simple-with-padding` with
...
- The registry resolves both block id `423` and slug `application-ui-navigation-command-palettes-02-simple-with-padding` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-02-simple-with-padding` story proves the fixture in both renderers.
