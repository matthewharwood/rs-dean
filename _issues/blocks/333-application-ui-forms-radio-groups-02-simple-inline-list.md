...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-f77fa2476964716cd375c934954229ae

Catalog path: Application UI / forms / Radio Groups / variant 2 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-02-simple-inline-list` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `332` and `application-ui-forms-radio-groups-02-simple-inline-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(332)`, or look up `application-ui-forms-radio-groups-02-simple-inline-list` with
...
- The registry resolves both block id `332` and slug `application-ui-forms-radio-groups-02-simple-inline-list` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-02-simple-inline-list` story proves the fixture in both renderers.
