...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-6ebe66c8103e943e840fd4dbf1cf8ab7

Catalog path: Ecommerce / components / Category Previews / variant 5 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-05-with-scrolling-cards` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `563` and `ecommerce-components-category-previews-05-with-scrolling-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(563)`, or look up `ecommerce-components-category-previews-05-with-scrolling-cards` with
...
- The registry resolves both block id `563` and slug `ecommerce-components-category-previews-05-with-scrolling-cards` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-05-with-scrolling-cards` story proves the fixture in both renderers.
