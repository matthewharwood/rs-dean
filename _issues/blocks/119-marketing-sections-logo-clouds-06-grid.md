...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/logo-clouds#component-43ee71fd15dce1037be11c19f5a95227

Catalog path: Marketing / sections / Logo Clouds / variant 6 of 6

## TPM Outcome

Ship `marketing-sections-logo-clouds-06-grid` as a registered Rust-first block in the Logo Clouds family. Preserve
...
- Block index `118` and `marketing-sections-logo-clouds-06-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(118)`, or look up `marketing-sections-logo-clouds-06-grid` with
...
- The registry resolves both block id `118` and slug `marketing-sections-logo-clouds-06-grid` one-to-one.
...
- An isolated `block-marketing-sections-logo-clouds-06-grid` story proves the fixture in both renderers.
