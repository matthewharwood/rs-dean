...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/list-containers#component-338d89d9dfdf34b0f72bf271951ce687

Catalog path: Application UI / layout / List containers / variant 3 of 7

## TPM Outcome

Ship `application-ui-layout-list-containers-03-card-with-dividers-full-width-on-mobile` as a registered Rust-first block in the List containers family. Preserve
...
- Block index `516` and `application-ui-layout-list-containers-03-card-with-dividers-full-width-on-mobile` are the stable registry identity.
...
- Resolve `BlockId::from_index(516)`, or look up `application-ui-layout-list-containers-03-card-with-dividers-full-width-on-mobile` with
...
- The registry resolves both block id `516` and slug `application-ui-layout-list-containers-03-card-with-dividers-full-width-on-mobile` one-to-one.
...
- An isolated `block-application-ui-layout-list-containers-03-card-with-dividers-full-width-on-mobile` story proves the fixture in both renderers.
