...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-ab799a0b48c911854636f6e31cb28915

Catalog path: Application UI / headings / Page Headings / variant 5 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-05-with-avatar-and-actions` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `206` and `application-ui-headings-page-headings-05-with-avatar-and-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(206)`, or look up `application-ui-headings-page-headings-05-with-avatar-and-actions` with
...
- The registry resolves both block id `206` and slug `application-ui-headings-page-headings-05-with-avatar-and-actions` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-05-with-avatar-and-actions` story proves the fixture in both renderers.
