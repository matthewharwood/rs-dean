...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-c3692309ba3a2cd4c439031e104ad97a

Catalog path: Application UI / headings / Card Headings / variant 1 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-01-simple` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `211` and `application-ui-headings-card-headings-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(211)`, or look up `application-ui-headings-card-headings-01-simple` with
...
- The registry resolves both block id `211` and slug `application-ui-headings-card-headings-01-simple` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-01-simple` story proves the fixture in both renderers.
