...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/checkout-pages#component-1eba6ef876ae6e4e30202d1785858c6d

Catalog path: Ecommerce / page-examples / Checkout Pages / variant 2 of 5

## TPM Outcome

Ship `ecommerce-page-examples-checkout-pages-02-single-step-with-order-summary` as a registered Rust-first block in the Checkout Pages family. Preserve
...
- Block index `645` and `ecommerce-page-examples-checkout-pages-02-single-step-with-order-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(645)`, or look up `ecommerce-page-examples-checkout-pages-02-single-step-with-order-summary` with
...
- The registry resolves both block id `645` and slug `ecommerce-page-examples-checkout-pages-02-single-step-with-order-summary` one-to-one.
...
- An isolated `block-ecommerce-page-examples-checkout-pages-02-single-step-with-order-summary` story proves the fixture in both renderers.
