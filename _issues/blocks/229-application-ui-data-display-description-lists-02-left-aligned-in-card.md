...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-e1b5917b21bbe76a73a96c5ca876225f

Catalog path: Application UI / data-display / Description Lists / variant 2 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-02-left-aligned-in-card` as a registered Rust-first block in the Description Lists family. Preserve
...
- Block index `228` and `application-ui-data-display-description-lists-02-left-aligned-in-card` are the stable registry identity.
...
- The family maps to the `Data display` composition pattern and the `Item`
...
- Resolve `BlockId::from_index(228)`, or look up `application-ui-data-display-description-lists-02-left-aligned-in-card` with
...
- The registry resolves both block id `228` and slug `application-ui-data-display-description-lists-02-left-aligned-in-card` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-02-left-aligned-in-card` story proves the fixture in both renderers.
