...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-4612a3d225951aa8a3e723d09381fc97

Catalog path: Ecommerce / components / Product Features / variant 7 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-07-with-alternating-sections` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `586` and `ecommerce-components-product-features-07-with-alternating-sections` are the stable registry identity.
...
- Resolve `BlockId::from_index(586)`, or look up `ecommerce-components-product-features-07-with-alternating-sections` with
...
- The registry resolves both block id `586` and slug `ecommerce-components-product-features-07-with-alternating-sections` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-07-with-alternating-sections` story proves the fixture in both renderers.
