...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/list-containers#component-a0f475f9acf9194cd19255e19acde240

Catalog path: Application UI / layout / List containers / variant 4 of 7

## TPM Outcome

Ship `application-ui-layout-list-containers-04-separate-cards` as a registered Rust-first block in the List containers family. Preserve
...
- Block index `517` and `application-ui-layout-list-containers-04-separate-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(517)`, or look up `application-ui-layout-list-containers-04-separate-cards` with
...
- The registry resolves both block id `517` and slug `application-ui-layout-list-containers-04-separate-cards` one-to-one.
...
- An isolated `block-application-ui-layout-list-containers-04-separate-cards` story proves the fixture in both renderers.
