...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-593dc2239ad88d2f55f81ad94b6a4069

Catalog path: Marketing / elements / Headers / variant 5 of 11

## TPM Outcome

Ship `marketing-elements-headers-05-full-width` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `137` and `marketing-elements-headers-05-full-width` are the stable registry identity.
...
- Resolve `BlockId::from_index(137)`, or look up `marketing-elements-headers-05-full-width` with
...
- The registry resolves both block id `137` and slug `marketing-elements-headers-05-full-width` one-to-one.
...
- An isolated `block-marketing-elements-headers-05-full-width` story proves the fixture in both renderers.
