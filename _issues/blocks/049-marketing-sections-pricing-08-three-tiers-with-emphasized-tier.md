...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-d91bc5ed1deb87275decb69f70274650

Catalog path: Marketing / sections / Pricing Sections / variant 8 of 12

## TPM Outcome

Ship `marketing-sections-pricing-08-three-tiers-with-emphasized-tier` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `48` and `marketing-sections-pricing-08-three-tiers-with-emphasized-tier` are the stable registry identity.
...
- Resolve `BlockId::from_index(48)`, or look up `marketing-sections-pricing-08-three-tiers-with-emphasized-tier` with
...
- The registry resolves both block id `48` and slug `marketing-sections-pricing-08-three-tiers-with-emphasized-tier` one-to-one.
...
- An isolated `block-marketing-sections-pricing-08-three-tiers-with-emphasized-tier` story proves the fixture in both renderers.
