...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-71f7051fb4be836be32b302f6cc43ab2

Catalog path: Application UI / elements / Badges / variant 11 of 16

## TPM Outcome

Ship `application-ui-elements-badges-11-small-with-border` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `475` and `application-ui-elements-badges-11-small-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(475)`, or look up `application-ui-elements-badges-11-small-with-border` with
...
- The registry resolves both block id `475` and slug `application-ui-elements-badges-11-small-with-border` one-to-one.
...
- An isolated `block-application-ui-elements-badges-11-small-with-border` story proves the fixture in both renderers.
