...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-d7e3987a5bcd99ecc19e6e55d448fccc

Catalog path: Application UI / elements / Avatars / variant 6 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-06-rounded-avatars-with-bottom-notification` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `459` and `application-ui-elements-avatars-06-rounded-avatars-with-bottom-notification` are the stable registry identity.
...
- Resolve `BlockId::from_index(459)`, or look up `application-ui-elements-avatars-06-rounded-avatars-with-bottom-notification` with
...
- The registry resolves both block id `459` and slug `application-ui-elements-avatars-06-rounded-avatars-with-bottom-notification` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-06-rounded-avatars-with-bottom-notification` story proves the fixture in both renderers.
