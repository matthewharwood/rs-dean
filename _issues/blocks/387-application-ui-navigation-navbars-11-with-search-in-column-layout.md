...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-ac4ed72c2e03976dc5415ce711fe2f78

Catalog path: Application UI / navigation / Navbars / variant 11 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-11-with-search-in-column-layout` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `386` and `application-ui-navigation-navbars-11-with-search-in-column-layout` are the stable registry identity.
...
- Resolve `BlockId::from_index(386)`, or look up `application-ui-navigation-navbars-11-with-search-in-column-layout` with
...
- The registry resolves both block id `386` and slug `application-ui-navigation-navbars-11-with-search-in-column-layout` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-11-with-search-in-column-layout` story proves the fixture in both renderers.
