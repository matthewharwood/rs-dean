...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-12ae7abe5e2cc75a10bb36d767b63547

Catalog path: Marketing / sections / Blog Sections / variant 2 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-02-three-column-with-images` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `84` and `marketing-sections-blog-sections-02-three-column-with-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(84)`, or look up `marketing-sections-blog-sections-02-three-column-with-images` with
...
- The registry resolves both block id `84` and slug `marketing-sections-blog-sections-02-three-column-with-images` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-02-three-column-with-images` story proves the fixture in both renderers.
