...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-b59d3a98c34e60d43c8972caa08618a5

Catalog path: Application UI / data-display / Calendars / variant 7 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-07-borderless-stacked` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `244` and `application-ui-data-display-calendars-07-borderless-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(244)`, or look up `application-ui-data-display-calendars-07-borderless-stacked` with
...
- The registry resolves both block id `244` and slug `application-ui-data-display-calendars-07-borderless-stacked` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-07-borderless-stacked` story proves the fixture in both renderers.
