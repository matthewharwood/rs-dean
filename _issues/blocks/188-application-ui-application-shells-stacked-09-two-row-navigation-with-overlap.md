...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-d3429709d7862763cc93bbc60777c0fe

Catalog path: Application UI / application-shells / Stacked Layouts / variant 9 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-09-two-row-navigation-with-overlap` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `187` and `application-ui-application-shells-stacked-09-two-row-navigation-with-overlap` are the stable registry identity.
...
- Resolve `BlockId::from_index(187)`, or look up `application-ui-application-shells-stacked-09-two-row-navigation-with-overlap` with
...
- The registry resolves both block id `187` and slug `application-ui-application-shells-stacked-09-two-row-navigation-with-overlap` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-09-two-row-navigation-with-overlap` story proves the fixture in both renderers.
