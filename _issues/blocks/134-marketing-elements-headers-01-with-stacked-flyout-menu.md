...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-27e5f71ced91b88e3f6b59ca69033a83

Catalog path: Marketing / elements / Headers / variant 1 of 11

## TPM Outcome

Ship `marketing-elements-headers-01-with-stacked-flyout-menu` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `133` and `marketing-elements-headers-01-with-stacked-flyout-menu` are the stable registry identity.
...
- Resolve `BlockId::from_index(133)`, or look up `marketing-elements-headers-01-with-stacked-flyout-menu` with
...
- The registry resolves both block id `133` and slug `marketing-elements-headers-01-with-stacked-flyout-menu` one-to-one.
...
- An isolated `block-marketing-elements-headers-01-with-stacked-flyout-menu` story proves the fixture in both renderers.
