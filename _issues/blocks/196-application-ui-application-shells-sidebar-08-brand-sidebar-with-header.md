...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-73d9b2c2e2af9184f305f06649710086

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 8 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-08-brand-sidebar-with-header` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `195` and `application-ui-application-shells-sidebar-08-brand-sidebar-with-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(195)`, or look up `application-ui-application-shells-sidebar-08-brand-sidebar-with-header` with
...
- The registry resolves both block id `195` and slug `application-ui-application-shells-sidebar-08-brand-sidebar-with-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-08-brand-sidebar-with-header` story proves the fixture in both renderers.
