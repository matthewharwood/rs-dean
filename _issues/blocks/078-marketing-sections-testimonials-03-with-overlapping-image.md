...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-c5694e9aacc7edd691e3234d067adc62

Catalog path: Marketing / sections / Testimonials / variant 3 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-03-with-overlapping-image` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `77` and `marketing-sections-testimonials-03-with-overlapping-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(77)`, or look up `marketing-sections-testimonials-03-with-overlapping-image` with
...
- The registry resolves both block id `77` and slug `marketing-sections-testimonials-03-with-overlapping-image` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-03-with-overlapping-image` story proves the fixture in both renderers.
