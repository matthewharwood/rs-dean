...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-48f0c3d2f1718b7f594e777ed3864ccd

Catalog path: Application UI / application-shells / Stacked Layouts / variant 5 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-05-with-overlap` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `183` and `application-ui-application-shells-stacked-05-with-overlap` are the stable registry identity.
...
- Resolve `BlockId::from_index(183)`, or look up `application-ui-application-shells-stacked-05-with-overlap` with
...
- The registry resolves both block id `183` and slug `application-ui-application-shells-stacked-05-with-overlap` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-05-with-overlap` story proves the fixture in both renderers.
