...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/stats#component-35ed1d3ddcfdc158c8a391745fc125f0

Catalog path: Application UI / data-display / Stats / variant 1 of 5

## TPM Outcome

Ship `application-ui-data-display-stats-01-with-trending` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `233` and `application-ui-data-display-stats-01-with-trending` are the stable registry identity.
...
- Resolve `BlockId::from_index(233)`, or look up `application-ui-data-display-stats-01-with-trending` with
...
- The registry resolves both block id `233` and slug `application-ui-data-display-stats-01-with-trending` one-to-one.
...
- An isolated `block-application-ui-data-display-stats-01-with-trending` story proves the fixture in both renderers.
