...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-69c177c9d4921026ce3ddd0c3f6846b0

Catalog path: Marketing / sections / Blog Sections / variant 5 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-05-single-column-with-images` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `87` and `marketing-sections-blog-sections-05-single-column-with-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(87)`, or look up `marketing-sections-blog-sections-05-single-column-with-images` with
...
- The registry resolves both block id `87` and slug `marketing-sections-blog-sections-05-single-column-with-images` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-05-single-column-with-images` story proves the fixture in both renderers.
