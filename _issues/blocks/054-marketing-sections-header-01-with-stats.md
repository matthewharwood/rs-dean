...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-813ce86310c2c337070a66a152012665

Catalog path: Marketing / sections / Header Sections / variant 1 of 8

## TPM Outcome

Ship `marketing-sections-header-01-with-stats` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `53` and `marketing-sections-header-01-with-stats` are the stable registry identity.
...
- Resolve `BlockId::from_index(53)`, or look up `marketing-sections-header-01-with-stats` with
...
- The registry resolves both block id `53` and slug `marketing-sections-header-01-with-stats` one-to-one.
...
- An isolated `block-marketing-sections-header-01-with-stats` story proves the fixture in both renderers.
