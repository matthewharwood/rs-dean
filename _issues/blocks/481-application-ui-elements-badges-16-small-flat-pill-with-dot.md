...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-a3e1f0728e54b8d4ec66a7dc5ec05e51

Catalog path: Application UI / elements / Badges / variant 16 of 16

## TPM Outcome

Ship `application-ui-elements-badges-16-small-flat-pill-with-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `480` and `application-ui-elements-badges-16-small-flat-pill-with-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(480)`, or look up `application-ui-elements-badges-16-small-flat-pill-with-dot` with
...
- The registry resolves both block id `480` and slug `application-ui-elements-badges-16-small-flat-pill-with-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-16-small-flat-pill-with-dot` story proves the fixture in both renderers.
