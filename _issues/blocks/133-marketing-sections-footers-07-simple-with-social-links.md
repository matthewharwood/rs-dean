...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-2804f3d86cef85d9e040bee6d08633d6

Catalog path: Marketing / sections / Footers / variant 7 of 7

## TPM Outcome

Ship `marketing-sections-footers-07-simple-with-social-links` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `132` and `marketing-sections-footers-07-simple-with-social-links` are the stable registry identity.
...
- Resolve `BlockId::from_index(132)`, or look up `marketing-sections-footers-07-simple-with-social-links` with
...
- The registry resolves both block id `132` and slug `marketing-sections-footers-07-simple-with-social-links` one-to-one.
...
- An isolated `block-marketing-sections-footers-07-simple-with-social-links` story proves the fixture in both renderers.
