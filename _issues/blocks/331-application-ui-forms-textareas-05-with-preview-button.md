...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/textareas#component-532d35bcb49664c16a4f877d71658b12

Catalog path: Application UI / forms / Textareas / variant 5 of 5

## TPM Outcome

Ship `application-ui-forms-textareas-05-with-preview-button` as a registered Rust-first block in the Textareas family. Preserve
...
- Block index `330` and `application-ui-forms-textareas-05-with-preview-button` are the stable registry identity.
...
- Resolve `BlockId::from_index(330)`, or look up `application-ui-forms-textareas-05-with-preview-button` with
...
- The registry resolves both block id `330` and slug `application-ui-forms-textareas-05-with-preview-button` one-to-one.
...
- An isolated `block-application-ui-forms-textareas-05-with-preview-button` story proves the fixture in both renderers.
