...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/home-screens#component-be6a9775f6e1a1a1e977799e4a209e2f

Catalog path: Application UI / page-examples / Home Screens / variant 1 of 2

## TPM Outcome

Ship `application-ui-page-examples-home-screens-01-sidebar` as a registered Rust-first block in the Home Screens family. Preserve
...
- Block index `537` and `application-ui-page-examples-home-screens-01-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(537)`, or look up `application-ui-page-examples-home-screens-01-sidebar` with
...
- The registry resolves both block id `537` and slug `application-ui-page-examples-home-screens-01-sidebar` one-to-one.
...
- An isolated `block-application-ui-page-examples-home-screens-01-sidebar` story proves the fixture in both renderers.
