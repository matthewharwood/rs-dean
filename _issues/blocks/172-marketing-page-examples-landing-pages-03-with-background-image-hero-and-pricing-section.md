...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/landing-pages#component-c9ffe5deded27ba87841128323150da9

Catalog path: Marketing / page-examples / Landing Pages / variant 3 of 4

## TPM Outcome

Ship `marketing-page-examples-landing-pages-03-with-background-image-hero-and-pricing-section` as a registered Rust-first block in the Landing Pages family. Preserve
...
- Block index `171` and `marketing-page-examples-landing-pages-03-with-background-image-hero-and-pricing-section` are the stable registry identity.
...
- Resolve `BlockId::from_index(171)`, or look up `marketing-page-examples-landing-pages-03-with-background-image-hero-and-pricing-section` with
...
- The registry resolves both block id `171` and slug `marketing-page-examples-landing-pages-03-with-background-image-hero-and-pricing-section` one-to-one.
...
- An isolated `block-marketing-page-examples-landing-pages-03-with-background-image-hero-and-pricing-section` story proves the fixture in both renderers.
