...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/dropdowns#component-1f7aa0b082c3b5074c78634c7d29588e

Catalog path: Application UI / elements / Dropdowns / variant 5 of 5

## TPM Outcome

Ship `application-ui-elements-dropdowns-05-with-simple-header` as a registered Rust-first block in the Dropdowns family. Preserve
...
- Block index `485` and `application-ui-elements-dropdowns-05-with-simple-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(485)`, or look up `application-ui-elements-dropdowns-05-with-simple-header` with
...
- The registry resolves both block id `485` and slug `application-ui-elements-dropdowns-05-with-simple-header` one-to-one.
...
- An isolated `block-application-ui-elements-dropdowns-05-with-simple-header` story proves the fixture in both renderers.
