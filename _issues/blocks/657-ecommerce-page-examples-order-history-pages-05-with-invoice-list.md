...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-90bf96c1fb7c25a8887c40ff21cd52da

Catalog path: Ecommerce / page-examples / Order History Pages / variant 5 of 5

## TPM Outcome

Ship `ecommerce-page-examples-order-history-pages-05-with-invoice-list` as a registered Rust-first block in the Order History Pages family. Preserve
...
- Block index `656` and `ecommerce-page-examples-order-history-pages-05-with-invoice-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(656)`, or look up `ecommerce-page-examples-order-history-pages-05-with-invoice-list` with
...
- The registry resolves both block id `656` and slug `ecommerce-page-examples-order-history-pages-05-with-invoice-list` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-history-pages-05-with-invoice-list` story proves the fixture in both renderers.
