...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-d33c977953fba7ea4736a741436839af

Catalog path: Ecommerce / components / Promo Sections / variant 5 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-05-with-overlapping-image-tiles` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `598` and `ecommerce-components-promo-sections-05-with-overlapping-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(598)`, or look up `ecommerce-components-promo-sections-05-with-overlapping-image-tiles` with
...
- The registry resolves both block id `598` and slug `ecommerce-components-promo-sections-05-with-overlapping-image-tiles` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-05-with-overlapping-image-tiles` story proves the fixture in both renderers.
