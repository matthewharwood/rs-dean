...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-d4761775d88a3e2127cd14e89431c257

Catalog path: Application UI / layout / Media Objects / variant 7 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-07-wide-responsive` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `527` and `application-ui-layout-media-objects-07-wide-responsive` are the stable registry identity.
...
- Resolve `BlockId::from_index(527)`, or look up `application-ui-layout-media-objects-07-wide-responsive` with
...
- The registry resolves both block id `527` and slug `application-ui-layout-media-objects-07-wide-responsive` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-07-wide-responsive` story proves the fixture in both renderers.
