...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/category-pages#component-d26d67381a533dac62c1282d92c01f2e

Catalog path: Ecommerce / page-examples / Category Pages / variant 3 of 5

## TPM Outcome

Ship `ecommerce-page-examples-category-pages-03-with-text-header-and-simple-product-grid` as a registered Rust-first block in the Category Pages family. Preserve
...
- Block index `638` and `ecommerce-page-examples-category-pages-03-with-text-header-and-simple-product-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(638)`, or look up `ecommerce-page-examples-category-pages-03-with-text-header-and-simple-product-grid` with
...
- The registry resolves both block id `638` and slug `ecommerce-page-examples-category-pages-03-with-text-header-and-simple-product-grid` one-to-one.
...
- An isolated `block-ecommerce-page-examples-category-pages-03-with-text-header-and-simple-product-grid` story proves the fixture in both renderers.
