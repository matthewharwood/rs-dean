...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/settings-screens#component-4df3bf06aaf8ab19c5e6bb0b09edacfd

Catalog path: Application UI / page-examples / Settings Screens / variant 1 of 2

## TPM Outcome

Ship `application-ui-page-examples-settings-screens-01-sidebar` as a registered Rust-first block in the Settings Screens family. Preserve
...
- Block index `541` and `application-ui-page-examples-settings-screens-01-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(541)`, or look up `application-ui-page-examples-settings-screens-01-sidebar` with
...
- The registry resolves both block id `541` and slug `application-ui-page-examples-settings-screens-01-sidebar` one-to-one.
...
- An isolated `block-application-ui-page-examples-settings-screens-01-sidebar` story proves the fixture in both renderers.
