...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-452126c6f087d341b296dcc8d0fb86a5

Catalog path: Application UI / layout / Media Objects / variant 4 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-04-stretched-to-fit` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `524` and `application-ui-layout-media-objects-04-stretched-to-fit` are the stable registry identity.
...
- Resolve `BlockId::from_index(524)`, or look up `application-ui-layout-media-objects-04-stretched-to-fit` with
...
- The registry resolves both block id `524` and slug `application-ui-layout-media-objects-04-stretched-to-fit` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-04-stretched-to-fit` story proves the fixture in both renderers.
