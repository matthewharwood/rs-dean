...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-65815af4357dfdcf9be55c390221c5fb

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 2 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-02-full-width-secondary-column-on-right` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
...
- Block index `197` and `application-ui-application-shells-multi-column-02-full-width-secondary-column-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(197)`, or look up `application-ui-application-shells-multi-column-02-full-width-secondary-column-on-right` with
...
- The registry resolves both block id `197` and slug `application-ui-application-shells-multi-column-02-full-width-secondary-column-on-right` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-02-full-width-secondary-column-on-right` story proves the fixture in both renderers.
