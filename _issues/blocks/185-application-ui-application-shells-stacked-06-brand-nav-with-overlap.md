...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-2c220920c5e70d33aeaa56deb4df3f0e

Catalog path: Application UI / application-shells / Stacked Layouts / variant 6 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-06-brand-nav-with-overlap` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `184` and `application-ui-application-shells-stacked-06-brand-nav-with-overlap` are the stable registry identity.
...
- Resolve `BlockId::from_index(184)`, or look up `application-ui-application-shells-stacked-06-brand-nav-with-overlap` with
...
- The registry resolves both block id `184` and slug `application-ui-application-shells-stacked-06-brand-nav-with-overlap` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-06-brand-nav-with-overlap` story proves the fixture in both renderers.
