...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/shopping-carts#component-49ea2974de976a1db7cc7411a85bb2b1

Catalog path: Ecommerce / components / Shopping Carts / variant 4 of 6

## TPM Outcome

Ship `ecommerce-components-shopping-carts-04-drawer` as a registered Rust-first block in the Shopping Carts family. Preserve
...
- Block index `568` and `ecommerce-components-shopping-carts-04-drawer` are the stable registry identity.
...
- Resolve `BlockId::from_index(568)`, or look up `ecommerce-components-shopping-carts-04-drawer` with
...
- The registry resolves both block id `568` and slug `ecommerce-components-shopping-carts-04-drawer` one-to-one.
...
- An isolated `block-ecommerce-components-shopping-carts-04-drawer` story proves the fixture in both renderers.
