...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/logo-clouds#component-fd820f87009f8bfcba4533c929686aad

Catalog path: Marketing / sections / Logo Clouds / variant 5 of 6

## TPM Outcome

Ship `marketing-sections-logo-clouds-05-simple` as a registered Rust-first block in the Logo Clouds family. Preserve
...
- Block index `117` and `marketing-sections-logo-clouds-05-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(117)`, or look up `marketing-sections-logo-clouds-05-simple` with
...
- The registry resolves both block id `117` and slug `marketing-sections-logo-clouds-05-simple` one-to-one.
...
- An isolated `block-marketing-sections-logo-clouds-05-simple` story proves the fixture in both renderers.
