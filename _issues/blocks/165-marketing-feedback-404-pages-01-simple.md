...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/feedback/404-pages#component-ebef3404d06e7b5f42e85b7b2ca4a2a5

Catalog path: Marketing / feedback / 404 Pages / variant 1 of 5

## TPM Outcome

Ship `marketing-feedback-404-pages-01-simple` as a registered Rust-first block in the 404 Pages family. Preserve
...
- Block index `164` and `marketing-feedback-404-pages-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(164)`, or look up `marketing-feedback-404-pages-01-simple` with
...
- The registry resolves both block id `164` and slug `marketing-feedback-404-pages-01-simple` one-to-one.
...
- An isolated `block-marketing-feedback-404-pages-01-simple` story proves the fixture in both renderers.
