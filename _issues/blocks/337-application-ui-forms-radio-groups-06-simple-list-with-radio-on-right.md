...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-f1d8d3ffc64bc16a36304a465a2a4c70

Catalog path: Application UI / forms / Radio Groups / variant 6 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-06-simple-list-with-radio-on-right` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `336` and `application-ui-forms-radio-groups-06-simple-list-with-radio-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(336)`, or look up `application-ui-forms-radio-groups-06-simple-list-with-radio-on-right` with
...
- The registry resolves both block id `336` and slug `application-ui-forms-radio-groups-06-simple-list-with-radio-on-right` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-06-simple-list-with-radio-on-right` story proves the fixture in both renderers.
