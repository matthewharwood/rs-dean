...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-7a07446d5ac240767202f521f7065893

Catalog path: Application UI / data-display / Description Lists / variant 5 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-05-left-aligned-with-inline-actions` as a registered Rust-first block in the Description Lists family. Preserve
...
- Block index `231` and `application-ui-data-display-description-lists-05-left-aligned-with-inline-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(231)`, or look up `application-ui-data-display-description-lists-05-left-aligned-with-inline-actions` with
...
- The registry resolves both block id `231` and slug `application-ui-data-display-description-lists-05-left-aligned-with-inline-actions` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-05-left-aligned-with-inline-actions` story proves the fixture in both renderers.
