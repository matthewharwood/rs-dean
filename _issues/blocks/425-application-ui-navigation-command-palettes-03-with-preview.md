...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-5e859372042e1b3b308dc51f3ac8bad6

Catalog path: Application UI / navigation / Command Palettes / variant 3 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-03-with-preview` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `424` and `application-ui-navigation-command-palettes-03-with-preview` are the stable registry identity.
...
- Resolve `BlockId::from_index(424)`, or look up `application-ui-navigation-command-palettes-03-with-preview` with
...
- The registry resolves both block id `424` and slug `application-ui-navigation-command-palettes-03-with-preview` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-03-with-preview` story proves the fixture in both renderers.
