...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-57db2be0bad7665ad4538e64fb878835

Catalog path: Application UI / forms / Radio Groups / variant 12 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-12-stacked-cards` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `342` and `application-ui-forms-radio-groups-12-stacked-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(342)`, or look up `application-ui-forms-radio-groups-12-stacked-cards` with
...
- The registry resolves both block id `342` and slug `application-ui-forms-radio-groups-12-stacked-cards` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-12-stacked-cards` story proves the fixture in both renderers.
