...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-7c4bcd0e50e14e855d55d20b6cd445d1

Catalog path: Marketing / sections / Blog Sections / variant 3 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-03-three-column-with-background-images` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `85` and `marketing-sections-blog-sections-03-three-column-with-background-images` are the stable registry identity.
...
- The family maps to the `Collection` composition pattern and the `Card`
  primary UI component.
- Variant behavior is constrained by `Background image`, `Plain`, and `Static`
...
- Resolve `BlockId::from_index(85)`, or look up `marketing-sections-blog-sections-03-three-column-with-background-images` with
...
- The registry resolves both block id `85` and slug `marketing-sections-blog-sections-03-three-column-with-background-images` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-03-three-column-with-background-images` story proves the fixture in both renderers.
