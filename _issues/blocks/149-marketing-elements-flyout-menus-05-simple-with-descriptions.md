...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-da3c449b5eaaf6a791a2cc48f2e87fb4

Catalog path: Marketing / elements / Flyout Menus / variant 5 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-05-simple-with-descriptions` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `148` and `marketing-elements-flyout-menus-05-simple-with-descriptions` are the stable registry identity.
...
- Resolve `BlockId::from_index(148)`, or look up `marketing-elements-flyout-menus-05-simple-with-descriptions` with
...
- The registry resolves both block id `148` and slug `marketing-elements-flyout-menus-05-simple-with-descriptions` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-05-simple-with-descriptions` story proves the fixture in both renderers.
