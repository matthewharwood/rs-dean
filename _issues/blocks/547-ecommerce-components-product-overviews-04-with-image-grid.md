...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-overviews#component-2904df5d10ee9fc81ba07d1ad61a27ca

Catalog path: Ecommerce / components / Product Overviews / variant 4 of 5

## TPM Outcome

Ship `ecommerce-components-product-overviews-04-with-image-grid` as a registered Rust-first block in the Product Overviews family. Preserve
...
- Block index `546` and `ecommerce-components-product-overviews-04-with-image-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(546)`, or look up `ecommerce-components-product-overviews-04-with-image-grid` with
...
- The registry resolves both block id `546` and slug `ecommerce-components-product-overviews-04-with-image-grid` one-to-one.
...
- An isolated `block-ecommerce-components-product-overviews-04-with-image-grid` story proves the fixture in both renderers.
