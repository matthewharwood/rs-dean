...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-ed0bd6107e9619f08a549f76f5073f20

Catalog path: Application UI / headings / Section Headings / variant 10 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-10-with-badge-and-dropdown` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `226` and `application-ui-headings-section-headings-10-with-badge-and-dropdown` are the stable registry identity.
...
- Resolve `BlockId::from_index(226)`, or look up `application-ui-headings-section-headings-10-with-badge-and-dropdown` with
...
- The registry resolves both block id `226` and slug `application-ui-headings-section-headings-10-with-badge-and-dropdown` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-10-with-badge-and-dropdown` story proves the fixture in both renderers.
