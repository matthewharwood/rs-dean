...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/dividers#component-b2f379aa4cf58206058b791ad1e3bda1

Catalog path: Application UI / layout / Dividers / variant 5 of 8

## TPM Outcome

Ship `application-ui-layout-dividers-05-with-title-on-left` as a registered Rust-first block in the Dividers family. Preserve
...
- Block index `533` and `application-ui-layout-dividers-05-with-title-on-left` are the stable registry identity.
...
- Resolve `BlockId::from_index(533)`, or look up `application-ui-layout-dividers-05-with-title-on-left` with
...
- The registry resolves both block id `533` and slug `application-ui-layout-dividers-05-with-title-on-left` one-to-one.
...
- An isolated `block-application-ui-layout-dividers-05-with-title-on-left` story proves the fixture in both renderers.
