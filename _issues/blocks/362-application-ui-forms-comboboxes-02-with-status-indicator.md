...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/comboboxes#component-02fc8b97c1a1d2d7c0edb5c8c081b013

Catalog path: Application UI / forms / Comboboxes / variant 2 of 4

## TPM Outcome

Ship `application-ui-forms-comboboxes-02-with-status-indicator` as a registered Rust-first block in the Comboboxes family. Preserve
...
- Block index `361` and `application-ui-forms-comboboxes-02-with-status-indicator` are the stable registry identity.
...
- Resolve `BlockId::from_index(361)`, or look up `application-ui-forms-comboboxes-02-with-status-indicator` with
...
- The registry resolves both block id `361` and slug `application-ui-forms-comboboxes-02-with-status-indicator` one-to-one.
...
- An isolated `block-application-ui-forms-comboboxes-02-with-status-indicator` story proves the fixture in both renderers.
