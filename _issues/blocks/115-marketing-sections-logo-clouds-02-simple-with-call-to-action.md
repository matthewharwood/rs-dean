...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/logo-clouds#component-41819e575f2ea4dc492ce0155e48f5ee

Catalog path: Marketing / sections / Logo Clouds / variant 2 of 6

## TPM Outcome

Ship `marketing-sections-logo-clouds-02-simple-with-call-to-action` as a registered Rust-first block in the Logo Clouds family. Preserve
...
- Block index `114` and `marketing-sections-logo-clouds-02-simple-with-call-to-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(114)`, or look up `marketing-sections-logo-clouds-02-simple-with-call-to-action` with
...
- The registry resolves both block id `114` and slug `marketing-sections-logo-clouds-02-simple-with-call-to-action` one-to-one.
...
- An isolated `block-marketing-sections-logo-clouds-02-simple-with-call-to-action` story proves the fixture in both renderers.
