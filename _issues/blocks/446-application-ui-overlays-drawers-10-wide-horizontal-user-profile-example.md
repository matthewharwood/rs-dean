...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-bfaf7b76cebcda82afc880e39abf3118

Catalog path: Application UI / overlays / Drawers / variant 10 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-10-wide-horizontal-user-profile-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `445` and `application-ui-overlays-drawers-10-wide-horizontal-user-profile-example` are the stable registry identity.
...
- The family maps to the `Overlay` composition pattern and the `Drawer`
...
- Resolve `BlockId::from_index(445)`, or look up `application-ui-overlays-drawers-10-wide-horizontal-user-profile-example` with
...
- The registry resolves both block id `445` and slug `application-ui-overlays-drawers-10-wide-horizontal-user-profile-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-10-wide-horizontal-user-profile-example` story proves the fixture in both renderers.
