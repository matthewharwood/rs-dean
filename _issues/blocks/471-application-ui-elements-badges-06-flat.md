...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-c5758123766e87db286ca66d5cb55872

Catalog path: Application UI / elements / Badges / variant 6 of 16

## TPM Outcome

Ship `application-ui-elements-badges-06-flat` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `470` and `application-ui-elements-badges-06-flat` are the stable registry identity.
...
- Resolve `BlockId::from_index(470)`, or look up `application-ui-elements-badges-06-flat` with
...
- The registry resolves both block id `470` and slug `application-ui-elements-badges-06-flat` one-to-one.
...
- An isolated `block-application-ui-elements-badges-06-flat` story proves the fixture in both renderers.
