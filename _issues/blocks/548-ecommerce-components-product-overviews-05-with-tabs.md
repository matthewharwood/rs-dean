...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-overviews#component-a4287d3928b87e3ac5c04af49bc062a8

Catalog path: Ecommerce / components / Product Overviews / variant 5 of 5

## TPM Outcome

Ship `ecommerce-components-product-overviews-05-with-tabs` as a registered Rust-first block in the Product Overviews family. Preserve
...
- Block index `547` and `ecommerce-components-product-overviews-05-with-tabs` are the stable registry identity.
...
- Variant behavior is constrained by `Product media`, `Plain`, and `Tabs`
...
- Resolve `BlockId::from_index(547)`, or look up `ecommerce-components-product-overviews-05-with-tabs` with
...
- The registry resolves both block id `547` and slug `ecommerce-components-product-overviews-05-with-tabs` one-to-one.
...
- An isolated `block-ecommerce-components-product-overviews-05-with-tabs` story proves the fixture in both renderers.
