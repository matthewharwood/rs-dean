...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-6aa46ca7c95f0e163e8fc04b59de7670

Catalog path: Marketing / sections / Blog Sections / variant 6 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-06-with-featured-post` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `88` and `marketing-sections-blog-sections-06-with-featured-post` are the stable registry identity.
...
- Resolve `BlockId::from_index(88)`, or look up `marketing-sections-blog-sections-06-with-featured-post` with
...
- The registry resolves both block id `88` and slug `marketing-sections-blog-sections-06-with-featured-post` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-06-with-featured-post` story proves the fixture in both renderers.
