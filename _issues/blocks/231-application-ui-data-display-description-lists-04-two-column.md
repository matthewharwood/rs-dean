...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-189e461eb3b78defcc758e837a875b6b

Catalog path: Application UI / data-display / Description Lists / variant 4 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-04-two-column` as a registered Rust-first block in the Description Lists family. Preserve
...
- Block index `230` and `application-ui-data-display-description-lists-04-two-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(230)`, or look up `application-ui-data-display-description-lists-04-two-column` with
...
- The registry resolves both block id `230` and slug `application-ui-data-display-description-lists-04-two-column` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-04-two-column` story proves the fixture in both renderers.
