...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-e772a4f0088a3ec0ac950b1eb0351989

Catalog path: Application UI / headings / Card Headings / variant 3 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-03-with-avatar-and-actions` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `213` and `application-ui-headings-card-headings-03-with-avatar-and-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(213)`, or look up `application-ui-headings-card-headings-03-with-avatar-and-actions` with
...
- The registry resolves both block id `213` and slug `application-ui-headings-card-headings-03-with-avatar-and-actions` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-03-with-avatar-and-actions` story proves the fixture in both renderers.
