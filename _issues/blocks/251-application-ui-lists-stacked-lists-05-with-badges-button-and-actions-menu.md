...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-aa5eae5161e0a8cd045cc1ed3f80302c

Catalog path: Application UI / lists / Stacked Lists / variant 5 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-05-with-badges-button-and-actions-menu` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `250` and `application-ui-lists-stacked-lists-05-with-badges-button-and-actions-menu` are the stable registry identity.
...
- Resolve `BlockId::from_index(250)`, or look up `application-ui-lists-stacked-lists-05-with-badges-button-and-actions-menu` with
...
- The registry resolves both block id `250` and slug `application-ui-lists-stacked-lists-05-with-badges-button-and-actions-menu` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-05-with-badges-button-and-actions-menu` story proves the fixture in both renderers.
