...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/checkout-forms#component-73aced7d668d593b93bde3aec63b0c37

Catalog path: Ecommerce / components / Checkout Forms / variant 2 of 5

## TPM Outcome

Ship `ecommerce-components-checkout-forms-02-with-mobile-order-summary-overlay` as a registered Rust-first block in the Checkout Forms family. Preserve
...
- Block index `603` and `ecommerce-components-checkout-forms-02-with-mobile-order-summary-overlay` are the stable registry identity.
...
- The family maps to the `Form` composition pattern and the `Field`
...
- Resolve `BlockId::from_index(603)`, or look up `ecommerce-components-checkout-forms-02-with-mobile-order-summary-overlay` with
...
- The registry resolves both block id `603` and slug `ecommerce-components-checkout-forms-02-with-mobile-order-summary-overlay` one-to-one.
...
- An isolated `block-ecommerce-components-checkout-forms-02-with-mobile-order-summary-overlay` story proves the fixture in both renderers.
