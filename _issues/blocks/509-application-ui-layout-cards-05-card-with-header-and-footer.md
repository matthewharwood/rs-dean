...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-30bb794fd4050766db6928c723ddf5ce

Catalog path: Application UI / layout / Cards / variant 5 of 10

## TPM Outcome

Ship `application-ui-layout-cards-05-card-with-header-and-footer` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `508` and `application-ui-layout-cards-05-card-with-header-and-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(508)`, or look up `application-ui-layout-cards-05-card-with-header-and-footer` with
...
- The registry resolves both block id `508` and slug `application-ui-layout-cards-05-card-with-header-and-footer` one-to-one.
...
- An isolated `block-application-ui-layout-cards-05-card-with-header-and-footer` story proves the fixture in both renderers.
