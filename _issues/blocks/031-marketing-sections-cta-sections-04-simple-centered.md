...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-25ce2a81d17545994655ccc4062651a4

Catalog path: Marketing / sections / CTA Sections / variant 4 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-04-simple-centered` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `30` and `marketing-sections-cta-sections-04-simple-centered` are the stable registry identity.
...
- Resolve `BlockId::from_index(30)`, or look up `marketing-sections-cta-sections-04-simple-centered` with
...
- The registry resolves both block id `30` and slug `marketing-sections-cta-sections-04-simple-centered` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-04-simple-centered` story proves the fixture in both renderers.
