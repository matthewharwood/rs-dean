...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/list-containers#component-1c3bb892112d30468d57dcc89c5298d1

Catalog path: Application UI / layout / List containers / variant 1 of 7

## TPM Outcome

Ship `application-ui-layout-list-containers-01-simple-with-dividers` as a registered Rust-first block in the List containers family. Preserve
...
- Block index `514` and `application-ui-layout-list-containers-01-simple-with-dividers` are the stable registry identity.
...
- Resolve `BlockId::from_index(514)`, or look up `application-ui-layout-list-containers-01-simple-with-dividers` with
...
- The registry resolves both block id `514` and slug `application-ui-layout-list-containers-01-simple-with-dividers` one-to-one.
...
- An isolated `block-application-ui-layout-list-containers-01-simple-with-dividers` story proves the fixture in both renderers.
