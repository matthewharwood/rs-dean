...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/sidebar-navigation#component-ea2064949c1427bc69284e1713dbbd6d

Catalog path: Application UI / navigation / Sidebar Navigation / variant 4 of 5

## TPM Outcome

Ship `application-ui-navigation-sidebar-navigation-04-with-secondary-navigation` as a registered Rust-first block in the Sidebar Navigation family. Preserve
...
- Block index `408` and `application-ui-navigation-sidebar-navigation-04-with-secondary-navigation` are the stable registry identity.
...
- The family maps to the `Navigation` composition pattern and the `Sidebar`
...
- Resolve `BlockId::from_index(408)`, or look up `application-ui-navigation-sidebar-navigation-04-with-secondary-navigation` with
...
- The registry resolves both block id `408` and slug `application-ui-navigation-sidebar-navigation-04-with-secondary-navigation` one-to-one.
...
- An isolated `block-application-ui-navigation-sidebar-navigation-04-with-secondary-navigation` story proves the fixture in both renderers.
