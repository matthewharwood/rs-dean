...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/category-pages#component-3fb96b1df336a2d60a972327e1c7f7d2

Catalog path: Ecommerce / page-examples / Category Pages / variant 2 of 5

## TPM Outcome

Ship `ecommerce-page-examples-category-pages-02-with-image-header-and-detail-product-grid` as a registered Rust-first block in the Category Pages family. Preserve
...
- Block index `637` and `ecommerce-page-examples-category-pages-02-with-image-header-and-detail-product-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(637)`, or look up `ecommerce-page-examples-category-pages-02-with-image-header-and-detail-product-grid` with
...
- The registry resolves both block id `637` and slug `ecommerce-page-examples-category-pages-02-with-image-header-and-detail-product-grid` one-to-one.
...
- An isolated `block-ecommerce-page-examples-category-pages-02-with-image-header-and-detail-product-grid` story proves the fixture in both renderers.
