...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/store-navigation#component-8c91476c7d73e3d73f9629ec734ccffa

Catalog path: Ecommerce / components / Store Navigation / variant 5 of 5

## TPM Outcome

Ship `ecommerce-components-store-navigation-05-with-double-column-and-persistent-mobile-nav` as a registered Rust-first block in the Store Navigation family. Preserve
...
- Block index `593` and `ecommerce-components-store-navigation-05-with-double-column-and-persistent-mobile-nav` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Plain`, and `Menu`
...
- Resolve `BlockId::from_index(593)`, or look up `ecommerce-components-store-navigation-05-with-double-column-and-persistent-mobile-nav` with
...
- The registry resolves both block id `593` and slug `ecommerce-components-store-navigation-05-with-double-column-and-persistent-mobile-nav` one-to-one.
...
- An isolated `block-ecommerce-components-store-navigation-05-with-double-column-and-persistent-mobile-nav` story proves the fixture in both renderers.
