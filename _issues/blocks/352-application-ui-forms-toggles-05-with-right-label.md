...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/toggles#component-b99e1c97056ef7d294767c9def084f7b

Catalog path: Application UI / forms / Toggles / variant 5 of 5

## TPM Outcome

Ship `application-ui-forms-toggles-05-with-right-label` as a registered Rust-first block in the Toggles family. Preserve
...
- Block index `351` and `application-ui-forms-toggles-05-with-right-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(351)`, or look up `application-ui-forms-toggles-05-with-right-label` with
...
- The registry resolves both block id `351` and slug `application-ui-forms-toggles-05-with-right-label` one-to-one.
...
- An isolated `block-application-ui-forms-toggles-05-with-right-label` story proves the fixture in both renderers.
