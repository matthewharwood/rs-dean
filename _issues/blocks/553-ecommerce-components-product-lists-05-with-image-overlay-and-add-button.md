...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-d8eb32559745988d0026cae377c493a0

Catalog path: Ecommerce / components / Product Lists / variant 5 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-05-with-image-overlay-and-add-button` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `552` and `ecommerce-components-product-lists-05-with-image-overlay-and-add-button` are the stable registry identity.
...
- Variant behavior is constrained by `Image`, `Plain`, and `Overlay`
...
- Resolve `BlockId::from_index(552)`, or look up `ecommerce-components-product-lists-05-with-image-overlay-and-add-button` with
...
- The registry resolves both block id `552` and slug `ecommerce-components-product-lists-05-with-image-overlay-and-add-button` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-05-with-image-overlay-and-add-button` story proves the fixture in both renderers.
