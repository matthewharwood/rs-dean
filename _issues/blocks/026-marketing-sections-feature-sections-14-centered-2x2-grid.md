...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-64ac58e032276db96bf343a8d4f332a8

Catalog path: Marketing / sections / Feature Sections / variant 14 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-14-centered-2x2-grid` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `25` and `marketing-sections-feature-sections-14-centered-2x2-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(25)`, or look up `marketing-sections-feature-sections-14-centered-2x2-grid` with
...
- The registry resolves both block id `25` and slug `marketing-sections-feature-sections-14-centered-2x2-grid` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-14-centered-2x2-grid` story proves the fixture in both renderers.
