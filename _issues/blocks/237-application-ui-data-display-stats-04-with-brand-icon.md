...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/stats#component-0d73a2494863902616f059ddcb5da2d5

Catalog path: Application UI / data-display / Stats / variant 4 of 5

## TPM Outcome

Ship `application-ui-data-display-stats-04-with-brand-icon` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `236` and `application-ui-data-display-stats-04-with-brand-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(236)`, or look up `application-ui-data-display-stats-04-with-brand-icon` with
...
- The registry resolves both block id `236` and slug `application-ui-data-display-stats-04-with-brand-icon` one-to-one.
...
- An isolated `block-application-ui-data-display-stats-04-with-brand-icon` story proves the fixture in both renderers.
