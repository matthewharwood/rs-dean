...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-24b27a127824cbc843ef2542d46fb3dc

Catalog path: Ecommerce / components / Incentives / variant 5 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-05-3-column-with-illustrations-and-heading` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `623` and `ecommerce-components-incentives-05-3-column-with-illustrations-and-heading` are the stable registry identity.
...
- Resolve `BlockId::from_index(623)`, or look up `ecommerce-components-incentives-05-3-column-with-illustrations-and-heading` with
...
- The registry resolves both block id `623` and slug `ecommerce-components-incentives-05-3-column-with-illustrations-and-heading` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-05-3-column-with-illustrations-and-heading` story proves the fixture in both renderers.
