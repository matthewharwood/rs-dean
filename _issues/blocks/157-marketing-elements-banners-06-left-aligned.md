...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-49536ab3f61c13112b042a7cb8293dbb

Catalog path: Marketing / elements / Banners / variant 6 of 13

## TPM Outcome

Ship `marketing-elements-banners-06-left-aligned` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `156` and `marketing-elements-banners-06-left-aligned` are the stable registry identity.
...
- Resolve `BlockId::from_index(156)`, or look up `marketing-elements-banners-06-left-aligned` with
...
- The registry resolves both block id `156` and slug `marketing-elements-banners-06-left-aligned` one-to-one.
...
- An isolated `block-marketing-elements-banners-06-left-aligned` story proves the fixture in both renderers.
