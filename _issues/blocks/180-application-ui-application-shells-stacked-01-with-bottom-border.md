...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-c0d6b19d73d2f3045ca388de0ab7c11b

Catalog path: Application UI / application-shells / Stacked Layouts / variant 1 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-01-with-bottom-border` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `179` and `application-ui-application-shells-stacked-01-with-bottom-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(179)`, or look up `application-ui-application-shells-stacked-01-with-bottom-border` with
...
- The registry resolves both block id `179` and slug `application-ui-application-shells-stacked-01-with-bottom-border` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-01-with-bottom-border` story proves the fixture in both renderers.
