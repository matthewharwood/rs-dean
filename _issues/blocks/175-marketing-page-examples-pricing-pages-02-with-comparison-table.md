...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/pricing-pages#component-5f3268c0a01e789d4578d1f0f505594e

Catalog path: Marketing / page-examples / Pricing Pages / variant 2 of 3

## TPM Outcome

Ship `marketing-page-examples-pricing-pages-02-with-comparison-table` as a registered Rust-first block in the Pricing Pages family. Preserve
...
- Block index `174` and `marketing-page-examples-pricing-pages-02-with-comparison-table` are the stable registry identity.
...
- Resolve `BlockId::from_index(174)`, or look up `marketing-page-examples-pricing-pages-02-with-comparison-table` with
...
- The registry resolves both block id `174` and slug `marketing-page-examples-pricing-pages-02-with-comparison-table` one-to-one.
...
- An isolated `block-marketing-page-examples-pricing-pages-02-with-comparison-table` story proves the fixture in both renderers.
