...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-911576fb54922e5199a9434ca8a273fd

Catalog path: Marketing / elements / Flyout Menus / variant 1 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-01-stacked-with-footer-actions` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `144` and `marketing-elements-flyout-menus-01-stacked-with-footer-actions` are the stable registry identity.
...
- The family maps to the `Menu` composition pattern and the `Dropdown Menu`
...
- Resolve `BlockId::from_index(144)`, or look up `marketing-elements-flyout-menus-01-stacked-with-footer-actions` with
...
- The registry resolves both block id `144` and slug `marketing-elements-flyout-menus-01-stacked-with-footer-actions` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-01-stacked-with-footer-actions` story proves the fixture in both renderers.
