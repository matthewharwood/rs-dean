...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-d6ba419d2b33a8ab4fd662189bfd8a31

Catalog path: Application UI / forms / Input Groups / variant 7 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-07-input-with-leading-icon` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `300` and `application-ui-forms-input-groups-07-input-with-leading-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(300)`, or look up `application-ui-forms-input-groups-07-input-with-leading-icon` with
...
- The registry resolves both block id `300` and slug `application-ui-forms-input-groups-07-input-with-leading-icon` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-07-input-with-leading-icon` story proves the fixture in both renderers.
