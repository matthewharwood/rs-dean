...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-1d53bd55122e563ea1f5c7f84221f993

Catalog path: Application UI / layout / Media Objects / variant 6 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-06-basic-responsive` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `526` and `application-ui-layout-media-objects-06-basic-responsive` are the stable registry identity.
...
- Resolve `BlockId::from_index(526)`, or look up `application-ui-layout-media-objects-06-basic-responsive` with
...
- The registry resolves both block id `526` and slug `application-ui-layout-media-objects-06-basic-responsive` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-06-basic-responsive` story proves the fixture in both renderers.
