...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/feeds#component-81e5ec57a92ddcadaa913e7bb68336fe

Catalog path: Application UI / lists / Feeds / variant 2 of 3

## TPM Outcome

Ship `application-ui-lists-feeds-02-with-comments` as a registered Rust-first block in the Feeds family. Preserve
...
- Block index `288` and `application-ui-lists-feeds-02-with-comments` are the stable registry identity.
...
- Resolve `BlockId::from_index(288)`, or look up `application-ui-lists-feeds-02-with-comments` with
...
- The registry resolves both block id `288` and slug `application-ui-lists-feeds-02-with-comments` one-to-one.
...
- An isolated `block-application-ui-lists-feeds-02-with-comments` story proves the fixture in both renderers.
