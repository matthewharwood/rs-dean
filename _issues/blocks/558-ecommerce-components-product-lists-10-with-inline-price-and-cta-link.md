...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-fd91c8fdd2322460930a44680b4ee7b9

Catalog path: Ecommerce / components / Product Lists / variant 10 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-10-with-inline-price-and-cta-link` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `557` and `ecommerce-components-product-lists-10-with-inline-price-and-cta-link` are the stable registry identity.
...
- Resolve `BlockId::from_index(557)`, or look up `ecommerce-components-product-lists-10-with-inline-price-and-cta-link` with
...
- The registry resolves both block id `557` and slug `ecommerce-components-product-lists-10-with-inline-price-and-cta-link` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-10-with-inline-price-and-cta-link` story proves the fixture in both renderers.
