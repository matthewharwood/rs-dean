...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-51e7bd07cdcacb755fd1f4ad6fde01ab

Catalog path: Marketing / elements / Flyout Menus / variant 4 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-04-full-width` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `147` and `marketing-elements-flyout-menus-04-full-width` are the stable registry identity.
...
- Resolve `BlockId::from_index(147)`, or look up `marketing-elements-flyout-menus-04-full-width` with
...
- The registry resolves both block id `147` and slug `marketing-elements-flyout-menus-04-full-width` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-04-full-width` story proves the fixture in both renderers.
