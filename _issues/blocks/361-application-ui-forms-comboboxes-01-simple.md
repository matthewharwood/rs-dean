...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/comboboxes#component-886412bdec54790d0c35bb5a09086c9a

Catalog path: Application UI / forms / Comboboxes / variant 1 of 4

## TPM Outcome

Ship `application-ui-forms-comboboxes-01-simple` as a registered Rust-first block in the Comboboxes family. Preserve
...
- Block index `360` and `application-ui-forms-comboboxes-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(360)`, or look up `application-ui-forms-comboboxes-01-simple` with
...
- The registry resolves both block id `360` and slug `application-ui-forms-comboboxes-01-simple` one-to-one.
...
- An isolated `block-application-ui-forms-comboboxes-01-simple` story proves the fixture in both renderers.
