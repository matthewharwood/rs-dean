...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-ebd95eb76948b1f97351bc44b63203aa

Catalog path: Application UI / navigation / Progress Bars / variant 2 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-02-panels` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `415` and `application-ui-navigation-progress-bars-02-panels` are the stable registry identity.
...
- Resolve `BlockId::from_index(415)`, or look up `application-ui-navigation-progress-bars-02-panels` with
...
- The registry resolves both block id `415` and slug `application-ui-navigation-progress-bars-02-panels` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-02-panels` story proves the fixture in both renderers.
