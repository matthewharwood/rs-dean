...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/dropdowns#component-f8a14da22f26a67757b19f2fe3ca00ed

Catalog path: Application UI / elements / Dropdowns / variant 1 of 5

## TPM Outcome

Ship `application-ui-elements-dropdowns-01-simple` as a registered Rust-first block in the Dropdowns family. Preserve
...
- Block index `481` and `application-ui-elements-dropdowns-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(481)`, or look up `application-ui-elements-dropdowns-01-simple` with
...
- The registry resolves both block id `481` and slug `application-ui-elements-dropdowns-01-simple` one-to-one.
...
- An isolated `block-application-ui-elements-dropdowns-01-simple` story proves the fixture in both renderers.
