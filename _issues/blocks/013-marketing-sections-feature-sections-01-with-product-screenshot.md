...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-11e5dbce11b8c462441792503ea864fc

Catalog path: Marketing / sections / Feature Sections / variant 1 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-01-with-product-screenshot` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `12` and `marketing-sections-feature-sections-01-with-product-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(12)`, or look up `marketing-sections-feature-sections-01-with-product-screenshot` with
...
- The registry resolves both block id `12` and slug `marketing-sections-feature-sections-01-with-product-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-01-with-product-screenshot` story proves the fixture in both renderers.
