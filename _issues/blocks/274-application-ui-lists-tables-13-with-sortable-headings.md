...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-7b5a46e74e475708d966ca31716f1771

Catalog path: Application UI / lists / Tables / variant 13 of 19

## TPM Outcome

Ship `application-ui-lists-tables-13-with-sortable-headings` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `273` and `application-ui-lists-tables-13-with-sortable-headings` are the stable registry identity.
...
- Resolve `BlockId::from_index(273)`, or look up `application-ui-lists-tables-13-with-sortable-headings` with
...
- The registry resolves both block id `273` and slug `application-ui-lists-tables-13-with-sortable-headings` one-to-one.
...
- An isolated `block-application-ui-lists-tables-13-with-sortable-headings` story proves the fixture in both renderers.
