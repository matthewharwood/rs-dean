...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-b8172652fa29dc3eac306c2a8a922323

Catalog path: Marketing / sections / Blog Sections / variant 1 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-01-three-column` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `83` and `marketing-sections-blog-sections-01-three-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(83)`, or look up `marketing-sections-blog-sections-01-three-column` with
...
- The registry resolves both block id `83` and slug `marketing-sections-blog-sections-01-three-column` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-01-three-column` story proves the fixture in both renderers.
