...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-ce021f02f586e0e6a5f8de2ca2ee537b

Catalog path: Application UI / lists / Grid Lists / variant 1 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-01-contact-cards-with-small-portraits` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `280` and `application-ui-lists-grid-lists-01-contact-cards-with-small-portraits` are the stable registry identity.
...
- Resolve `BlockId::from_index(280)`, or look up `application-ui-lists-grid-lists-01-contact-cards-with-small-portraits` with
...
- The registry resolves both block id `280` and slug `application-ui-lists-grid-lists-01-contact-cards-with-small-portraits` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-01-contact-cards-with-small-portraits` story proves the fixture in both renderers.
