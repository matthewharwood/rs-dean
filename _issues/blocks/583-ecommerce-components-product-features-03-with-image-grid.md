...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-6bf262ecea63105e5f1fc57ec12057f9

Catalog path: Ecommerce / components / Product Features / variant 3 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-03-with-image-grid` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `582` and `ecommerce-components-product-features-03-with-image-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(582)`, or look up `ecommerce-components-product-features-03-with-image-grid` with
...
- The registry resolves both block id `582` and slug `ecommerce-components-product-features-03-with-image-grid` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-03-with-image-grid` story proves the fixture in both renderers.
