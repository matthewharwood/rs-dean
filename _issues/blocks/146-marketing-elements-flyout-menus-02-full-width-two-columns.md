...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-f2922faa2add4efd389ddfccc77b2f22

Catalog path: Marketing / elements / Flyout Menus / variant 2 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-02-full-width-two-columns` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `145` and `marketing-elements-flyout-menus-02-full-width-two-columns` are the stable registry identity.
...
- Resolve `BlockId::from_index(145)`, or look up `marketing-elements-flyout-menus-02-full-width-two-columns` with
...
- The registry resolves both block id `145` and slug `marketing-elements-flyout-menus-02-full-width-two-columns` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-02-full-width-two-columns` story proves the fixture in both renderers.
