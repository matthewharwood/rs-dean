...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-52ce80a2e5549b97abb3d5d3f76f739e

Catalog path: Ecommerce / components / Incentives / variant 4 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-04-3-column-with-illustrations-and-centered-text` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `622` and `ecommerce-components-incentives-04-3-column-with-illustrations-and-centered-text` are the stable registry identity.
...
- The family maps to the `Metrics` composition pattern and the `Badge`
...
- Resolve `BlockId::from_index(622)`, or look up `ecommerce-components-incentives-04-3-column-with-illustrations-and-centered-text` with
...
- The registry resolves both block id `622` and slug `ecommerce-components-incentives-04-3-column-with-illustrations-and-centered-text` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-04-3-column-with-illustrations-and-centered-text` story proves the fixture in both renderers.
