...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-38742d005e7e8f48feb79dea72a0a8a5

Catalog path: Ecommerce / components / Incentives / variant 2 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-02-4-column-with-illustrations` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `620` and `ecommerce-components-incentives-02-4-column-with-illustrations` are the stable registry identity.
...
- Resolve `BlockId::from_index(620)`, or look up `ecommerce-components-incentives-02-4-column-with-illustrations` with
...
- The registry resolves both block id `620` and slug `ecommerce-components-incentives-02-4-column-with-illustrations` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-02-4-column-with-illustrations` story proves the fixture in both renderers.
