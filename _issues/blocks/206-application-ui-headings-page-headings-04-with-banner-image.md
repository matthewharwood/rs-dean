...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-6fae9e848a855282e0d7fc637cb94791

Catalog path: Application UI / headings / Page Headings / variant 4 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-04-with-banner-image` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `205` and `application-ui-headings-page-headings-04-with-banner-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(205)`, or look up `application-ui-headings-page-headings-04-with-banner-image` with
...
- The registry resolves both block id `205` and slug `application-ui-headings-page-headings-04-with-banner-image` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-04-with-banner-image` story proves the fixture in both renderers.
