...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-ac6bdf836c3a0b6b9588eb6e96d1b706

Catalog path: Application UI / forms / Action Panels / variant 2 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-02-with-link` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `353` and `application-ui-forms-action-panels-02-with-link` are the stable registry identity.
...
- Resolve `BlockId::from_index(353)`, or look up `application-ui-forms-action-panels-02-with-link` with
...
- The registry resolves both block id `353` and slug `application-ui-forms-action-panels-02-with-link` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-02-with-link` story proves the fixture in both renderers.
