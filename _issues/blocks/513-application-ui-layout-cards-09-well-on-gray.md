...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-19fd0a5dfcf9ea32f64b9d5f49d76db7

Catalog path: Application UI / layout / Cards / variant 9 of 10

## TPM Outcome

Ship `application-ui-layout-cards-09-well-on-gray` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `512` and `application-ui-layout-cards-09-well-on-gray` are the stable registry identity.
...
- Resolve `BlockId::from_index(512)`, or look up `application-ui-layout-cards-09-well-on-gray` with
...
- The registry resolves both block id `512` and slug `application-ui-layout-cards-09-well-on-gray` one-to-one.
...
- An isolated `block-application-ui-layout-cards-09-well-on-gray` story proves the fixture in both renderers.
