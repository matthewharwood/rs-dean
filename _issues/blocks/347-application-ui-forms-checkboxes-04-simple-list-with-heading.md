...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/checkboxes#component-fa06ef87d471092fb404c8c09e1af8a5

Catalog path: Application UI / forms / Checkboxes / variant 4 of 4

## TPM Outcome

Ship `application-ui-forms-checkboxes-04-simple-list-with-heading` as a registered Rust-first block in the Checkboxes family. Preserve
...
- Block index `346` and `application-ui-forms-checkboxes-04-simple-list-with-heading` are the stable registry identity.
...
- Resolve `BlockId::from_index(346)`, or look up `application-ui-forms-checkboxes-04-simple-list-with-heading` with
...
- The registry resolves both block id `346` and slug `application-ui-forms-checkboxes-04-simple-list-with-heading` one-to-one.
...
- An isolated `block-application-ui-forms-checkboxes-04-simple-list-with-heading` story proves the fixture in both renderers.
