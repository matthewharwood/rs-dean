...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/section-headings#component-e41884f80859d3afa20019532c28c1fb

Catalog path: Application UI / headings / Section Headings / variant 2 of 10

## TPM Outcome

Ship `application-ui-headings-section-headings-02-with-description` as a registered Rust-first block in the Section Headings family. Preserve
...
- Block index `218` and `application-ui-headings-section-headings-02-with-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(218)`, or look up `application-ui-headings-section-headings-02-with-description` with
...
- The registry resolves both block id `218` and slug `application-ui-headings-section-headings-02-with-description` one-to-one.
...
- An isolated `block-application-ui-headings-section-headings-02-with-description` story proves the fixture in both renderers.
