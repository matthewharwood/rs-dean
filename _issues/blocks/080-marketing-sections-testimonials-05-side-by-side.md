...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-54e74b5b1897b81f3537b3880df3811e

Catalog path: Marketing / sections / Testimonials / variant 5 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-05-side-by-side` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `79` and `marketing-sections-testimonials-05-side-by-side` are the stable registry identity.
...
- Resolve `BlockId::from_index(79)`, or look up `marketing-sections-testimonials-05-side-by-side` with
...
- The registry resolves both block id `79` and slug `marketing-sections-testimonials-05-side-by-side` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-05-side-by-side` story proves the fixture in both renderers.
