...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-6cef741e3fd54a859e5db689d52afcef

Catalog path: Application UI / elements / Buttons / variant 4 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-04-buttons-with-leading-icon` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `489` and `application-ui-elements-buttons-04-buttons-with-leading-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(489)`, or look up `application-ui-elements-buttons-04-buttons-with-leading-icon` with
...
- The registry resolves both block id `489` and slug `application-ui-elements-buttons-04-buttons-with-leading-icon` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-04-buttons-with-leading-icon` story proves the fixture in both renderers.
