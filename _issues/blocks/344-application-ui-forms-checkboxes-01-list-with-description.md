...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/checkboxes#component-f03fb959d6ba814eb987d39ae40961f0

Catalog path: Application UI / forms / Checkboxes / variant 1 of 4

## TPM Outcome

Ship `application-ui-forms-checkboxes-01-list-with-description` as a registered Rust-first block in the Checkboxes family. Preserve
...
- Block index `343` and `application-ui-forms-checkboxes-01-list-with-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(343)`, or look up `application-ui-forms-checkboxes-01-list-with-description` with
...
- The registry resolves both block id `343` and slug `application-ui-forms-checkboxes-01-list-with-description` one-to-one.
...
- An isolated `block-application-ui-forms-checkboxes-01-list-with-description` story proves the fixture in both renderers.
