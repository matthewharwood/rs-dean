...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-0bccd1058690fa6d03a79564f992f609

Catalog path: Ecommerce / components / Category Previews / variant 1 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-01-with-image-backgrounds` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `559` and `ecommerce-components-category-previews-01-with-image-backgrounds` are the stable registry identity.
...
- Resolve `BlockId::from_index(559)`, or look up `ecommerce-components-category-previews-01-with-image-backgrounds` with
...
- The registry resolves both block id `559` and slug `ecommerce-components-category-previews-01-with-image-backgrounds` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-01-with-image-backgrounds` story proves the fixture in both renderers.
