...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-4ec337def61b547035ce908c128bca5c

Catalog path: Application UI / lists / Grid Lists / variant 3 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-03-simple-cards` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `282` and `application-ui-lists-grid-lists-03-simple-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(282)`, or look up `application-ui-lists-grid-lists-03-simple-cards` with
...
- The registry resolves both block id `282` and slug `application-ui-lists-grid-lists-03-simple-cards` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-03-simple-cards` story proves the fixture in both renderers.
