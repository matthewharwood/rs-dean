...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-89f285aeebb60ddecb7ec8b5e664d525

Catalog path: Application UI / data-display / Calendars / variant 3 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-03-week-view` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `240` and `application-ui-data-display-calendars-03-week-view` are the stable registry identity.
...
- Resolve `BlockId::from_index(240)`, or look up `application-ui-data-display-calendars-03-week-view` with
...
- The registry resolves both block id `240` and slug `application-ui-data-display-calendars-03-week-view` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-03-week-view` story proves the fixture in both renderers.
