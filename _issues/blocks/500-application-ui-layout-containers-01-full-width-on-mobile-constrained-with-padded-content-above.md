...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/containers#component-fa14d2deae17e4c14964ef86ea0a1603

Catalog path: Application UI / layout / Containers / variant 1 of 5

## TPM Outcome

Ship `application-ui-layout-containers-01-full-width-on-mobile-constrained-with-padded-content-above` as a registered Rust-first block in the Containers family. Preserve
...
- Block index `499` and `application-ui-layout-containers-01-full-width-on-mobile-constrained-with-padded-content-above` are the stable registry identity.
...
- Resolve `BlockId::from_index(499)`, or look up `application-ui-layout-containers-01-full-width-on-mobile-constrained-with-padded-content-above` with
...
- The registry resolves both block id `499` and slug `application-ui-layout-containers-01-full-width-on-mobile-constrained-with-padded-content-above` one-to-one.
...
- An isolated `block-application-ui-layout-containers-01-full-width-on-mobile-constrained-with-padded-content-above` story proves the fixture in both renderers.
