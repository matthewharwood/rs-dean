...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-d95a835cac90b32aa5d8baa9ec647b59

Catalog path: Marketing / sections / Pricing Sections / variant 3 of 12

## TPM Outcome

Ship `marketing-sections-pricing-03-three-tiers-with-logos-and-feature-comparison` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `43` and `marketing-sections-pricing-03-three-tiers-with-logos-and-feature-comparison` are the stable registry identity.
...
- The family maps to the `Pricing` composition pattern and the `Card`
  primary UI component.
- Variant behavior is constrained by `Logo`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(43)`, or look up `marketing-sections-pricing-03-three-tiers-with-logos-and-feature-comparison` with
...
- The registry resolves both block id `43` and slug `marketing-sections-pricing-03-three-tiers-with-logos-and-feature-comparison` one-to-one.
...
- An isolated `block-marketing-sections-pricing-03-three-tiers-with-logos-and-feature-comparison` story proves the fixture in both renderers.
