...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-09826e92264e0f1fa45b8e6a88cb2725

Catalog path: Marketing / sections / Team Sections / variant 4 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-04-large-grid-with-cards` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `100` and `marketing-sections-team-sections-04-large-grid-with-cards` are the stable registry identity.
...
- The family maps to the `Collection` composition pattern and the `Avatar`
...
- Resolve `BlockId::from_index(100)`, or look up `marketing-sections-team-sections-04-large-grid-with-cards` with
...
- The registry resolves both block id `100` and slug `marketing-sections-team-sections-04-large-grid-with-cards` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-04-large-grid-with-cards` story proves the fixture in both renderers.
