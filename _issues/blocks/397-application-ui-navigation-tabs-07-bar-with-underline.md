...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-83b472fc38b57e49a566805a5e5bb2f7

Catalog path: Application UI / navigation / Tabs / variant 7 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-07-bar-with-underline` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `396` and `application-ui-navigation-tabs-07-bar-with-underline` are the stable registry identity.
...
- Resolve `BlockId::from_index(396)`, or look up `application-ui-navigation-tabs-07-bar-with-underline` with
...
- The registry resolves both block id `396` and slug `application-ui-navigation-tabs-07-bar-with-underline` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-07-bar-with-underline` story proves the fixture in both renderers.
