...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/button-groups#component-cbd15ccb80090a5dfb2d647be03b6ee9

Catalog path: Application UI / elements / Button Groups / variant 3 of 5

## TPM Outcome

Ship `application-ui-elements-button-groups-03-with-stat` as a registered Rust-first block in the Button Groups family. Preserve
...
- Block index `496` and `application-ui-elements-button-groups-03-with-stat` are the stable registry identity.
...
- Resolve `BlockId::from_index(496)`, or look up `application-ui-elements-button-groups-03-with-stat` with
...
- The registry resolves both block id `496` and slug `application-ui-elements-button-groups-03-with-stat` one-to-one.
...
- An isolated `block-application-ui-elements-button-groups-03-with-stat` story proves the fixture in both renderers.
