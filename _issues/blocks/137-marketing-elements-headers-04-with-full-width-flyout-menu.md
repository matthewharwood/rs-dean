...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-9b3074c76a13e5151c82c2be12e52a6c

Catalog path: Marketing / elements / Headers / variant 4 of 11

## TPM Outcome

Ship `marketing-elements-headers-04-with-full-width-flyout-menu` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `136` and `marketing-elements-headers-04-with-full-width-flyout-menu` are the stable registry identity.
...
- Resolve `BlockId::from_index(136)`, or look up `marketing-elements-headers-04-with-full-width-flyout-menu` with
...
- The registry resolves both block id `136` and slug `marketing-elements-headers-04-with-full-width-flyout-menu` one-to-one.
...
- An isolated `block-marketing-elements-headers-04-with-full-width-flyout-menu` story proves the fixture in both renderers.
