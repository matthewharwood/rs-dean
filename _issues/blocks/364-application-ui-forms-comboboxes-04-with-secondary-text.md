...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/comboboxes#component-0834ed9ce704a78cc0045ef92f4af723

Catalog path: Application UI / forms / Comboboxes / variant 4 of 4

## TPM Outcome

Ship `application-ui-forms-comboboxes-04-with-secondary-text` as a registered Rust-first block in the Comboboxes family. Preserve
...
- Block index `363` and `application-ui-forms-comboboxes-04-with-secondary-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(363)`, or look up `application-ui-forms-comboboxes-04-with-secondary-text` with
...
- The registry resolves both block id `363` and slug `application-ui-forms-comboboxes-04-with-secondary-text` one-to-one.
...
- An isolated `block-application-ui-forms-comboboxes-04-with-secondary-text` story proves the fixture in both renderers.
