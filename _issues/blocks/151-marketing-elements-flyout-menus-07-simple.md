...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-3a091a4d7664f1d576e29f48d523edfa

Catalog path: Marketing / elements / Flyout Menus / variant 7 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-07-simple` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `150` and `marketing-elements-flyout-menus-07-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(150)`, or look up `marketing-elements-flyout-menus-07-simple` with
...
- The registry resolves both block id `150` and slug `marketing-elements-flyout-menus-07-simple` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-07-simple` story proves the fixture in both renderers.
