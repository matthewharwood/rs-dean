...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-75718a5d20c65d411bb9e1669888f72e

Catalog path: Application UI / lists / Tables / variant 6 of 19

## TPM Outcome

Ship `application-ui-lists-tables-06-with-uppercase-headings` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `266` and `application-ui-lists-tables-06-with-uppercase-headings` are the stable registry identity.
...
- Resolve `BlockId::from_index(266)`, or look up `application-ui-lists-tables-06-with-uppercase-headings` with
...
- The registry resolves both block id `266` and slug `application-ui-lists-tables-06-with-uppercase-headings` one-to-one.
...
- An isolated `block-application-ui-lists-tables-06-with-uppercase-headings` story proves the fixture in both renderers.
