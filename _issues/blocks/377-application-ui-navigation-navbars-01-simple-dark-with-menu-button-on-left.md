...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-70a9bdf83ef2c8568c5cddf6c39c2331

Catalog path: Application UI / navigation / Navbars / variant 1 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-01-simple-dark-with-menu-button-on-left` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `376` and `application-ui-navigation-navbars-01-simple-dark-with-menu-button-on-left` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Dark`, and `Menu`
...
- Resolve `BlockId::from_index(376)`, or look up `application-ui-navigation-navbars-01-simple-dark-with-menu-button-on-left` with
...
- The registry resolves both block id `376` and slug `application-ui-navigation-navbars-01-simple-dark-with-menu-button-on-left` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-01-simple-dark-with-menu-button-on-left` story proves the fixture in both renderers.
