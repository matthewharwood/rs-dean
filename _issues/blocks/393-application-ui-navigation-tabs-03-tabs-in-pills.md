...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-556317db33900f6182a5f45cd9b50300

Catalog path: Application UI / navigation / Tabs / variant 3 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-03-tabs-in-pills` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `392` and `application-ui-navigation-tabs-03-tabs-in-pills` are the stable registry identity.
...
- Resolve `BlockId::from_index(392)`, or look up `application-ui-navigation-tabs-03-tabs-in-pills` with
...
- The registry resolves both block id `392` and slug `application-ui-navigation-tabs-03-tabs-in-pills` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-03-tabs-in-pills` story proves the fixture in both renderers.
