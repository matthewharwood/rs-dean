...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/notifications#component-7d20f80f5b5fc2a13c14034d3d60115e

Catalog path: Application UI / overlays / Notifications / variant 5 of 6

## TPM Outcome

Ship `application-ui-overlays-notifications-05-with-split-buttons` as a registered Rust-first block in the Notifications family. Preserve
...
- Block index `452` and `application-ui-overlays-notifications-05-with-split-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(452)`, or look up `application-ui-overlays-notifications-05-with-split-buttons` with
...
- The registry resolves both block id `452` and slug `application-ui-overlays-notifications-05-with-split-buttons` one-to-one.
...
- An isolated `block-application-ui-overlays-notifications-05-with-split-buttons` story proves the fixture in both renderers.
