...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-aca9a5b856afc07ad4ee04f5d1861256

Catalog path: Application UI / elements / Badges / variant 1 of 16

## TPM Outcome

Ship `application-ui-elements-badges-01-with-border` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `465` and `application-ui-elements-badges-01-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(465)`, or look up `application-ui-elements-badges-01-with-border` with
...
- The registry resolves both block id `465` and slug `application-ui-elements-badges-01-with-border` one-to-one.
...
- An isolated `block-application-ui-elements-badges-01-with-border` story proves the fixture in both renderers.
