...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-a5f686fef580771c6c3489b1b50f9852

Catalog path: Ecommerce / components / Product Lists / variant 2 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-02-with-cta-link` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `549` and `ecommerce-components-product-lists-02-with-cta-link` are the stable registry identity.
...
- Resolve `BlockId::from_index(549)`, or look up `ecommerce-components-product-lists-02-with-cta-link` with
...
- The registry resolves both block id `549` and slug `ecommerce-components-product-lists-02-with-cta-link` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-02-with-cta-link` story proves the fixture in both renderers.
