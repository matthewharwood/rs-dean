...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-9a7c2b542c1c683ffaa6cdd418c65a26

Catalog path: Marketing / sections / CTA Sections / variant 8 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-08-simple-justified-on-subtle-brand` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `34` and `marketing-sections-cta-sections-08-simple-justified-on-subtle-brand` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Subtle`, and `Actions`
...
- Resolve `BlockId::from_index(34)`, or look up `marketing-sections-cta-sections-08-simple-justified-on-subtle-brand` with
...
- The registry resolves both block id `34` and slug `marketing-sections-cta-sections-08-simple-justified-on-subtle-brand` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-08-simple-justified-on-subtle-brand` story proves the fixture in both renderers.
