...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-2c77a3f6925b437e983e0d07fe3288b1

Catalog path: Application UI / data-display / Calendars / variant 4 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-04-day-view` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `241` and `application-ui-data-display-calendars-04-day-view` are the stable registry identity.
...
- Resolve `BlockId::from_index(241)`, or look up `application-ui-data-display-calendars-04-day-view` with
...
- The registry resolves both block id `241` and slug `application-ui-data-display-calendars-04-day-view` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-04-day-view` story proves the fixture in both renderers.
