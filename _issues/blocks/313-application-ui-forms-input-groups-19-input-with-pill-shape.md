...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-550d28e5af844fd761c80c6b6a8d7486

Catalog path: Application UI / forms / Input Groups / variant 19 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-19-input-with-pill-shape` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `312` and `application-ui-forms-input-groups-19-input-with-pill-shape` are the stable registry identity.
...
- Resolve `BlockId::from_index(312)`, or look up `application-ui-forms-input-groups-19-input-with-pill-shape` with
...
- The registry resolves both block id `312` and slug `application-ui-forms-input-groups-19-input-with-pill-shape` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-19-input-with-pill-shape` story proves the fixture in both renderers.
