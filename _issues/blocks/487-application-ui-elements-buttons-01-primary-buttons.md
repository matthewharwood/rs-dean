...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-80fd0d5ac7982f1a83b171bb0fb9e116

Catalog path: Application UI / elements / Buttons / variant 1 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-01-primary-buttons` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `486` and `application-ui-elements-buttons-01-primary-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(486)`, or look up `application-ui-elements-buttons-01-primary-buttons` with
...
- The registry resolves both block id `486` and slug `application-ui-elements-buttons-01-primary-buttons` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-01-primary-buttons` story proves the fixture in both renderers.
