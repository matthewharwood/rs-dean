...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/button-groups#component-9e4d2ae1944600eac288621ec31cf6e2

Catalog path: Application UI / elements / Button Groups / variant 5 of 5

## TPM Outcome

Ship `application-ui-elements-button-groups-05-with-checkbox-and-dropdown` as a registered Rust-first block in the Button Groups family. Preserve
...
- Block index `498` and `application-ui-elements-button-groups-05-with-checkbox-and-dropdown` are the stable registry identity.
...
- The family maps to the `Component composition` composition pattern and the `Button Group`
...
- Resolve `BlockId::from_index(498)`, or look up `application-ui-elements-button-groups-05-with-checkbox-and-dropdown` with
...
- The registry resolves both block id `498` and slug `application-ui-elements-button-groups-05-with-checkbox-and-dropdown` one-to-one.
...
- An isolated `block-application-ui-elements-button-groups-05-with-checkbox-and-dropdown` story proves the fixture in both renderers.
