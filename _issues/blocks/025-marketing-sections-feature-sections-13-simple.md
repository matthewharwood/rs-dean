...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-58733237d8453d06f9d3e093404e2eba

Catalog path: Marketing / sections / Feature Sections / variant 13 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-13-simple` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `24` and `marketing-sections-feature-sections-13-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(24)`, or look up `marketing-sections-feature-sections-13-simple` with
...
- The registry resolves both block id `24` and slug `marketing-sections-feature-sections-13-simple` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-13-simple` story proves the fixture in both renderers.
