...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-e5f12862f086eee6108f70ff74a502ff

Catalog path: Application UI / data-display / Calendars / variant 5 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-05-year-view` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `242` and `application-ui-data-display-calendars-05-year-view` are the stable registry identity.
...
- Resolve `BlockId::from_index(242)`, or look up `application-ui-data-display-calendars-05-year-view` with
...
- The registry resolves both block id `242` and slug `application-ui-data-display-calendars-05-year-view` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-05-year-view` story proves the fixture in both renderers.
