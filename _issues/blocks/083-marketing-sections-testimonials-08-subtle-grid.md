...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-13b31ada062b8653addbdede99c1ee7d

Catalog path: Marketing / sections / Testimonials / variant 8 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-08-subtle-grid` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `82` and `marketing-sections-testimonials-08-subtle-grid` are the stable registry identity.
...
- The family maps to the `Testimonial` composition pattern and the `Card`
...
- Resolve `BlockId::from_index(82)`, or look up `marketing-sections-testimonials-08-subtle-grid` with
...
- The registry resolves both block id `82` and slug `marketing-sections-testimonials-08-subtle-grid` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-08-subtle-grid` story proves the fixture in both renderers.
