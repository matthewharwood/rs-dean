...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-fbfbdf31759a62bee2bf8d52dffe0f00

Catalog path: Marketing / sections / Stats / variant 6 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-06-stepped` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `72` and `marketing-sections-stats-sections-06-stepped` are the stable registry identity.
...
- Resolve `BlockId::from_index(72)`, or look up `marketing-sections-stats-sections-06-stepped` with
...
- The registry resolves both block id `72` and slug `marketing-sections-stats-sections-06-stepped` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-06-stepped` story proves the fixture in both renderers.
