...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-b2c41f4521a0b989aa8e3c0d6ee400c9

Catalog path: Marketing / sections / Footers / variant 5 of 7

## TPM Outcome

Ship `marketing-sections-footers-05-4-column-with-newsletter-below` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `130` and `marketing-sections-footers-05-4-column-with-newsletter-below` are the stable registry identity.
...
- The family maps to the `Footer` composition pattern and the `Navigation Menu`
...
- Resolve `BlockId::from_index(130)`, or look up `marketing-sections-footers-05-4-column-with-newsletter-below` with
...
- The registry resolves both block id `130` and slug `marketing-sections-footers-05-4-column-with-newsletter-below` one-to-one.
...
- An isolated `block-marketing-sections-footers-05-4-column-with-newsletter-below` story proves the fixture in both renderers.
