...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-13acf9810a8e9f90cc6a67a4b6d8b8f7

Catalog path: Application UI / lists / Stacked Lists / variant 2 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-02-with-links` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `247` and `application-ui-lists-stacked-lists-02-with-links` are the stable registry identity.
...
- Resolve `BlockId::from_index(247)`, or look up `application-ui-lists-stacked-lists-02-with-links` with
...
- The registry resolves both block id `247` and slug `application-ui-lists-stacked-lists-02-with-links` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-02-with-links` story proves the fixture in both renderers.
