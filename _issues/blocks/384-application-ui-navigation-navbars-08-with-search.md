...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-9dd6cc41ada513726b95c80033e90a74

Catalog path: Application UI / navigation / Navbars / variant 8 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-08-with-search` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `383` and `application-ui-navigation-navbars-08-with-search` are the stable registry identity.
...
- Resolve `BlockId::from_index(383)`, or look up `application-ui-navigation-navbars-08-with-search` with
...
- The registry resolves both block id `383` and slug `application-ui-navigation-navbars-08-with-search` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-08-with-search` story proves the fixture in both renderers.
