...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-a6fe57a3075bcfcb790893a428c4cfb5

Catalog path: Marketing / elements / Banners / variant 7 of 13

## TPM Outcome

Ship `marketing-elements-banners-07-bottom-aligned` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `157` and `marketing-elements-banners-07-bottom-aligned` are the stable registry identity.
...
- Resolve `BlockId::from_index(157)`, or look up `marketing-elements-banners-07-bottom-aligned` with
...
- The registry resolves both block id `157` and slug `marketing-elements-banners-07-bottom-aligned` one-to-one.
...
- An isolated `block-marketing-elements-banners-07-bottom-aligned` story proves the fixture in both renderers.
