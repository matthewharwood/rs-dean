...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/breadcrumbs#component-30bf6b10109ab7c77e4a5ddf3e9506a8

Catalog path: Application UI / navigation / Breadcrumbs / variant 4 of 4

## TPM Outcome

Ship `application-ui-navigation-breadcrumbs-04-simple-with-slashes` as a registered Rust-first block in the Breadcrumbs family. Preserve
...
- Block index `413` and `application-ui-navigation-breadcrumbs-04-simple-with-slashes` are the stable registry identity.
...
- Resolve `BlockId::from_index(413)`, or look up `application-ui-navigation-breadcrumbs-04-simple-with-slashes` with
...
- The registry resolves both block id `413` and slug `application-ui-navigation-breadcrumbs-04-simple-with-slashes` one-to-one.
...
- An isolated `block-application-ui-navigation-breadcrumbs-04-simple-with-slashes` story proves the fixture in both renderers.
