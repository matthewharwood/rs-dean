...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-6e57d09ad8ecb00c5d738055e17a6e22

Catalog path: Marketing / sections / CTA Sections / variant 5 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-05-simple-centered-with-gradient` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `31` and `marketing-sections-cta-sections-05-simple-centered-with-gradient` are the stable registry identity.
...
- Resolve `BlockId::from_index(31)`, or look up `marketing-sections-cta-sections-05-simple-centered-with-gradient` with
...
- The registry resolves both block id `31` and slug `marketing-sections-cta-sections-05-simple-centered-with-gradient` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-05-simple-centered-with-gradient` story proves the fixture in both renderers.
