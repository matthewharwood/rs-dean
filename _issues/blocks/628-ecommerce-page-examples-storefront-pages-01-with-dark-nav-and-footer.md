...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/storefront-pages#component-04740945117f4ec46b10f866630a6347

Catalog path: Ecommerce / page-examples / Storefront Pages / variant 1 of 4

## TPM Outcome

Ship `ecommerce-page-examples-storefront-pages-01-with-dark-nav-and-footer` as a registered Rust-first block in the Storefront Pages family. Preserve
...
- Block index `627` and `ecommerce-page-examples-storefront-pages-01-with-dark-nav-and-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(627)`, or look up `ecommerce-page-examples-storefront-pages-01-with-dark-nav-and-footer` with
...
- The registry resolves both block id `627` and slug `ecommerce-page-examples-storefront-pages-01-with-dark-nav-and-footer` one-to-one.
...
- An isolated `block-ecommerce-page-examples-storefront-pages-01-with-dark-nav-and-footer` story proves the fixture in both renderers.
