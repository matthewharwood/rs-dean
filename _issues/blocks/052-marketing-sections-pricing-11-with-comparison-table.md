...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-466fb280c935eaf1bbc06080419b751f

Catalog path: Marketing / sections / Pricing Sections / variant 11 of 12

## TPM Outcome

Ship `marketing-sections-pricing-11-with-comparison-table` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `51` and `marketing-sections-pricing-11-with-comparison-table` are the stable registry identity.
...
- Resolve `BlockId::from_index(51)`, or look up `marketing-sections-pricing-11-with-comparison-table` with
...
- The registry resolves both block id `51` and slug `marketing-sections-pricing-11-with-comparison-table` one-to-one.
...
- An isolated `block-marketing-sections-pricing-11-with-comparison-table` story proves the fixture in both renderers.
