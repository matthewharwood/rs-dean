...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/toggles#component-92732eaa2a1e1af9d23939f08cabd44f

Catalog path: Application UI / forms / Toggles / variant 1 of 5

## TPM Outcome

Ship `application-ui-forms-toggles-01-simple-toggle` as a registered Rust-first block in the Toggles family. Preserve
...
- Block index `347` and `application-ui-forms-toggles-01-simple-toggle` are the stable registry identity.
...
- Resolve `BlockId::from_index(347)`, or look up `application-ui-forms-toggles-01-simple-toggle` with
...
- The registry resolves both block id `347` and slug `application-ui-forms-toggles-01-simple-toggle` one-to-one.
...
- An isolated `block-application-ui-forms-toggles-01-simple-toggle` story proves the fixture in both renderers.
