...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-ce25978b18b6bdf2e40d49fb6d21ef20

Catalog path: Marketing / sections / Content Sections / variant 4 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-04-two-columns-with-screenshot` as a registered Rust-first block in the Content Sections family. Preserve
...
- Block index `109` and `marketing-sections-content-sections-04-two-columns-with-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(109)`, or look up `marketing-sections-content-sections-04-two-columns-with-screenshot` with
...
- The registry resolves both block id `109` and slug `marketing-sections-content-sections-04-two-columns-with-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-04-two-columns-with-screenshot` story proves the fixture in both renderers.
