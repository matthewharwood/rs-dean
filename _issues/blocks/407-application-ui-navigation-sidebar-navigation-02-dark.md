...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/sidebar-navigation#component-6c780cba69f5c1f01742a45dc0bfaa76

Catalog path: Application UI / navigation / Sidebar Navigation / variant 2 of 5

## TPM Outcome

Ship `application-ui-navigation-sidebar-navigation-02-dark` as a registered Rust-first block in the Sidebar Navigation family. Preserve
...
- Block index `406` and `application-ui-navigation-sidebar-navigation-02-dark` are the stable registry identity.
...
- Resolve `BlockId::from_index(406)`, or look up `application-ui-navigation-sidebar-navigation-02-dark` with
...
- The registry resolves both block id `406` and slug `application-ui-navigation-sidebar-navigation-02-dark` one-to-one.
...
- An isolated `block-application-ui-navigation-sidebar-navigation-02-dark` story proves the fixture in both renderers.
