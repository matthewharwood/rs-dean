...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-5d42250cd4a018d6a5d20a37fffaec09

Catalog path: Application UI / application-shells / Stacked Layouts / variant 3 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-03-with-lighter-page-header` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `181` and `application-ui-application-shells-stacked-03-with-lighter-page-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(181)`, or look up `application-ui-application-shells-stacked-03-with-lighter-page-header` with
...
- The registry resolves both block id `181` and slug `application-ui-application-shells-stacked-03-with-lighter-page-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-03-with-lighter-page-header` story proves the fixture in both renderers.
