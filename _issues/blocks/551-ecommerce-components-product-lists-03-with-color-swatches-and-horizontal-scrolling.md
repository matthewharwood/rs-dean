...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-611c7d5d2ea9805a53c70aa0477434be

Catalog path: Ecommerce / components / Product Lists / variant 3 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-03-with-color-swatches-and-horizontal-scrolling` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `550` and `ecommerce-components-product-lists-03-with-color-swatches-and-horizontal-scrolling` are the stable registry identity.
...
- Resolve `BlockId::from_index(550)`, or look up `ecommerce-components-product-lists-03-with-color-swatches-and-horizontal-scrolling` with
...
- The registry resolves both block id `550` and slug `ecommerce-components-product-lists-03-with-color-swatches-and-horizontal-scrolling` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-03-with-color-swatches-and-horizontal-scrolling` story proves the fixture in both renderers.
