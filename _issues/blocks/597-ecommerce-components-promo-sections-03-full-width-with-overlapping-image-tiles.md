...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-a63bf3a5e5430e5ba171ad153687d87d

Catalog path: Ecommerce / components / Promo Sections / variant 3 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-03-full-width-with-overlapping-image-tiles` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `596` and `ecommerce-components-promo-sections-03-full-width-with-overlapping-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(596)`, or look up `ecommerce-components-promo-sections-03-full-width-with-overlapping-image-tiles` with
...
- The registry resolves both block id `596` and slug `ecommerce-components-promo-sections-03-full-width-with-overlapping-image-tiles` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-03-full-width-with-overlapping-image-tiles` story proves the fixture in both renderers.
