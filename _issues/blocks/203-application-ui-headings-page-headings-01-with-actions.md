...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-d7c74dbf561c0e69da7d009d223bdc0a

Catalog path: Application UI / headings / Page Headings / variant 1 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-01-with-actions` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `202` and `application-ui-headings-page-headings-01-with-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(202)`, or look up `application-ui-headings-page-headings-01-with-actions` with
...
- The registry resolves both block id `202` and slug `application-ui-headings-page-headings-01-with-actions` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-01-with-actions` story proves the fixture in both renderers.
