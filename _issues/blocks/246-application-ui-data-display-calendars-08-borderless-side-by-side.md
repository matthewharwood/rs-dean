...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-5bb74a1ac1c8cf96e7b3d1ea2bf4570b

Catalog path: Application UI / data-display / Calendars / variant 8 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-08-borderless-side-by-side` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `245` and `application-ui-data-display-calendars-08-borderless-side-by-side` are the stable registry identity.
...
- The family maps to the `Calendar` composition pattern and the `Calendar`
...
- Resolve `BlockId::from_index(245)`, or look up `application-ui-data-display-calendars-08-borderless-side-by-side` with
...
- The registry resolves both block id `245` and slug `application-ui-data-display-calendars-08-borderless-side-by-side` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-08-borderless-side-by-side` story proves the fixture in both renderers.
