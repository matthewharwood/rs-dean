...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-45612766894822db447a2837d79355f5

Catalog path: Application UI / forms / Radio Groups / variant 10 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-10-cards` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `340` and `application-ui-forms-radio-groups-10-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(340)`, or look up `application-ui-forms-radio-groups-10-cards` with
...
- The registry resolves both block id `340` and slug `application-ui-forms-radio-groups-10-cards` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-10-cards` story proves the fixture in both renderers.
