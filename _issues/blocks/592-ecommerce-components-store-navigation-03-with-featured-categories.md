...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/store-navigation#component-870de0c4ec620ad31bb8538a2886e3f0

Catalog path: Ecommerce / components / Store Navigation / variant 3 of 5

## TPM Outcome

Ship `ecommerce-components-store-navigation-03-with-featured-categories` as a registered Rust-first block in the Store Navigation family. Preserve
...
- Block index `591` and `ecommerce-components-store-navigation-03-with-featured-categories` are the stable registry identity.
...
- Resolve `BlockId::from_index(591)`, or look up `ecommerce-components-store-navigation-03-with-featured-categories` with
...
- The registry resolves both block id `591` and slug `ecommerce-components-store-navigation-03-with-featured-categories` one-to-one.
...
- An isolated `block-ecommerce-components-store-navigation-03-with-featured-categories` story proves the fixture in both renderers.
