...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-d3acbf5cf2bb7ba7f94bbe6e0b30ed2f

Catalog path: Marketing / sections / Team Sections / variant 3 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-03-grid-with-round-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `99` and `marketing-sections-team-sections-03-grid-with-round-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(99)`, or look up `marketing-sections-team-sections-03-grid-with-round-images` with
...
- The registry resolves both block id `99` and slug `marketing-sections-team-sections-03-grid-with-round-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-03-grid-with-round-images` story proves the fixture in both renderers.
