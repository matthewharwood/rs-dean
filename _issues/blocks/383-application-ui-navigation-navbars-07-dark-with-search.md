...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-1be56e16325019ce5e105b23952d0b8b

Catalog path: Application UI / navigation / Navbars / variant 7 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-07-dark-with-search` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `382` and `application-ui-navigation-navbars-07-dark-with-search` are the stable registry identity.
...
- Resolve `BlockId::from_index(382)`, or look up `application-ui-navigation-navbars-07-dark-with-search` with
...
- The registry resolves both block id `382` and slug `application-ui-navigation-navbars-07-dark-with-search` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-07-dark-with-search` story proves the fixture in both renderers.
