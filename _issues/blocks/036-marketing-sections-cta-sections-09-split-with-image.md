...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-58b6441d042e26470c2d485039ead146

Catalog path: Marketing / sections / CTA Sections / variant 9 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-09-split-with-image` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `35` and `marketing-sections-cta-sections-09-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(35)`, or look up `marketing-sections-cta-sections-09-split-with-image` with
...
- The registry resolves both block id `35` and slug `marketing-sections-cta-sections-09-split-with-image` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-09-split-with-image` story proves the fixture in both renderers.
