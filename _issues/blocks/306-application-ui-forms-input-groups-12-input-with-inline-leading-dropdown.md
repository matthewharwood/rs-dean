...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-6e671f3ae1aaf020c3dfe26d7aaf7b3d

Catalog path: Application UI / forms / Input Groups / variant 12 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-12-input-with-inline-leading-dropdown` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `305` and `application-ui-forms-input-groups-12-input-with-inline-leading-dropdown` are the stable registry identity.
...
- Resolve `BlockId::from_index(305)`, or look up `application-ui-forms-input-groups-12-input-with-inline-leading-dropdown` with
...
- The registry resolves both block id `305` and slug `application-ui-forms-input-groups-12-input-with-inline-leading-dropdown` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-12-input-with-inline-leading-dropdown` story proves the fixture in both renderers.
