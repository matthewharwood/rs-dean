...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-f49fff01d7f8c41856ac0fc3bf82e972

Catalog path: Application UI / forms / Radio Groups / variant 5 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-05-list-with-radio-on-right` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `335` and `application-ui-forms-radio-groups-05-list-with-radio-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(335)`, or look up `application-ui-forms-radio-groups-05-list-with-radio-on-right` with
...
- The registry resolves both block id `335` and slug `application-ui-forms-radio-groups-05-list-with-radio-on-right` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-05-list-with-radio-on-right` story proves the fixture in both renderers.
