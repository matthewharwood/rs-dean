...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/sign-in-forms#component-bc08eb211afa45fad7c9f89c1891f284

Catalog path: Application UI / forms / Sign-in and Registration / variant 4 of 4

## TPM Outcome

Ship `application-ui-forms-sign-in-forms-04-simple-card` as a registered Rust-first block in the Sign-in and Registration family. Preserve
...
- Block index `325` and `application-ui-forms-sign-in-forms-04-simple-card` are the stable registry identity.
...
- Resolve `BlockId::from_index(325)`, or look up `application-ui-forms-sign-in-forms-04-simple-card` with
...
- The registry resolves both block id `325` and slug `application-ui-forms-sign-in-forms-04-simple-card` one-to-one.
...
- An isolated `block-application-ui-forms-sign-in-forms-04-simple-card` story proves the fixture in both renderers.
