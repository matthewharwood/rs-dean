...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/reviews#component-3d2bb70379ce64ab64f0b4e38866cf8a

Catalog path: Ecommerce / components / Reviews / variant 2 of 4

## TPM Outcome

Ship `ecommerce-components-reviews-02-with-summary-chart` as a registered Rust-first block in the Reviews family. Preserve
...
- Block index `608` and `ecommerce-components-reviews-02-with-summary-chart` are the stable registry identity.
...
- Resolve `BlockId::from_index(608)`, or look up `ecommerce-components-reviews-02-with-summary-chart` with
...
- The registry resolves both block id `608` and slug `ecommerce-components-reviews-02-with-summary-chart` one-to-one.
...
- An isolated `block-ecommerce-components-reviews-02-with-summary-chart` story proves the fixture in both renderers.
