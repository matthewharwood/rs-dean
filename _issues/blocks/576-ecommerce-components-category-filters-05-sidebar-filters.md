...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-filters#component-948dd4ebccc4d262d38cce4e7e638c7e

Catalog path: Ecommerce / components / Category Filters / variant 5 of 5

## TPM Outcome

Ship `ecommerce-components-category-filters-05-sidebar-filters` as a registered Rust-first block in the Category Filters family. Preserve
...
- Block index `575` and `ecommerce-components-category-filters-05-sidebar-filters` are the stable registry identity.
...
- Resolve `BlockId::from_index(575)`, or look up `ecommerce-components-category-filters-05-sidebar-filters` with
...
- The registry resolves both block id `575` and slug `ecommerce-components-category-filters-05-sidebar-filters` one-to-one.
...
- An isolated `block-ecommerce-components-category-filters-05-sidebar-filters` story proves the fixture in both renderers.
