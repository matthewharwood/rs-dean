...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/dropdowns#component-1f10562f6266c9b3ef15ff792edd508e

Catalog path: Application UI / elements / Dropdowns / variant 2 of 5

## TPM Outcome

Ship `application-ui-elements-dropdowns-02-with-dividers` as a registered Rust-first block in the Dropdowns family. Preserve
...
- Block index `482` and `application-ui-elements-dropdowns-02-with-dividers` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Bordered`, and `Menu`
...
- Resolve `BlockId::from_index(482)`, or look up `application-ui-elements-dropdowns-02-with-dividers` with
...
- The registry resolves both block id `482` and slug `application-ui-elements-dropdowns-02-with-dividers` one-to-one.
...
- An isolated `block-application-ui-elements-dropdowns-02-with-dividers` story proves the fixture in both renderers.
