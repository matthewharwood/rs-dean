...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-2c89cc9bc554b56dba081876a969255c

Catalog path: Application UI / navigation / Vertical Navigation / variant 6 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-06-on-gray` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `404` and `application-ui-navigation-vertical-navigation-06-on-gray` are the stable registry identity.
...
- Resolve `BlockId::from_index(404)`, or look up `application-ui-navigation-vertical-navigation-06-on-gray` with
...
- The registry resolves both block id `404` and slug `application-ui-navigation-vertical-navigation-06-on-gray` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-06-on-gray` story proves the fixture in both renderers.
