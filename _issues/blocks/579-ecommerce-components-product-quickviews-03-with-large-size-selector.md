...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-quickviews#component-54247b2102ff85761ad0bc3b5d1e7aae

Catalog path: Ecommerce / components / Product Quickviews / variant 3 of 4

## TPM Outcome

Ship `ecommerce-components-product-quickviews-03-with-large-size-selector` as a registered Rust-first block in the Product Quickviews family. Preserve
...
- Block index `578` and `ecommerce-components-product-quickviews-03-with-large-size-selector` are the stable registry identity.
...
- Resolve `BlockId::from_index(578)`, or look up `ecommerce-components-product-quickviews-03-with-large-size-selector` with
...
- The registry resolves both block id `578` and slug `ecommerce-components-product-quickviews-03-with-large-size-selector` one-to-one.
...
- An isolated `block-ecommerce-components-product-quickviews-03-with-large-size-selector` story proves the fixture in both renderers.
