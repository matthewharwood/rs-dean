...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-d18ab876bc346ed08c7499a16281777c

Catalog path: Marketing / sections / Pricing Sections / variant 10 of 12

## TPM Outcome

Ship `marketing-sections-pricing-10-four-tiers-with-toggle` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `50` and `marketing-sections-pricing-10-four-tiers-with-toggle` are the stable registry identity.
...
- Resolve `BlockId::from_index(50)`, or look up `marketing-sections-pricing-10-four-tiers-with-toggle` with
...
- The registry resolves both block id `50` and slug `marketing-sections-pricing-10-four-tiers-with-toggle` one-to-one.
...
- An isolated `block-marketing-sections-pricing-10-four-tiers-with-toggle` story proves the fixture in both renderers.
