...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-0efa5ebc92e2aa72bc2332fcf5578869

Catalog path: Marketing / sections / Team Sections / variant 5 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-05-with-image-and-short-paragraph` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `101` and `marketing-sections-team-sections-05-with-image-and-short-paragraph` are the stable registry identity.
...
- Resolve `BlockId::from_index(101)`, or look up `marketing-sections-team-sections-05-with-image-and-short-paragraph` with
...
- The registry resolves both block id `101` and slug `marketing-sections-team-sections-05-with-image-and-short-paragraph` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-05-with-image-and-short-paragraph` story proves the fixture in both renderers.
