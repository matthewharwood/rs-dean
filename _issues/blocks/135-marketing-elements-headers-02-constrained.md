...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-df5b00183223aa31c98ab9ea3e03ed71

Catalog path: Marketing / elements / Headers / variant 2 of 11

## TPM Outcome

Ship `marketing-elements-headers-02-constrained` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `134` and `marketing-elements-headers-02-constrained` are the stable registry identity.
...
- Resolve `BlockId::from_index(134)`, or look up `marketing-elements-headers-02-constrained` with
...
- The registry resolves both block id `134` and slug `marketing-elements-headers-02-constrained` one-to-one.
...
- An isolated `block-marketing-elements-headers-02-constrained` story proves the fixture in both renderers.
