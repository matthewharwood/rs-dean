...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/alerts#component-e67a7131a853fd88ae683dbad613fe53

Catalog path: Application UI / feedback / Alerts / variant 4 of 6

## TPM Outcome

Ship `application-ui-feedback-alerts-04-with-link-on-right` as a registered Rust-first block in the Alerts family. Preserve
...
- Block index `367` and `application-ui-feedback-alerts-04-with-link-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(367)`, or look up `application-ui-feedback-alerts-04-with-link-on-right` with
...
- The registry resolves both block id `367` and slug `application-ui-feedback-alerts-04-with-link-on-right` one-to-one.
...
- An isolated `block-application-ui-feedback-alerts-04-with-link-on-right` story proves the fixture in both renderers.
