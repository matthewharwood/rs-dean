...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-51cd49b2ceceb69e91a6c0f3af763862

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 7 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-07-simple-brand-sidebar` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `194` and `application-ui-application-shells-sidebar-07-simple-brand-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(194)`, or look up `application-ui-application-shells-sidebar-07-simple-brand-sidebar` with
...
- The registry resolves both block id `194` and slug `application-ui-application-shells-sidebar-07-simple-brand-sidebar` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-07-simple-brand-sidebar` story proves the fixture in both renderers.
