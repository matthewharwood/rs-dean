...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/flyout-menus#component-988e9eed61ec84450b9650c7f6ad805e

Catalog path: Marketing / elements / Flyout Menus / variant 3 of 7

## TPM Outcome

Ship `marketing-elements-flyout-menus-03-stacked-with-footer-list` as a registered Rust-first block in the Flyout Menus family. Preserve
...
- Block index `146` and `marketing-elements-flyout-menus-03-stacked-with-footer-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(146)`, or look up `marketing-elements-flyout-menus-03-stacked-with-footer-list` with
...
- The registry resolves both block id `146` and slug `marketing-elements-flyout-menus-03-stacked-with-footer-list` one-to-one.
...
- An isolated `block-marketing-elements-flyout-menus-03-stacked-with-footer-list` story proves the fixture in both renderers.
