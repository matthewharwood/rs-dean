...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-d9372707af2e94e67936e94d7339cbb3

Catalog path: Application UI / data-display / Description Lists / variant 1 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-01-left-aligned` as a registered Rust-first block in the Description Lists family. Preserve
...
- Block index `227` and `application-ui-data-display-description-lists-01-left-aligned` are the stable registry identity.
...
- Resolve `BlockId::from_index(227)`, or look up `application-ui-data-display-description-lists-01-left-aligned` with
...
- The registry resolves both block id `227` and slug `application-ui-data-display-description-lists-01-left-aligned` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-01-left-aligned` story proves the fixture in both renderers.
