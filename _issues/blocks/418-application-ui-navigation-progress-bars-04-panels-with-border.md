...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-8d8661f38f3de5cbd0e8d704368ffc3d

Catalog path: Application UI / navigation / Progress Bars / variant 4 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-04-panels-with-border` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `417` and `application-ui-navigation-progress-bars-04-panels-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(417)`, or look up `application-ui-navigation-progress-bars-04-panels-with-border` with
...
- The registry resolves both block id `417` and slug `application-ui-navigation-progress-bars-04-panels-with-border` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-04-panels-with-border` story proves the fixture in both renderers.
