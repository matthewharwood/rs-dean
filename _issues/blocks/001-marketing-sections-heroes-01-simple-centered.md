...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-b9bcab4538776a17fff93d18f82a8272

Catalog path: Marketing / sections / Hero Sections / variant 1 of 12

## TPM Outcome

Ship `marketing-sections-heroes-01-simple-centered` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `0` and `marketing-sections-heroes-01-simple-centered` are the stable registry identity.
...
- Resolve `BlockId::from_index(0)`, or look up `marketing-sections-heroes-01-simple-centered` with
...
- The registry resolves both block id `0` and slug `marketing-sections-heroes-01-simple-centered` one-to-one.
...
- An isolated `block-marketing-sections-heroes-01-simple-centered` story proves the fixture in both renderers.
