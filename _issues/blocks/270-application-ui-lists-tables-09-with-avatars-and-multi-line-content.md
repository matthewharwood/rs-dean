...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-822ab4bf111e9a34063e651275b381e6

Catalog path: Application UI / lists / Tables / variant 9 of 19

## TPM Outcome

Ship `application-ui-lists-tables-09-with-avatars-and-multi-line-content` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `269` and `application-ui-lists-tables-09-with-avatars-and-multi-line-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(269)`, or look up `application-ui-lists-tables-09-with-avatars-and-multi-line-content` with
...
- The registry resolves both block id `269` and slug `application-ui-lists-tables-09-with-avatars-and-multi-line-content` one-to-one.
...
- An isolated `block-application-ui-lists-tables-09-with-avatars-and-multi-line-content` story proves the fixture in both renderers.
