...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/sign-in-forms#component-fef1d7e9849359af76d4d6ead796938b

Catalog path: Application UI / forms / Sign-in and Registration / variant 3 of 4

## TPM Outcome

Ship `application-ui-forms-sign-in-forms-03-split-screen` as a registered Rust-first block in the Sign-in and Registration family. Preserve
...
- Block index `324` and `application-ui-forms-sign-in-forms-03-split-screen` are the stable registry identity.
...
- Resolve `BlockId::from_index(324)`, or look up `application-ui-forms-sign-in-forms-03-split-screen` with
...
- The registry resolves both block id `324` and slug `application-ui-forms-sign-in-forms-03-split-screen` one-to-one.
...
- An isolated `block-application-ui-forms-sign-in-forms-03-split-screen` story proves the fixture in both renderers.
