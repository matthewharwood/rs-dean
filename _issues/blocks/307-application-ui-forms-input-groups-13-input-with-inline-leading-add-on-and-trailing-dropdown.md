...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-2607d970262ada86428f063c72b1e7bd

Catalog path: Application UI / forms / Input Groups / variant 13 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-13-input-with-inline-leading-add-on-and-trailing-dropdown` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `306` and `application-ui-forms-input-groups-13-input-with-inline-leading-add-on-and-trailing-dropdown` are the stable registry identity.
...
- The family maps to the `Form` composition pattern and the `Input Group`
...
- Resolve `BlockId::from_index(306)`, or look up `application-ui-forms-input-groups-13-input-with-inline-leading-add-on-and-trailing-dropdown` with
...
- The registry resolves both block id `306` and slug `application-ui-forms-input-groups-13-input-with-inline-leading-add-on-and-trailing-dropdown` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-13-input-with-inline-leading-add-on-and-trailing-dropdown` story proves the fixture in both renderers.
