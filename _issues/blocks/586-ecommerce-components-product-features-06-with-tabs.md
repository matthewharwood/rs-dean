...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-1c59e9598a7ee96a39f2a1c1e6b270a7

Catalog path: Ecommerce / components / Product Features / variant 6 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-06-with-tabs` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `585` and `ecommerce-components-product-features-06-with-tabs` are the stable registry identity.
...
- Resolve `BlockId::from_index(585)`, or look up `ecommerce-components-product-features-06-with-tabs` with
...
- The registry resolves both block id `585` and slug `ecommerce-components-product-features-06-with-tabs` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-06-with-tabs` story proves the fixture in both renderers.
