...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/store-navigation#component-05d207688239bbe040029b5bfa5ddf92

Catalog path: Ecommerce / components / Store Navigation / variant 2 of 5

## TPM Outcome

Ship `ecommerce-components-store-navigation-02-with-simple-menu-and-promo` as a registered Rust-first block in the Store Navigation family. Preserve
...
- Block index `590` and `ecommerce-components-store-navigation-02-with-simple-menu-and-promo` are the stable registry identity.
...
- Resolve `BlockId::from_index(590)`, or look up `ecommerce-components-store-navigation-02-with-simple-menu-and-promo` with
...
- The registry resolves both block id `590` and slug `ecommerce-components-store-navigation-02-with-simple-menu-and-promo` one-to-one.
...
- An isolated `block-ecommerce-components-store-navigation-02-with-simple-menu-and-promo` story proves the fixture in both renderers.
