...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-quickviews#component-fbb6aae7c79cee56e654c788f76835d9

Catalog path: Ecommerce / components / Product Quickviews / variant 4 of 4

## TPM Outcome

Ship `ecommerce-components-product-quickviews-04-with-color-selector-and-description` as a registered Rust-first block in the Product Quickviews family. Preserve
...
- Block index `579` and `ecommerce-components-product-quickviews-04-with-color-selector-and-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(579)`, or look up `ecommerce-components-product-quickviews-04-with-color-selector-and-description` with
...
- The registry resolves both block id `579` and slug `ecommerce-components-product-quickviews-04-with-color-selector-and-description` one-to-one.
...
- An isolated `block-ecommerce-components-product-quickviews-04-with-color-selector-and-description` story proves the fixture in both renderers.
