...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-e1655fc2b62c1d5280cb639a5c09f1f6

Catalog path: Application UI / navigation / Progress Bars / variant 7 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-07-circles-with-text` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `420` and `application-ui-navigation-progress-bars-07-circles-with-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(420)`, or look up `application-ui-navigation-progress-bars-07-circles-with-text` with
...
- The registry resolves both block id `420` and slug `application-ui-navigation-progress-bars-07-circles-with-text` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-07-circles-with-text` story proves the fixture in both renderers.
