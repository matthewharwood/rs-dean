...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-02ae72fbf89f7bacef963f28d7c9908c

Catalog path: Application UI / lists / Tables / variant 16 of 19

## TPM Outcome

Ship `application-ui-lists-tables-16-with-border` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `276` and `application-ui-lists-tables-16-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(276)`, or look up `application-ui-lists-tables-16-with-border` with
...
- The registry resolves both block id `276` and slug `application-ui-lists-tables-16-with-border` one-to-one.
...
- An isolated `block-application-ui-lists-tables-16-with-border` story proves the fixture in both renderers.
