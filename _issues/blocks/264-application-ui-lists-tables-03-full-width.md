...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-cc6b046f8b3180ace676ce4847f3826f

Catalog path: Application UI / lists / Tables / variant 3 of 19

## TPM Outcome

Ship `application-ui-lists-tables-03-full-width` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `263` and `application-ui-lists-tables-03-full-width` are the stable registry identity.
...
- Resolve `BlockId::from_index(263)`, or look up `application-ui-lists-tables-03-full-width` with
...
- The registry resolves both block id `263` and slug `application-ui-lists-tables-03-full-width` one-to-one.
...
- An isolated `block-application-ui-lists-tables-03-full-width` story proves the fixture in both renderers.
