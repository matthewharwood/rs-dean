...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-d833265bea66e95da3b499411d4d49b3

Catalog path: Application UI / navigation / Navbars / variant 2 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-02-dark-with-quick-action` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `377` and `application-ui-navigation-navbars-02-dark-with-quick-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(377)`, or look up `application-ui-navigation-navbars-02-dark-with-quick-action` with
...
- The registry resolves both block id `377` and slug `application-ui-navigation-navbars-02-dark-with-quick-action` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-02-dark-with-quick-action` story proves the fixture in both renderers.
