...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-986addbc8678313fba5b0dd59c778e9b

Catalog path: Marketing / sections / Contact Sections / variant 1 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-01-centered` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `90` and `marketing-sections-contact-sections-01-centered` are the stable registry identity.
...
- Resolve `BlockId::from_index(90)`, or look up `marketing-sections-contact-sections-01-centered` with
...
- The registry resolves both block id `90` and slug `marketing-sections-contact-sections-01-centered` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-01-centered` story proves the fixture in both renderers.
