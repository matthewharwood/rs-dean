...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-5548358cb34897c6b28551f2ad885eec

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 4 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-04-dark-sidebar-with-header` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `191` and `application-ui-application-shells-sidebar-04-dark-sidebar-with-header` are the stable registry identity.
...
- The family maps to the `Application shell` composition pattern and the `Sidebar`
  primary UI component.
- Variant behavior is constrained by `No media`, `Dark`, and `Static`
...
- Resolve `BlockId::from_index(191)`, or look up `application-ui-application-shells-sidebar-04-dark-sidebar-with-header` with
...
- The registry resolves both block id `191` and slug `application-ui-application-shells-sidebar-04-dark-sidebar-with-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-04-dark-sidebar-with-header` story proves the fixture in both renderers.
