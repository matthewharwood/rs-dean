...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-2893edff150c2ccadf6ca761393d7eb1

Catalog path: Application UI / forms / Action Panels / variant 3 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-03-with-button-on-right` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `354` and `application-ui-forms-action-panels-03-with-button-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(354)`, or look up `application-ui-forms-action-panels-03-with-button-on-right` with
...
- The registry resolves both block id `354` and slug `application-ui-forms-action-panels-03-with-button-on-right` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-03-with-button-on-right` story proves the fixture in both renderers.
