...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/dividers#component-8fbd91ccd8fa7759ad4de9c874cfb23e

Catalog path: Application UI / layout / Dividers / variant 3 of 8

## TPM Outcome

Ship `application-ui-layout-dividers-03-with-label-on-left` as a registered Rust-first block in the Dividers family. Preserve
...
- Block index `531` and `application-ui-layout-dividers-03-with-label-on-left` are the stable registry identity.
...
- Resolve `BlockId::from_index(531)`, or look up `application-ui-layout-dividers-03-with-label-on-left` with
...
- The registry resolves both block id `531` and slug `application-ui-layout-dividers-03-with-label-on-left` one-to-one.
...
- An isolated `block-application-ui-layout-dividers-03-with-label-on-left` story proves the fixture in both renderers.
