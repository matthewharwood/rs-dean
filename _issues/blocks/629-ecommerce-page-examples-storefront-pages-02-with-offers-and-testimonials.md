...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/storefront-pages#component-087fa445e40f73cc5aa809b7ebac72f0

Catalog path: Ecommerce / page-examples / Storefront Pages / variant 2 of 4

## TPM Outcome

Ship `ecommerce-page-examples-storefront-pages-02-with-offers-and-testimonials` as a registered Rust-first block in the Storefront Pages family. Preserve
...
- Block index `628` and `ecommerce-page-examples-storefront-pages-02-with-offers-and-testimonials` are the stable registry identity.
...
- Resolve `BlockId::from_index(628)`, or look up `ecommerce-page-examples-storefront-pages-02-with-offers-and-testimonials` with
...
- The registry resolves both block id `628` and slug `ecommerce-page-examples-storefront-pages-02-with-offers-and-testimonials` one-to-one.
...
- An isolated `block-ecommerce-page-examples-storefront-pages-02-with-offers-and-testimonials` story proves the fixture in both renderers.
