...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-3d940888b49b624701d5343b67536107

Catalog path: Application UI / data-display / Calendars / variant 6 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-06-double` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `243` and `application-ui-data-display-calendars-06-double` are the stable registry identity.
...
- Resolve `BlockId::from_index(243)`, or look up `application-ui-data-display-calendars-06-double` with
...
- The registry resolves both block id `243` and slug `application-ui-data-display-calendars-06-double` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-06-double` story proves the fixture in both renderers.
