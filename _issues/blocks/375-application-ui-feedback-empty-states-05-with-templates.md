...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/empty-states#component-fdd158a00f60e3f9cdf9415b5835e139

Catalog path: Application UI / feedback / Empty States / variant 5 of 6

## TPM Outcome

Ship `application-ui-feedback-empty-states-05-with-templates` as a registered Rust-first block in the Empty States family. Preserve
...
- Block index `374` and `application-ui-feedback-empty-states-05-with-templates` are the stable registry identity.
...
- Resolve `BlockId::from_index(374)`, or look up `application-ui-feedback-empty-states-05-with-templates` with
...
- The registry resolves both block id `374` and slug `application-ui-feedback-empty-states-05-with-templates` one-to-one.
...
- An isolated `block-application-ui-feedback-empty-states-05-with-templates` story proves the fixture in both renderers.
