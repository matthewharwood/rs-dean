...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-a17f8a661b0c18a30ef74897cdcdd168

Catalog path: Marketing / sections / Feature Sections / variant 7 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-07-contained-in-panel` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `18` and `marketing-sections-feature-sections-07-contained-in-panel` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Panel`, and `Actions`
...
- Resolve `BlockId::from_index(18)`, or look up `marketing-sections-feature-sections-07-contained-in-panel` with
...
- The registry resolves both block id `18` and slug `marketing-sections-feature-sections-07-contained-in-panel` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-07-contained-in-panel` story proves the fixture in both renderers.
