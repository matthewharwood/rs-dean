...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-cb948bdbe04c717def4a7195a285d08b

Catalog path: Application UI / lists / Stacked Lists / variant 11 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-11-narrow-with-sticky-headings` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `256` and `application-ui-lists-stacked-lists-11-narrow-with-sticky-headings` are the stable registry identity.
...
- Resolve `BlockId::from_index(256)`, or look up `application-ui-lists-stacked-lists-11-narrow-with-sticky-headings` with
...
- The registry resolves both block id `256` and slug `application-ui-lists-stacked-lists-11-narrow-with-sticky-headings` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-11-narrow-with-sticky-headings` story proves the fixture in both renderers.
