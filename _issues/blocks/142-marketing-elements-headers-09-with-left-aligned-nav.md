...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-7ef8ee9230d367ff934b5494dc162aaf

Catalog path: Marketing / elements / Headers / variant 9 of 11

## TPM Outcome

Ship `marketing-elements-headers-09-with-left-aligned-nav` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `141` and `marketing-elements-headers-09-with-left-aligned-nav` are the stable registry identity.
...
- Resolve `BlockId::from_index(141)`, or look up `marketing-elements-headers-09-with-left-aligned-nav` with
...
- The registry resolves both block id `141` and slug `marketing-elements-headers-09-with-left-aligned-nav` one-to-one.
...
- An isolated `block-marketing-elements-headers-09-with-left-aligned-nav` story proves the fixture in both renderers.
