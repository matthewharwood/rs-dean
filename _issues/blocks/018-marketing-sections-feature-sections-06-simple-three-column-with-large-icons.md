...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-a8001ec7e007def1caf4383c1ddaa8a9

Catalog path: Marketing / sections / Feature Sections / variant 6 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-06-simple-three-column-with-large-icons` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `17` and `marketing-sections-feature-sections-06-simple-three-column-with-large-icons` are the stable registry identity.
...
- Variant behavior is constrained by `Icon`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(17)`, or look up `marketing-sections-feature-sections-06-simple-three-column-with-large-icons` with
...
- The registry resolves both block id `17` and slug `marketing-sections-feature-sections-06-simple-three-column-with-large-icons` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-06-simple-three-column-with-large-icons` story proves the fixture in both renderers.
