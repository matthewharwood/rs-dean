...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/landing-pages#component-09a9f8bd8b212b82cada14de363e1c02

Catalog path: Marketing / page-examples / Landing Pages / variant 2 of 4

## TPM Outcome

Ship `marketing-page-examples-landing-pages-02-with-large-screenshot-and-testimonial` as a registered Rust-first block in the Landing Pages family. Preserve
...
- Block index `170` and `marketing-page-examples-landing-pages-02-with-large-screenshot-and-testimonial` are the stable registry identity.
...
- Resolve `BlockId::from_index(170)`, or look up `marketing-page-examples-landing-pages-02-with-large-screenshot-and-testimonial` with
...
- The registry resolves both block id `170` and slug `marketing-page-examples-landing-pages-02-with-large-screenshot-and-testimonial` one-to-one.
...
- An isolated `block-marketing-page-examples-landing-pages-02-with-large-screenshot-and-testimonial` story proves the fixture in both renderers.
