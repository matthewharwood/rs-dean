...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-3899975a74f43a3fe103baffc0f1de86

Catalog path: Ecommerce / components / Incentives / variant 6 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-06-2x2-grid-with-illustrations` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `624` and `ecommerce-components-incentives-06-2x2-grid-with-illustrations` are the stable registry identity.
...
- Resolve `BlockId::from_index(624)`, or look up `ecommerce-components-incentives-06-2x2-grid-with-illustrations` with
...
- The registry resolves both block id `624` and slug `ecommerce-components-incentives-06-2x2-grid-with-illustrations` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-06-2x2-grid-with-illustrations` story proves the fixture in both renderers.
