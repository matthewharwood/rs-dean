...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-8fb8b0c0c450b171ae66be65be521558

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 2 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-02-simple-dark-sidebar` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `189` and `application-ui-application-shells-sidebar-02-simple-dark-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(189)`, or look up `application-ui-application-shells-sidebar-02-simple-dark-sidebar` with
...
- The registry resolves both block id `189` and slug `application-ui-application-shells-sidebar-02-simple-dark-sidebar` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-02-simple-dark-sidebar` story proves the fixture in both renderers.
