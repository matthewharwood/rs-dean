...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-a113dbf75844a04b403f4c7a55d431c5

Catalog path: Marketing / sections / FAQs / variant 5 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-05-three-columns-with-centered-introduction` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `123` and `marketing-sections-faq-sections-05-three-columns-with-centered-introduction` are the stable registry identity.
...
- The family maps to the `FAQ` composition pattern and the `Accordion`
...
- Resolve `BlockId::from_index(123)`, or look up `marketing-sections-faq-sections-05-three-columns-with-centered-introduction` with
...
- The registry resolves both block id `123` and slug `marketing-sections-faq-sections-05-three-columns-with-centered-introduction` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-05-three-columns-with-centered-introduction` story proves the fixture in both renderers.
