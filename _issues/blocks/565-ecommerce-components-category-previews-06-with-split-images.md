...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-fb276b5490d5ef7ebd8352e50043a5de

Catalog path: Ecommerce / components / Category Previews / variant 6 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-06-with-split-images` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `564` and `ecommerce-components-category-previews-06-with-split-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(564)`, or look up `ecommerce-components-category-previews-06-with-split-images` with
...
- The registry resolves both block id `564` and slug `ecommerce-components-category-previews-06-with-split-images` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-06-with-split-images` story proves the fixture in both renderers.
