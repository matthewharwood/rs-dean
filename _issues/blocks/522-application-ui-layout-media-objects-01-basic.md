...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-eda7e599a3c8507780c878cdeb9d409a

Catalog path: Application UI / layout / Media Objects / variant 1 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-01-basic` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `521` and `application-ui-layout-media-objects-01-basic` are the stable registry identity.
...
- Resolve `BlockId::from_index(521)`, or look up `application-ui-layout-media-objects-01-basic` with
...
- The registry resolves both block id `521` and slug `application-ui-layout-media-objects-01-basic` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-01-basic` story proves the fixture in both renderers.
