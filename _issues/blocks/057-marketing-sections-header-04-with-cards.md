...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-f295328e633edbb29e7612672e3d69cc

Catalog path: Marketing / sections / Header Sections / variant 4 of 8

## TPM Outcome

Ship `marketing-sections-header-04-with-cards` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `56` and `marketing-sections-header-04-with-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(56)`, or look up `marketing-sections-header-04-with-cards` with
...
- The registry resolves both block id `56` and slug `marketing-sections-header-04-with-cards` one-to-one.
...
- An isolated `block-marketing-sections-header-04-with-cards` story proves the fixture in both renderers.
