...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-aeb0ee53368825ebb0be85ae6524cd6c

Catalog path: Ecommerce / components / Incentives / variant 8 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-08-3-column-with-icons` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `626` and `ecommerce-components-incentives-08-3-column-with-icons` are the stable registry identity.
...
- Resolve `BlockId::from_index(626)`, or look up `ecommerce-components-incentives-08-3-column-with-icons` with
...
- The registry resolves both block id `626` and slug `ecommerce-components-incentives-08-3-column-with-icons` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-08-3-column-with-icons` story proves the fixture in both renderers.
