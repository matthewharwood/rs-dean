...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/storefront-pages#component-464ebe7691b135031411ad52b3560cc1

Catalog path: Ecommerce / page-examples / Storefront Pages / variant 4 of 4

## TPM Outcome

Ship `ecommerce-page-examples-storefront-pages-04-with-overlapping-image-tiles-and-perks` as a registered Rust-first block in the Storefront Pages family. Preserve
...
- Block index `630` and `ecommerce-page-examples-storefront-pages-04-with-overlapping-image-tiles-and-perks` are the stable registry identity.
...
- Resolve `BlockId::from_index(630)`, or look up `ecommerce-page-examples-storefront-pages-04-with-overlapping-image-tiles-and-perks` with
...
- The registry resolves both block id `630` and slug `ecommerce-page-examples-storefront-pages-04-with-overlapping-image-tiles-and-perks` one-to-one.
...
- An isolated `block-ecommerce-page-examples-storefront-pages-04-with-overlapping-image-tiles-and-perks` story proves the fixture in both renderers.
