...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-8017f4faee579f7ca518cdde140d4689

Catalog path: Marketing / sections / FAQs / variant 1 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-01-offset-with-supporting-text` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `119` and `marketing-sections-faq-sections-01-offset-with-supporting-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(119)`, or look up `marketing-sections-faq-sections-01-offset-with-supporting-text` with
...
- The registry resolves both block id `119` and slug `marketing-sections-faq-sections-01-offset-with-supporting-text` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-01-offset-with-supporting-text` story proves the fixture in both renderers.
