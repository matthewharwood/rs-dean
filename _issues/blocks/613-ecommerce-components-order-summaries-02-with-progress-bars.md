...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-summaries#component-e2b488e9a1bb6dd01abae32ea6cefe15

Catalog path: Ecommerce / components / Order Summaries / variant 2 of 4

## TPM Outcome

Ship `ecommerce-components-order-summaries-02-with-progress-bars` as a registered Rust-first block in the Order Summaries family. Preserve
...
- Block index `612` and `ecommerce-components-order-summaries-02-with-progress-bars` are the stable registry identity.
...
- Resolve `BlockId::from_index(612)`, or look up `ecommerce-components-order-summaries-02-with-progress-bars` with
...
- The registry resolves both block id `612` and slug `ecommerce-components-order-summaries-02-with-progress-bars` one-to-one.
...
- An isolated `block-ecommerce-components-order-summaries-02-with-progress-bars` story proves the fixture in both renderers.
