...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-7b841ae32a25ff642d2c128cf11b62d1

Catalog path: Application UI / elements / Badges / variant 13 of 16

## TPM Outcome

Ship `application-ui-elements-badges-13-small-pill-with-border` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `477` and `application-ui-elements-badges-13-small-pill-with-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(477)`, or look up `application-ui-elements-badges-13-small-pill-with-border` with
...
- The registry resolves both block id `477` and slug `application-ui-elements-badges-13-small-pill-with-border` one-to-one.
...
- An isolated `block-application-ui-elements-badges-13-small-pill-with-border` story proves the fixture in both renderers.
