...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-9a0cf79b18a892dfed706f00447128e3

Catalog path: Application UI / headings / Card Headings / variant 2 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-02-with-action` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `212` and `application-ui-headings-card-headings-02-with-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(212)`, or look up `application-ui-headings-card-headings-02-with-action` with
...
- The registry resolves both block id `212` and slug `application-ui-headings-card-headings-02-with-action` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-02-with-action` story proves the fixture in both renderers.
