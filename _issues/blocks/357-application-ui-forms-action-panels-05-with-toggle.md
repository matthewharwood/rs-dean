...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-575df646e77ef070900d616c26a521e7

Catalog path: Application UI / forms / Action Panels / variant 5 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-05-with-toggle` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `356` and `application-ui-forms-action-panels-05-with-toggle` are the stable registry identity.
...
- The family maps to the `Form` composition pattern and the `Card`
...
- Resolve `BlockId::from_index(356)`, or look up `application-ui-forms-action-panels-05-with-toggle` with
...
- The registry resolves both block id `356` and slug `application-ui-forms-action-panels-05-with-toggle` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-05-with-toggle` story proves the fixture in both renderers.
