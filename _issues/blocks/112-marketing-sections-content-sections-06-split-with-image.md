...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-be88a98fa8e54342829a636bd0bff3f6

Catalog path: Marketing / sections / Content Sections / variant 6 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-06-split-with-image` as a registered Rust-first block in the Content Sections family. Preserve
...
- Block index `111` and `marketing-sections-content-sections-06-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(111)`, or look up `marketing-sections-content-sections-06-split-with-image` with
...
- The registry resolves both block id `111` and slug `marketing-sections-content-sections-06-split-with-image` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-06-split-with-image` story proves the fixture in both renderers.
