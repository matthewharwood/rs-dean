...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/checkout-pages#component-a9a6b2fd86b533dfed24f36da907b20f

Catalog path: Ecommerce / page-examples / Checkout Pages / variant 5 of 5

## TPM Outcome

Ship `ecommerce-page-examples-checkout-pages-05-split-with-order-summary` as a registered Rust-first block in the Checkout Pages family. Preserve
...
- Block index `648` and `ecommerce-page-examples-checkout-pages-05-split-with-order-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(648)`, or look up `ecommerce-page-examples-checkout-pages-05-split-with-order-summary` with
...
- The registry resolves both block id `648` and slug `ecommerce-page-examples-checkout-pages-05-split-with-order-summary` one-to-one.
...
- An isolated `block-ecommerce-page-examples-checkout-pages-05-split-with-order-summary` story proves the fixture in both renderers.
