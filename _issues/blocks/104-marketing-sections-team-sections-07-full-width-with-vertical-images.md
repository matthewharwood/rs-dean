...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-47734c5175a01916ce046c9ad77b3aaf

Catalog path: Marketing / sections / Team Sections / variant 7 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-07-full-width-with-vertical-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `103` and `marketing-sections-team-sections-07-full-width-with-vertical-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(103)`, or look up `marketing-sections-team-sections-07-full-width-with-vertical-images` with
...
- The registry resolves both block id `103` and slug `marketing-sections-team-sections-07-full-width-with-vertical-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-07-full-width-with-vertical-images` story proves the fixture in both renderers.
