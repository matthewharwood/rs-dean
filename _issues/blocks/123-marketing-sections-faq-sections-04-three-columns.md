...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-f273cb93c5b5acf64f2c1711417aadfa

Catalog path: Marketing / sections / FAQs / variant 4 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-04-three-columns` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `122` and `marketing-sections-faq-sections-04-three-columns` are the stable registry identity.
...
- Resolve `BlockId::from_index(122)`, or look up `marketing-sections-faq-sections-04-three-columns` with
...
- The registry resolves both block id `122` and slug `marketing-sections-faq-sections-04-three-columns` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-04-three-columns` story proves the fixture in both renderers.
