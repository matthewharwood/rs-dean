...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-6702d62917fd70644340f4008b126943

Catalog path: Application UI / elements / Buttons / variant 8 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-08-circular-buttons` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `493` and `application-ui-elements-buttons-08-circular-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(493)`, or look up `application-ui-elements-buttons-08-circular-buttons` with
...
- The registry resolves both block id `493` and slug `application-ui-elements-buttons-08-circular-buttons` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-08-circular-buttons` story proves the fixture in both renderers.
