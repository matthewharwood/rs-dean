...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/checkout-forms#component-d88097dde78b4d4b63ef666f77afd97d

Catalog path: Ecommerce / components / Checkout Forms / variant 1 of 5

## TPM Outcome

Ship `ecommerce-components-checkout-forms-01-single-step-with-order-summary` as a registered Rust-first block in the Checkout Forms family. Preserve
...
- Block index `602` and `ecommerce-components-checkout-forms-01-single-step-with-order-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(602)`, or look up `ecommerce-components-checkout-forms-01-single-step-with-order-summary` with
...
- The registry resolves both block id `602` and slug `ecommerce-components-checkout-forms-01-single-step-with-order-summary` one-to-one.
...
- An isolated `block-ecommerce-components-checkout-forms-01-single-step-with-order-summary` story proves the fixture in both renderers.
