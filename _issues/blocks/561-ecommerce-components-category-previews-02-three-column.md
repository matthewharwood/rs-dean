...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-37995021e5cdf0c643346920ff40b13b

Catalog path: Ecommerce / components / Category Previews / variant 2 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-02-three-column` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `560` and `ecommerce-components-category-previews-02-three-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(560)`, or look up `ecommerce-components-category-previews-02-three-column` with
...
- The registry resolves both block id `560` and slug `ecommerce-components-category-previews-02-three-column` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-02-three-column` story proves the fixture in both renderers.
