...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-ce3346a7007ed3114735fd9771b3d393

Catalog path: Ecommerce / components / Product Lists / variant 11 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-11-card-with-full-details` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `558` and `ecommerce-components-product-lists-11-card-with-full-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(558)`, or look up `ecommerce-components-product-lists-11-card-with-full-details` with
...
- The registry resolves both block id `558` and slug `ecommerce-components-product-lists-11-card-with-full-details` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-11-card-with-full-details` story proves the fixture in both renderers.
