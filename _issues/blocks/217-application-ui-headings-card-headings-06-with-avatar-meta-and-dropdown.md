...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-566f127b7b70db160352896d06794a7f

Catalog path: Application UI / headings / Card Headings / variant 6 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-06-with-avatar-meta-and-dropdown` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `216` and `application-ui-headings-card-headings-06-with-avatar-meta-and-dropdown` are the stable registry identity.
...
- Resolve `BlockId::from_index(216)`, or look up `application-ui-headings-card-headings-06-with-avatar-meta-and-dropdown` with
...
- The registry resolves both block id `216` and slug `application-ui-headings-card-headings-06-with-avatar-meta-and-dropdown` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-06-with-avatar-meta-and-dropdown` story proves the fixture in both renderers.
