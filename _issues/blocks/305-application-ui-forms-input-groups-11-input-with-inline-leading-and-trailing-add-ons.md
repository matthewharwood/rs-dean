...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-1a20b7fee66274173ad5ed756fabb335

Catalog path: Application UI / forms / Input Groups / variant 11 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-11-input-with-inline-leading-and-trailing-add-ons` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `304` and `application-ui-forms-input-groups-11-input-with-inline-leading-and-trailing-add-ons` are the stable registry identity.
...
- Resolve `BlockId::from_index(304)`, or look up `application-ui-forms-input-groups-11-input-with-inline-leading-and-trailing-add-ons` with
...
- The registry resolves both block id `304` and slug `application-ui-forms-input-groups-11-input-with-inline-leading-and-trailing-add-ons` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-11-input-with-inline-leading-and-trailing-add-ons` story proves the fixture in both renderers.
