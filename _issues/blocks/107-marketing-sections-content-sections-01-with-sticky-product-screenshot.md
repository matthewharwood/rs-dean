...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-218027743700ff38c54be7e9c1ce3bf8

Catalog path: Marketing / sections / Content Sections / variant 1 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-01-with-sticky-product-screenshot` as a registered Rust-first block in the Content Sections family. Preserve
...
- Apply the typed `Screenshot` media mode, `Plain` surface treatment, and
...
- Block index `106` and `marketing-sections-content-sections-01-with-sticky-product-screenshot` are the stable registry identity.
...
- The family maps to the `Editorial` composition pattern and the `Typography`
  primary UI component.
- Variant behavior is constrained by `Screenshot`, `Plain`, and `Static`
...
- Resolve `BlockId::from_index(106)`, or look up `marketing-sections-content-sections-01-with-sticky-product-screenshot` with
...
- The registry resolves both block id `106` and slug `marketing-sections-content-sections-01-with-sticky-product-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-01-with-sticky-product-screenshot` story proves the fixture in both renderers.
