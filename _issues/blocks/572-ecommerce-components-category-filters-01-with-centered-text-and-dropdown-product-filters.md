...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-filters#component-cb75aacd7c636865835476c98f606a38

Catalog path: Ecommerce / components / Category Filters / variant 1 of 5

## TPM Outcome

Ship `ecommerce-components-category-filters-01-with-centered-text-and-dropdown-product-filters` as a registered Rust-first block in the Category Filters family. Preserve
...
- Block index `571` and `ecommerce-components-category-filters-01-with-centered-text-and-dropdown-product-filters` are the stable registry identity.
...
- Variant behavior is constrained by `Product media`, `Plain`, and `Filter`
...
- Resolve `BlockId::from_index(571)`, or look up `ecommerce-components-category-filters-01-with-centered-text-and-dropdown-product-filters` with
...
- The registry resolves both block id `571` and slug `ecommerce-components-category-filters-01-with-centered-text-and-dropdown-product-filters` one-to-one.
...
- An isolated `block-ecommerce-components-category-filters-01-with-centered-text-and-dropdown-product-filters` story proves the fixture in both renderers.
