...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-8476b5eab4015287662c951b2e314cfa

Catalog path: Marketing / sections / Feature Sections / variant 15 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-15-simple-3x2-grid` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `26` and `marketing-sections-feature-sections-15-simple-3x2-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(26)`, or look up `marketing-sections-feature-sections-15-simple-3x2-grid` with
...
- The registry resolves both block id `26` and slug `marketing-sections-feature-sections-15-simple-3x2-grid` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-15-simple-3x2-grid` story proves the fixture in both renderers.
