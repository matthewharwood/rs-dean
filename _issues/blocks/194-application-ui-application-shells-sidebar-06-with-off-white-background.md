...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-bcda0241bdc4768c6b966958a683047c

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 6 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-06-with-off-white-background` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `193` and `application-ui-application-shells-sidebar-06-with-off-white-background` are the stable registry identity.
...
- Resolve `BlockId::from_index(193)`, or look up `application-ui-application-shells-sidebar-06-with-off-white-background` with
...
- The registry resolves both block id `193` and slug `application-ui-application-shells-sidebar-06-with-off-white-background` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-06-with-off-white-background` story proves the fixture in both renderers.
