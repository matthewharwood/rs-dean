...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-f23694a5070bbd968770234e5d1e178e

Catalog path: Marketing / sections / FAQs / variant 7 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-07-two-columns-with-centered-introduction` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `125` and `marketing-sections-faq-sections-07-two-columns-with-centered-introduction` are the stable registry identity.
...
- Resolve `BlockId::from_index(125)`, or look up `marketing-sections-faq-sections-07-two-columns-with-centered-introduction` with
...
- The registry resolves both block id `125` and slug `marketing-sections-faq-sections-07-two-columns-with-centered-introduction` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-07-two-columns-with-centered-introduction` story proves the fixture in both renderers.
