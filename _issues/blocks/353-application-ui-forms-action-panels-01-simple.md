...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-2f53677fe913f1a063fd93ac9a8fc425

Catalog path: Application UI / forms / Action Panels / variant 1 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-01-simple` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `352` and `application-ui-forms-action-panels-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(352)`, or look up `application-ui-forms-action-panels-01-simple` with
...
- The registry resolves both block id `352` and slug `application-ui-forms-action-panels-01-simple` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-01-simple` story proves the fixture in both renderers.
