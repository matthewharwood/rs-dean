...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-a79cba194f17e6b28fe610c07bcdb8a0

Catalog path: Marketing / sections / FAQs / variant 3 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-03-side-by-side` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `121` and `marketing-sections-faq-sections-03-side-by-side` are the stable registry identity.
...
- Resolve `BlockId::from_index(121)`, or look up `marketing-sections-faq-sections-03-side-by-side` with
...
- The registry resolves both block id `121` and slug `marketing-sections-faq-sections-03-side-by-side` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-03-side-by-side` story proves the fixture in both renderers.
