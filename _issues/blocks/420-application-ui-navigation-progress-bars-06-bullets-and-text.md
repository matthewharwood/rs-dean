...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-de81b2a07fe257c90fcc7a8c68489f02

Catalog path: Application UI / navigation / Progress Bars / variant 6 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-06-bullets-and-text` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `419` and `application-ui-navigation-progress-bars-06-bullets-and-text` are the stable registry identity.
...
- Resolve `BlockId::from_index(419)`, or look up `application-ui-navigation-progress-bars-06-bullets-and-text` with
...
- The registry resolves both block id `419` and slug `application-ui-navigation-progress-bars-06-bullets-and-text` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-06-bullets-and-text` story proves the fixture in both renderers.
