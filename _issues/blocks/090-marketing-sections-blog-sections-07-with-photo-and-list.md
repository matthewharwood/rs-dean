...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-f02cbddc32e5e2729b224d6a34e31f4a

Catalog path: Marketing / sections / Blog Sections / variant 7 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-07-with-photo-and-list` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `89` and `marketing-sections-blog-sections-07-with-photo-and-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(89)`, or look up `marketing-sections-blog-sections-07-with-photo-and-list` with
...
- The registry resolves both block id `89` and slug `marketing-sections-blog-sections-07-with-photo-and-list` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-07-with-photo-and-list` story proves the fixture in both renderers.
