...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/progress-bars#component-2771127c1e236ed43a11c623657479d5

Catalog path: Application UI / navigation / Progress Bars / variant 1 of 8

## TPM Outcome

Ship `application-ui-navigation-progress-bars-01-simple` as a registered Rust-first block in the Progress Bars family. Preserve
...
- Block index `414` and `application-ui-navigation-progress-bars-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(414)`, or look up `application-ui-navigation-progress-bars-01-simple` with
...
- The registry resolves both block id `414` and slug `application-ui-navigation-progress-bars-01-simple` one-to-one.
...
- An isolated `block-application-ui-navigation-progress-bars-01-simple` story proves the fixture in both renderers.
