...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-6e8d7d4ca9657a86da779b7af9a1de2c

Catalog path: Application UI / lists / Tables / variant 10 of 19

## TPM Outcome

Ship `application-ui-lists-tables-10-with-sticky-header` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `270` and `application-ui-lists-tables-10-with-sticky-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(270)`, or look up `application-ui-lists-tables-10-with-sticky-header` with
...
- The registry resolves both block id `270` and slug `application-ui-lists-tables-10-with-sticky-header` one-to-one.
...
- An isolated `block-application-ui-lists-tables-10-with-sticky-header` story proves the fixture in both renderers.
