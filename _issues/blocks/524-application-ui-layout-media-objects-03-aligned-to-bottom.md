...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-8f103bc65ca8eae900111c14168fcdbc

Catalog path: Application UI / layout / Media Objects / variant 3 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-03-aligned-to-bottom` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `523` and `application-ui-layout-media-objects-03-aligned-to-bottom` are the stable registry identity.
...
- Resolve `BlockId::from_index(523)`, or look up `application-ui-layout-media-objects-03-aligned-to-bottom` with
...
- The registry resolves both block id `523` and slug `application-ui-layout-media-objects-03-aligned-to-bottom` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-03-aligned-to-bottom` story proves the fixture in both renderers.
