...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-2b205c50497e231565b015fc1457839e

Catalog path: Marketing / sections / Hero Sections / variant 7 of 12

## TPM Outcome

Ship `marketing-sections-heroes-07-with-app-screenshot` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `6` and `marketing-sections-heroes-07-with-app-screenshot` are the stable registry identity.
...
- Resolve `BlockId::from_index(6)`, or look up `marketing-sections-heroes-07-with-app-screenshot` with
...
- The registry resolves both block id `6` and slug `marketing-sections-heroes-07-with-app-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-heroes-07-with-app-screenshot` story proves the fixture in both renderers.
