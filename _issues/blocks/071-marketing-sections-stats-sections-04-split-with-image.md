...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-f488532a6d2ff00f8ce0f9a787808a9c

Catalog path: Marketing / sections / Stats / variant 4 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-04-split-with-image` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `70` and `marketing-sections-stats-sections-04-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(70)`, or look up `marketing-sections-stats-sections-04-split-with-image` with
...
- The registry resolves both block id `70` and slug `marketing-sections-stats-sections-04-split-with-image` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-04-split-with-image` story proves the fixture in both renderers.
