...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/checkout-forms#component-0cc73c0ab9d4e5c1d34cc5dc1a7ac96a

Catalog path: Ecommerce / components / Checkout Forms / variant 4 of 5

## TPM Outcome

Ship `ecommerce-components-checkout-forms-04-with-order-summary-sidebar` as a registered Rust-first block in the Checkout Forms family. Preserve
...
- Block index `605` and `ecommerce-components-checkout-forms-04-with-order-summary-sidebar` are the stable registry identity.
...
- Resolve `BlockId::from_index(605)`, or look up `ecommerce-components-checkout-forms-04-with-order-summary-sidebar` with
...
- The registry resolves both block id `605` and slug `ecommerce-components-checkout-forms-04-with-order-summary-sidebar` one-to-one.
...
- An isolated `block-ecommerce-components-checkout-forms-04-with-order-summary-sidebar` story proves the fixture in both renderers.
