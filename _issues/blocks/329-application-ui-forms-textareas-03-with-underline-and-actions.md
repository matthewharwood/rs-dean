...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/textareas#component-7c970c3497e5971b9e7e7c8d062d9e3b

Catalog path: Application UI / forms / Textareas / variant 3 of 5

## TPM Outcome

Ship `application-ui-forms-textareas-03-with-underline-and-actions` as a registered Rust-first block in the Textareas family. Preserve
...
- Block index `328` and `application-ui-forms-textareas-03-with-underline-and-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(328)`, or look up `application-ui-forms-textareas-03-with-underline-and-actions` with
...
- The registry resolves both block id `328` and slug `application-ui-forms-textareas-03-with-underline-and-actions` one-to-one.
...
- An isolated `block-application-ui-forms-textareas-03-with-underline-and-actions` story proves the fixture in both renderers.
