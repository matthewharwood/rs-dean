...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/checkout-pages#component-d6f0fd2a3b29de41b8bf61af8433be16

Catalog path: Ecommerce / page-examples / Checkout Pages / variant 3 of 5

## TPM Outcome

Ship `ecommerce-page-examples-checkout-pages-03-with-mobile-order-summary-overlay` as a registered Rust-first block in the Checkout Pages family. Preserve
...
- Block index `646` and `ecommerce-page-examples-checkout-pages-03-with-mobile-order-summary-overlay` are the stable registry identity.
...
- Resolve `BlockId::from_index(646)`, or look up `ecommerce-page-examples-checkout-pages-03-with-mobile-order-summary-overlay` with
...
- The registry resolves both block id `646` and slug `ecommerce-page-examples-checkout-pages-03-with-mobile-order-summary-overlay` one-to-one.
...
- An isolated `block-ecommerce-page-examples-checkout-pages-03-with-mobile-order-summary-overlay` story proves the fixture in both renderers.
