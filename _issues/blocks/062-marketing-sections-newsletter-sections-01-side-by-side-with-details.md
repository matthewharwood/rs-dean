...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/newsletter-sections#component-82fc139db99143307df48bb9fe6152c5

Catalog path: Marketing / sections / Newsletter Sections / variant 1 of 6

## TPM Outcome

Ship `marketing-sections-newsletter-sections-01-side-by-side-with-details` as a registered Rust-first block in the Newsletter Sections family. Preserve
...
- Block index `61` and `marketing-sections-newsletter-sections-01-side-by-side-with-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(61)`, or look up `marketing-sections-newsletter-sections-01-side-by-side-with-details` with
...
- The registry resolves both block id `61` and slug `marketing-sections-newsletter-sections-01-side-by-side-with-details` one-to-one.
...
- An isolated `block-marketing-sections-newsletter-sections-01-side-by-side-with-details` story proves the fixture in both renderers.
