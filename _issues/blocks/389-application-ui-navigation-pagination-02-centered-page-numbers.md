...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/pagination#component-f9a9347de5384a492c79c34cf6ce3ccf

Catalog path: Application UI / navigation / Pagination / variant 2 of 3

## TPM Outcome

Ship `application-ui-navigation-pagination-02-centered-page-numbers` as a registered Rust-first block in the Pagination family. Preserve
...
- Block index `388` and `application-ui-navigation-pagination-02-centered-page-numbers` are the stable registry identity.
...
- The family maps to the `Navigation` composition pattern and the `Pagination`
...
- Resolve `BlockId::from_index(388)`, or look up `application-ui-navigation-pagination-02-centered-page-numbers` with
...
- The registry resolves both block id `388` and slug `application-ui-navigation-pagination-02-centered-page-numbers` one-to-one.
...
- An isolated `block-application-ui-navigation-pagination-02-centered-page-numbers` story proves the fixture in both renderers.
