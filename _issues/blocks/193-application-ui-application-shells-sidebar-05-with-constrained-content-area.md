...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-9d1c8401d0b558af19422eb15ddc8620

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 5 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-05-with-constrained-content-area` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `192` and `application-ui-application-shells-sidebar-05-with-constrained-content-area` are the stable registry identity.
...
- Resolve `BlockId::from_index(192)`, or look up `application-ui-application-shells-sidebar-05-with-constrained-content-area` with
...
- The registry resolves both block id `192` and slug `application-ui-application-shells-sidebar-05-with-constrained-content-area` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-05-with-constrained-content-area` story proves the fixture in both renderers.
