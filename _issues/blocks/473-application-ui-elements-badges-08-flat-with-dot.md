...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-7a572c03b50600e6da9768983a8e9043

Catalog path: Application UI / elements / Badges / variant 8 of 16

## TPM Outcome

Ship `application-ui-elements-badges-08-flat-with-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `472` and `application-ui-elements-badges-08-flat-with-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(472)`, or look up `application-ui-elements-badges-08-flat-with-dot` with
...
- The registry resolves both block id `472` and slug `application-ui-elements-badges-08-flat-with-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-08-flat-with-dot` story proves the fixture in both renderers.
