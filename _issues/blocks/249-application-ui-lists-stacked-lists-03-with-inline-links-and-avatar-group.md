...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-0e46de7c930770b339e15800282bbc37

Catalog path: Application UI / lists / Stacked Lists / variant 3 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-03-with-inline-links-and-avatar-group` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `248` and `application-ui-lists-stacked-lists-03-with-inline-links-and-avatar-group` are the stable registry identity.
...
- Resolve `BlockId::from_index(248)`, or look up `application-ui-lists-stacked-lists-03-with-inline-links-and-avatar-group` with
...
- The registry resolves both block id `248` and slug `application-ui-lists-stacked-lists-03-with-inline-links-and-avatar-group` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-03-with-inline-links-and-avatar-group` story proves the fixture in both renderers.
