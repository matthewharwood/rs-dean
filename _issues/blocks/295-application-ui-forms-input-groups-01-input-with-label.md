...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-04a268fee12196d74c94e82a43106f8d

Catalog path: Application UI / forms / Input Groups / variant 1 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-01-input-with-label` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `294` and `application-ui-forms-input-groups-01-input-with-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(294)`, or look up `application-ui-forms-input-groups-01-input-with-label` with
...
- The registry resolves both block id `294` and slug `application-ui-forms-input-groups-01-input-with-label` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-01-input-with-label` story proves the fixture in both renderers.
