...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-607fe5cb764384292b01318ed7f28c14

Catalog path: Application UI / forms / Action Panels / variant 7 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-07-simple-well` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `358` and `application-ui-forms-action-panels-07-simple-well` are the stable registry identity.
...
- Resolve `BlockId::from_index(358)`, or look up `application-ui-forms-action-panels-07-simple-well` with
...
- The registry resolves both block id `358` and slug `application-ui-forms-action-panels-07-simple-well` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-07-simple-well` story proves the fixture in both renderers.
