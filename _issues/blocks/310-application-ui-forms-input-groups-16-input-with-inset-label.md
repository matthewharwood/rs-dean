...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-85e0087460af7ce9f5160485832f72b2

Catalog path: Application UI / forms / Input Groups / variant 16 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-16-input-with-inset-label` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `309` and `application-ui-forms-input-groups-16-input-with-inset-label` are the stable registry identity.
...
- Resolve `BlockId::from_index(309)`, or look up `application-ui-forms-input-groups-16-input-with-inset-label` with
...
- The registry resolves both block id `309` and slug `application-ui-forms-input-groups-16-input-with-inset-label` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-16-input-with-inset-label` story proves the fixture in both renderers.
