...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-dd9098382f8067c3d90b99dbad8351a3

Catalog path: Marketing / elements / Banners / variant 9 of 13

## TPM Outcome

Ship `marketing-elements-banners-09-floating-at-bottom-centered` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `159` and `marketing-elements-banners-09-floating-at-bottom-centered` are the stable registry identity.
...
- The family maps to the `Feedback` composition pattern and the `Alert`
...
- Resolve `BlockId::from_index(159)`, or look up `marketing-elements-banners-09-floating-at-bottom-centered` with
...
- The registry resolves both block id `159` and slug `marketing-elements-banners-09-floating-at-bottom-centered` one-to-one.
...
- An isolated `block-marketing-elements-banners-09-floating-at-bottom-centered` story proves the fixture in both renderers.
