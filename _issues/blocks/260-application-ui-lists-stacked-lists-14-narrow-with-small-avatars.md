...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-3e86787d0e3cb82b44746a24f61768e7

Catalog path: Application UI / lists / Stacked Lists / variant 14 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-14-narrow-with-small-avatars` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `259` and `application-ui-lists-stacked-lists-14-narrow-with-small-avatars` are the stable registry identity.
...
- Resolve `BlockId::from_index(259)`, or look up `application-ui-lists-stacked-lists-14-narrow-with-small-avatars` with
...
- The registry resolves both block id `259` and slug `application-ui-lists-stacked-lists-14-narrow-with-small-avatars` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-14-narrow-with-small-avatars` story proves the fixture in both renderers.
