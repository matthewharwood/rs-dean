...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/pagination#component-69eb9381f977800aa890ce8f7d9e2d20

Catalog path: Application UI / navigation / Pagination / variant 1 of 3

## TPM Outcome

Ship `application-ui-navigation-pagination-01-card-footer-with-page-buttons` as a registered Rust-first block in the Pagination family. Preserve
...
- Block index `387` and `application-ui-navigation-pagination-01-card-footer-with-page-buttons` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Panel`, and `Menu`
...
- Resolve `BlockId::from_index(387)`, or look up `application-ui-navigation-pagination-01-card-footer-with-page-buttons` with
...
- The registry resolves both block id `387` and slug `application-ui-navigation-pagination-01-card-footer-with-page-buttons` one-to-one.
...
- An isolated `block-application-ui-navigation-pagination-01-card-footer-with-page-buttons` story proves the fixture in both renderers.
