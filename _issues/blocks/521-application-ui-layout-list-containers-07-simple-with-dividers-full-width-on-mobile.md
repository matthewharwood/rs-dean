...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/list-containers#component-e928e0ef48e654b288069499e7359e23

Catalog path: Application UI / layout / List containers / variant 7 of 7

## TPM Outcome

Ship `application-ui-layout-list-containers-07-simple-with-dividers-full-width-on-mobile` as a registered Rust-first block in the List containers family. Preserve
...
- Apply the typed `No media` media mode, `Bordered` surface treatment, and
...
- Block index `520` and `application-ui-layout-list-containers-07-simple-with-dividers-full-width-on-mobile` are the stable registry identity.
...
- The family maps to the `Collection` composition pattern and the `Item`
  primary UI component.
- Variant behavior is constrained by `No media`, `Bordered`, and `Static`
...
- Resolve `BlockId::from_index(520)`, or look up `application-ui-layout-list-containers-07-simple-with-dividers-full-width-on-mobile` with
...
- The registry resolves both block id `520` and slug `application-ui-layout-list-containers-07-simple-with-dividers-full-width-on-mobile` one-to-one.
...
- An isolated `block-application-ui-layout-list-containers-07-simple-with-dividers-full-width-on-mobile` story proves the fixture in both renderers.
