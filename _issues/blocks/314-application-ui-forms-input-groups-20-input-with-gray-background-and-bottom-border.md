...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-9ea6fd1e083858f747f6bac9151550c1

Catalog path: Application UI / forms / Input Groups / variant 20 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-20-input-with-gray-background-and-bottom-border` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `313` and `application-ui-forms-input-groups-20-input-with-gray-background-and-bottom-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(313)`, or look up `application-ui-forms-input-groups-20-input-with-gray-background-and-bottom-border` with
...
- The registry resolves both block id `313` and slug `application-ui-forms-input-groups-20-input-with-gray-background-and-bottom-border` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-20-input-with-gray-background-and-bottom-border` story proves the fixture in both renderers.
