...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/detail-screens#component-6d449ab606e4b9f99757efd317b768de

Catalog path: Application UI / page-examples / Detail Screens / variant 2 of 2

## TPM Outcome

Ship `application-ui-page-examples-detail-screens-02-stacked` as a registered Rust-first block in the Detail Screens family. Preserve
...
- Block index `540` and `application-ui-page-examples-detail-screens-02-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(540)`, or look up `application-ui-page-examples-detail-screens-02-stacked` with
...
- The registry resolves both block id `540` and slug `application-ui-page-examples-detail-screens-02-stacked` one-to-one.
...
- An isolated `block-application-ui-page-examples-detail-screens-02-stacked` story proves the fixture in both renderers.
