...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-230ebe97ca4f24eef13b0a225e41b87b

Catalog path: Application UI / overlays / Modal Dialogs / variant 2 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-02-centered-with-wide-buttons` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `431` and `application-ui-overlays-modal-dialogs-02-centered-with-wide-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(431)`, or look up `application-ui-overlays-modal-dialogs-02-centered-with-wide-buttons` with
...
- The registry resolves both block id `431` and slug `application-ui-overlays-modal-dialogs-02-centered-with-wide-buttons` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-02-centered-with-wide-buttons` story proves the fixture in both renderers.
