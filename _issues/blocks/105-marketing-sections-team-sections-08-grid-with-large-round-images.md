...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-eb7952c73eb192259f344487948d339e

Catalog path: Marketing / sections / Team Sections / variant 8 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-08-grid-with-large-round-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `104` and `marketing-sections-team-sections-08-grid-with-large-round-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(104)`, or look up `marketing-sections-team-sections-08-grid-with-large-round-images` with
...
- The registry resolves both block id `104` and slug `marketing-sections-team-sections-08-grid-with-large-round-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-08-grid-with-large-round-images` story proves the fixture in both renderers.
