...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-2f3ef5016b7f5b976cc8045b564dd774

Catalog path: Application UI / elements / Badges / variant 12 of 16

## TPM Outcome

Ship `application-ui-elements-badges-12-small-flat` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `476` and `application-ui-elements-badges-12-small-flat` are the stable registry identity.
...
- Resolve `BlockId::from_index(476)`, or look up `application-ui-elements-badges-12-small-flat` with
...
- The registry resolves both block id `476` and slug `application-ui-elements-badges-12-small-flat` one-to-one.
...
- An isolated `block-application-ui-elements-badges-12-small-flat` story proves the fixture in both renderers.
