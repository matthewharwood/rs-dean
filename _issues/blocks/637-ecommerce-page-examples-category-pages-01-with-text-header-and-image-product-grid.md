...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/category-pages#component-bba40c3d5ade88d4cd15b3db01f67097

Catalog path: Ecommerce / page-examples / Category Pages / variant 1 of 5

## TPM Outcome

Ship `ecommerce-page-examples-category-pages-01-with-text-header-and-image-product-grid` as a registered Rust-first block in the Category Pages family. Preserve
...
- Block index `636` and `ecommerce-page-examples-category-pages-01-with-text-header-and-image-product-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(636)`, or look up `ecommerce-page-examples-category-pages-01-with-text-header-and-image-product-grid` with
...
- The registry resolves both block id `636` and slug `ecommerce-page-examples-category-pages-01-with-text-header-and-image-product-grid` one-to-one.
...
- An isolated `block-ecommerce-page-examples-category-pages-01-with-text-header-and-image-product-grid` story proves the fixture in both renderers.
