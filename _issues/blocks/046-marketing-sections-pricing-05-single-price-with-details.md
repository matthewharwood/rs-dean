...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-56cbd4f191ac0d54e5a5c0287481d5b9

Catalog path: Marketing / sections / Pricing Sections / variant 5 of 12

## TPM Outcome

Ship `marketing-sections-pricing-05-single-price-with-details` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `45` and `marketing-sections-pricing-05-single-price-with-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(45)`, or look up `marketing-sections-pricing-05-single-price-with-details` with
...
- The registry resolves both block id `45` and slug `marketing-sections-pricing-05-single-price-with-details` one-to-one.
...
- An isolated `block-marketing-sections-pricing-05-single-price-with-details` story proves the fixture in both renderers.
