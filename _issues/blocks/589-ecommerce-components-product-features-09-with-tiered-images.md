...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-c348959ea53204f2d87ccdabad56aef0

Catalog path: Ecommerce / components / Product Features / variant 9 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-09-with-tiered-images` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `588` and `ecommerce-components-product-features-09-with-tiered-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(588)`, or look up `ecommerce-components-product-features-09-with-tiered-images` with
...
- The registry resolves both block id `588` and slug `ecommerce-components-product-features-09-with-tiered-images` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-09-with-tiered-images` story proves the fixture in both renderers.
