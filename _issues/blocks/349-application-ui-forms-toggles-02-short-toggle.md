...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/toggles#component-b3e0a15571300f79fced5845f97fa972

Catalog path: Application UI / forms / Toggles / variant 2 of 5

## TPM Outcome

Ship `application-ui-forms-toggles-02-short-toggle` as a registered Rust-first block in the Toggles family. Preserve
...
- Block index `348` and `application-ui-forms-toggles-02-short-toggle` are the stable registry identity.
...
- Resolve `BlockId::from_index(348)`, or look up `application-ui-forms-toggles-02-short-toggle` with
...
- The registry resolves both block id `348` and slug `application-ui-forms-toggles-02-short-toggle` one-to-one.
...
- An isolated `block-application-ui-forms-toggles-02-short-toggle` story proves the fixture in both renderers.
