...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-ddd6f8c57e5a07ac015b69ee0a71b0d4

Catalog path: Application UI / lists / Stacked Lists / variant 8 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-08-full-width-with-links` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `253` and `application-ui-lists-stacked-lists-08-full-width-with-links` are the stable registry identity.
...
- Resolve `BlockId::from_index(253)`, or look up `application-ui-lists-stacked-lists-08-full-width-with-links` with
...
- The registry resolves both block id `253` and slug `application-ui-lists-stacked-lists-08-full-width-with-links` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-08-full-width-with-links` story proves the fixture in both renderers.
