...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/category-pages#component-bd8eb5804d133c8fa4f6027217342fce

Catalog path: Ecommerce / page-examples / Category Pages / variant 5 of 5

## TPM Outcome

Ship `ecommerce-page-examples-category-pages-05-with-large-images-and-filters-sidebar` as a registered Rust-first block in the Category Pages family. Preserve
...
- Block index `640` and `ecommerce-page-examples-category-pages-05-with-large-images-and-filters-sidebar` are the stable registry identity.
...
- Variant behavior is constrained by `Image`, `Plain`, and `Filter`
...
- Resolve `BlockId::from_index(640)`, or look up `ecommerce-page-examples-category-pages-05-with-large-images-and-filters-sidebar` with
...
- The registry resolves both block id `640` and slug `ecommerce-page-examples-category-pages-05-with-large-images-and-filters-sidebar` one-to-one.
...
- An isolated `block-ecommerce-page-examples-category-pages-05-with-large-images-and-filters-sidebar` story proves the fixture in both renderers.
