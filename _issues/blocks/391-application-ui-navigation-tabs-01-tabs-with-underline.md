...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-de43ff625fee032d234b14989e88422f

Catalog path: Application UI / navigation / Tabs / variant 1 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-01-tabs-with-underline` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `390` and `application-ui-navigation-tabs-01-tabs-with-underline` are the stable registry identity.
...
- Resolve `BlockId::from_index(390)`, or look up `application-ui-navigation-tabs-01-tabs-with-underline` with
...
- The registry resolves both block id `390` and slug `application-ui-navigation-tabs-01-tabs-with-underline` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-01-tabs-with-underline` story proves the fixture in both renderers.
