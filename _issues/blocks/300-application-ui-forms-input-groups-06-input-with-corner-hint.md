...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-cd2d41bc1bca37b76acacab5925d507c

Catalog path: Application UI / forms / Input Groups / variant 6 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-06-input-with-corner-hint` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `299` and `application-ui-forms-input-groups-06-input-with-corner-hint` are the stable registry identity.
...
- Resolve `BlockId::from_index(299)`, or look up `application-ui-forms-input-groups-06-input-with-corner-hint` with
...
- The registry resolves both block id `299` and slug `application-ui-forms-input-groups-06-input-with-corner-hint` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-06-input-with-corner-hint` story proves the fixture in both renderers.
