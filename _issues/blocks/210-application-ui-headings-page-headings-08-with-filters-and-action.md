...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-084702e69fb92658c23452d0dffc8639

Catalog path: Application UI / headings / Page Headings / variant 8 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-08-with-filters-and-action` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `209` and `application-ui-headings-page-headings-08-with-filters-and-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(209)`, or look up `application-ui-headings-page-headings-08-with-filters-and-action` with
...
- The registry resolves both block id `209` and slug `application-ui-headings-page-headings-08-with-filters-and-action` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-08-with-filters-and-action` story proves the fixture in both renderers.
