...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-e4a92edf4f12acee331db4190019b4ef

Catalog path: Application UI / elements / Avatars / variant 9 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-09-avatar-group-stacked-bottom-to-top` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `462` and `application-ui-elements-avatars-09-avatar-group-stacked-bottom-to-top` are the stable registry identity.
...
- Resolve `BlockId::from_index(462)`, or look up `application-ui-elements-avatars-09-avatar-group-stacked-bottom-to-top` with
...
- The registry resolves both block id `462` and slug `application-ui-elements-avatars-09-avatar-group-stacked-bottom-to-top` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-09-avatar-group-stacked-bottom-to-top` story proves the fixture in both renderers.
