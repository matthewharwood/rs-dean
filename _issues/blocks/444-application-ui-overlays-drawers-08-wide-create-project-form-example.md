...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-dff90699fb6230e905c1de975230c736

Catalog path: Application UI / overlays / Drawers / variant 8 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-08-wide-create-project-form-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `443` and `application-ui-overlays-drawers-08-wide-create-project-form-example` are the stable registry identity.
...
- Resolve `BlockId::from_index(443)`, or look up `application-ui-overlays-drawers-08-wide-create-project-form-example` with
...
- The registry resolves both block id `443` and slug `application-ui-overlays-drawers-08-wide-create-project-form-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-08-wide-create-project-form-example` story proves the fixture in both renderers.
