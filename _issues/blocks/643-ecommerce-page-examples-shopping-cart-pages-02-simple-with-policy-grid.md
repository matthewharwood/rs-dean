...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/shopping-cart-pages#component-a1e2ea92ae3a4e4e74881fbc695f92bf

Catalog path: Ecommerce / page-examples / Shopping Cart Pages / variant 2 of 3

## TPM Outcome

Ship `ecommerce-page-examples-shopping-cart-pages-02-simple-with-policy-grid` as a registered Rust-first block in the Shopping Cart Pages family. Preserve
...
- Block index `642` and `ecommerce-page-examples-shopping-cart-pages-02-simple-with-policy-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(642)`, or look up `ecommerce-page-examples-shopping-cart-pages-02-simple-with-policy-grid` with
...
- The registry resolves both block id `642` and slug `ecommerce-page-examples-shopping-cart-pages-02-simple-with-policy-grid` one-to-one.
...
- An isolated `block-ecommerce-page-examples-shopping-cart-pages-02-simple-with-policy-grid` story proves the fixture in both renderers.
