...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/sidebar-navigation#component-5f3422a8482c68ee78f29705b19d7dfc

Catalog path: Application UI / navigation / Sidebar Navigation / variant 5 of 5

## TPM Outcome

Ship `application-ui-navigation-sidebar-navigation-05-brand` as a registered Rust-first block in the Sidebar Navigation family. Preserve
...
- Block index `409` and `application-ui-navigation-sidebar-navigation-05-brand` are the stable registry identity.
...
- Resolve `BlockId::from_index(409)`, or look up `application-ui-navigation-sidebar-navigation-05-brand` with
...
- The registry resolves both block id `409` and slug `application-ui-navigation-sidebar-navigation-05-brand` one-to-one.
...
- An isolated `block-application-ui-navigation-sidebar-navigation-05-brand` story proves the fixture in both renderers.
