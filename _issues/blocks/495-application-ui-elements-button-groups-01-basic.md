...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/button-groups#component-dc2468c1992adb5950f2d93cf589a65e

Catalog path: Application UI / elements / Button Groups / variant 1 of 5

## TPM Outcome

Ship `application-ui-elements-button-groups-01-basic` as a registered Rust-first block in the Button Groups family. Preserve
...
- Block index `494` and `application-ui-elements-button-groups-01-basic` are the stable registry identity.
...
- Resolve `BlockId::from_index(494)`, or look up `application-ui-elements-button-groups-01-basic` with
...
- The registry resolves both block id `494` and slug `application-ui-elements-button-groups-01-basic` one-to-one.
...
- An isolated `block-application-ui-elements-button-groups-01-basic` story proves the fixture in both renderers.
