...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-3b180d3192f5b442c58f58367258c15b

Catalog path: Application UI / lists / Tables / variant 8 of 19

## TPM Outcome

Ship `application-ui-lists-tables-08-with-hidden-columns-on-mobile` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `268` and `application-ui-lists-tables-08-with-hidden-columns-on-mobile` are the stable registry identity.
...
- Resolve `BlockId::from_index(268)`, or look up `application-ui-lists-tables-08-with-hidden-columns-on-mobile` with
...
- The registry resolves both block id `268` and slug `application-ui-lists-tables-08-with-hidden-columns-on-mobile` one-to-one.
...
- An isolated `block-application-ui-lists-tables-08-with-hidden-columns-on-mobile` story proves the fixture in both renderers.
