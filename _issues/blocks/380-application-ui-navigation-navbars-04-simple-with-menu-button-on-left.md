...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-b6bd4615a762a0d24780157803ad319e

Catalog path: Application UI / navigation / Navbars / variant 4 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-04-simple-with-menu-button-on-left` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `379` and `application-ui-navigation-navbars-04-simple-with-menu-button-on-left` are the stable registry identity.
...
- Resolve `BlockId::from_index(379)`, or look up `application-ui-navigation-navbars-04-simple-with-menu-button-on-left` with
...
- The registry resolves both block id `379` and slug `application-ui-navigation-navbars-04-simple-with-menu-button-on-left` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-04-simple-with-menu-button-on-left` story proves the fixture in both renderers.
