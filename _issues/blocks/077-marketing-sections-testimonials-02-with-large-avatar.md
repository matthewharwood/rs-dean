...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-54ee9cbce13afa3082f12b00ff1c00a6

Catalog path: Marketing / sections / Testimonials / variant 2 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-02-with-large-avatar` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `76` and `marketing-sections-testimonials-02-with-large-avatar` are the stable registry identity.
...
- Resolve `BlockId::from_index(76)`, or look up `marketing-sections-testimonials-02-with-large-avatar` with
...
- The registry resolves both block id `76` and slug `marketing-sections-testimonials-02-with-large-avatar` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-02-with-large-avatar` story proves the fixture in both renderers.
