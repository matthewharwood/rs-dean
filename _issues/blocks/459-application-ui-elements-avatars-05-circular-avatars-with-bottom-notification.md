...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-beffc7e57aaf1acb644b3a27ad29a2f8

Catalog path: Application UI / elements / Avatars / variant 5 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-05-circular-avatars-with-bottom-notification` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `458` and `application-ui-elements-avatars-05-circular-avatars-with-bottom-notification` are the stable registry identity.
...
- Resolve `BlockId::from_index(458)`, or look up `application-ui-elements-avatars-05-circular-avatars-with-bottom-notification` with
...
- The registry resolves both block id `458` and slug `application-ui-elements-avatars-05-circular-avatars-with-bottom-notification` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-05-circular-avatars-with-bottom-notification` story proves the fixture in both renderers.
