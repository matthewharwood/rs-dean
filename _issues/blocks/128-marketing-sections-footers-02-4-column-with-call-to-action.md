...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-2e47a11aec9a4e1aab7fc0e20d6b5951

Catalog path: Marketing / sections / Footers / variant 2 of 7

## TPM Outcome

Ship `marketing-sections-footers-02-4-column-with-call-to-action` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `127` and `marketing-sections-footers-02-4-column-with-call-to-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(127)`, or look up `marketing-sections-footers-02-4-column-with-call-to-action` with
...
- The registry resolves both block id `127` and slug `marketing-sections-footers-02-4-column-with-call-to-action` one-to-one.
...
- An isolated `block-marketing-sections-footers-02-4-column-with-call-to-action` story proves the fixture in both renderers.
