...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-71d7d7d72af96eb205739097efcb1c87

Catalog path: Ecommerce / page-examples / Order History Pages / variant 2 of 5

## TPM Outcome

Ship `ecommerce-page-examples-order-history-pages-02-with-invoice-list-and-quick-actions` as a registered Rust-first block in the Order History Pages family. Preserve
...
- Block index `653` and `ecommerce-page-examples-order-history-pages-02-with-invoice-list-and-quick-actions` are the stable registry identity.
...
- The family maps to the `Page composition` composition pattern and the `Table`
...
- Resolve `BlockId::from_index(653)`, or look up `ecommerce-page-examples-order-history-pages-02-with-invoice-list-and-quick-actions` with
...
- The registry resolves both block id `653` and slug `ecommerce-page-examples-order-history-pages-02-with-invoice-list-and-quick-actions` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-history-pages-02-with-invoice-list-and-quick-actions` story proves the fixture in both renderers.
