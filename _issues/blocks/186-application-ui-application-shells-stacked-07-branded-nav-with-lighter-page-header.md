...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-598386746ad5a838f5c9c6a8437be537

Catalog path: Application UI / application-shells / Stacked Layouts / variant 7 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-07-branded-nav-with-lighter-page-header` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `185` and `application-ui-application-shells-stacked-07-branded-nav-with-lighter-page-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(185)`, or look up `application-ui-application-shells-stacked-07-branded-nav-with-lighter-page-header` with
...
- The registry resolves both block id `185` and slug `application-ui-application-shells-stacked-07-branded-nav-with-lighter-page-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-07-branded-nav-with-lighter-page-header` story proves the fixture in both renderers.
