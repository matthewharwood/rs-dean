...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-28f13c987e42ce2edb6222e7ba3d2459

Catalog path: Application UI / lists / Stacked Lists / variant 7 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-07-two-columns-with-links` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `252` and `application-ui-lists-stacked-lists-07-two-columns-with-links` are the stable registry identity.
...
- Resolve `BlockId::from_index(252)`, or look up `application-ui-lists-stacked-lists-07-two-columns-with-links` with
...
- The registry resolves both block id `252` and slug `application-ui-lists-stacked-lists-07-two-columns-with-links` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-07-two-columns-with-links` story proves the fixture in both renderers.
