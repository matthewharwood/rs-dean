...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/shopping-carts#component-28f287f64aac61d7f6dbc24f6311d975

Catalog path: Ecommerce / components / Shopping Carts / variant 3 of 6

## TPM Outcome

Ship `ecommerce-components-shopping-carts-03-with-extended-summary` as a registered Rust-first block in the Shopping Carts family. Preserve
...
- Block index `567` and `ecommerce-components-shopping-carts-03-with-extended-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(567)`, or look up `ecommerce-components-shopping-carts-03-with-extended-summary` with
...
- The registry resolves both block id `567` and slug `ecommerce-components-shopping-carts-03-with-extended-summary` one-to-one.
...
- An isolated `block-ecommerce-components-shopping-carts-03-with-extended-summary` story proves the fixture in both renderers.
