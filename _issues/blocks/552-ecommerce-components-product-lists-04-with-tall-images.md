...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-f0541d3d493c2571c74e2c37507722c5

Catalog path: Ecommerce / components / Product Lists / variant 4 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-04-with-tall-images` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `551` and `ecommerce-components-product-lists-04-with-tall-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(551)`, or look up `ecommerce-components-product-lists-04-with-tall-images` with
...
- The registry resolves both block id `551` and slug `ecommerce-components-product-lists-04-with-tall-images` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-04-with-tall-images` story proves the fixture in both renderers.
