...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-1ea7e52a3e89a3cf7b4a0a4fd2dcdf84

Catalog path: Marketing / sections / Team Sections / variant 1 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-01-with-small-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `97` and `marketing-sections-team-sections-01-with-small-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(97)`, or look up `marketing-sections-team-sections-01-with-small-images` with
...
- The registry resolves both block id `97` and slug `marketing-sections-team-sections-01-with-small-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-01-with-small-images` story proves the fixture in both renderers.
