...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-3b5e12493074827bcd9d77db75787d78

Catalog path: Marketing / elements / Headers / variant 8 of 11

## TPM Outcome

Ship `marketing-elements-headers-08-with-icons-in-mobile-menu` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `140` and `marketing-elements-headers-08-with-icons-in-mobile-menu` are the stable registry identity.
...
- Resolve `BlockId::from_index(140)`, or look up `marketing-elements-headers-08-with-icons-in-mobile-menu` with
...
- The registry resolves both block id `140` and slug `marketing-elements-headers-08-with-icons-in-mobile-menu` one-to-one.
...
- An isolated `block-marketing-elements-headers-08-with-icons-in-mobile-menu` story proves the fixture in both renderers.
