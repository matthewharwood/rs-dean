...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/select-menus#component-8298198b136afab3bb19391ae716077f

Catalog path: Application UI / forms / Select Menus / variant 2 of 7

## TPM Outcome

Ship `application-ui-forms-select-menus-02-simple-custom` as a registered Rust-first block in the Select Menus family. Preserve
...
- Block index `316` and `application-ui-forms-select-menus-02-simple-custom` are the stable registry identity.
...
- Resolve `BlockId::from_index(316)`, or look up `application-ui-forms-select-menus-02-simple-custom` with
...
- The registry resolves both block id `316` and slug `application-ui-forms-select-menus-02-simple-custom` one-to-one.
...
- An isolated `block-application-ui-forms-select-menus-02-simple-custom` story proves the fixture in both renderers.
