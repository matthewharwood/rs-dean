...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-7654075f650c9f1044bfcf1b1b6ffd77

Catalog path: Application UI / headings / Page Headings / variant 3 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-03-with-meta-and-actions` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `204` and `application-ui-headings-page-headings-03-with-meta-and-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(204)`, or look up `application-ui-headings-page-headings-03-with-meta-and-actions` with
...
- The registry resolves both block id `204` and slug `application-ui-headings-page-headings-03-with-meta-and-actions` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-03-with-meta-and-actions` story proves the fixture in both renderers.
