...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-f5f5e837510e2b4f46325e58ee1c37f9

Catalog path: Marketing / sections / Team Sections / variant 9 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-09-with-medium-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `105` and `marketing-sections-team-sections-09-with-medium-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(105)`, or look up `marketing-sections-team-sections-09-with-medium-images` with
...
- The registry resolves both block id `105` and slug `marketing-sections-team-sections-09-with-medium-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-09-with-medium-images` story proves the fixture in both renderers.
