...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-91a802d0d690e1fab88003f4fe449f0b

Catalog path: Application UI / overlays / Modal Dialogs / variant 6 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-06-simple-alert-with-left-aligned-buttons` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `435` and `application-ui-overlays-modal-dialogs-06-simple-alert-with-left-aligned-buttons` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Plain`, and `Overlay`
...
- Resolve `BlockId::from_index(435)`, or look up `application-ui-overlays-modal-dialogs-06-simple-alert-with-left-aligned-buttons` with
...
- The registry resolves both block id `435` and slug `application-ui-overlays-modal-dialogs-06-simple-alert-with-left-aligned-buttons` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-06-simple-alert-with-left-aligned-buttons` story proves the fixture in both renderers.
