...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-9df8d30b1ea52307e8d5fd15a87a3a4c

Catalog path: Marketing / sections / Stats / variant 7 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-07-with-two-column-description` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `73` and `marketing-sections-stats-sections-07-with-two-column-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(73)`, or look up `marketing-sections-stats-sections-07-with-two-column-description` with
...
- The registry resolves both block id `73` and slug `marketing-sections-stats-sections-07-with-two-column-description` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-07-with-two-column-description` story proves the fixture in both renderers.
