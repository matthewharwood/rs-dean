...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-d7236fb2b65d5508f47ef24394c037fe

Catalog path: Application UI / elements / Badges / variant 7 of 16

## TPM Outcome

Ship `application-ui-elements-badges-07-flat-pill` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `471` and `application-ui-elements-badges-07-flat-pill` are the stable registry identity.
...
- Resolve `BlockId::from_index(471)`, or look up `application-ui-elements-badges-07-flat-pill` with
...
- The registry resolves both block id `471` and slug `application-ui-elements-badges-07-flat-pill` one-to-one.
...
- An isolated `block-application-ui-elements-badges-07-flat-pill` story proves the fixture in both renderers.
