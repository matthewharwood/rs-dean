...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/alerts#component-bfa7bc8484740ff2b3dfabe5fd318b25

Catalog path: Application UI / feedback / Alerts / variant 2 of 6

## TPM Outcome

Ship `application-ui-feedback-alerts-02-with-list` as a registered Rust-first block in the Alerts family. Preserve
...
- Block index `365` and `application-ui-feedback-alerts-02-with-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(365)`, or look up `application-ui-feedback-alerts-02-with-list` with
...
- The registry resolves both block id `365` and slug `application-ui-feedback-alerts-02-with-list` one-to-one.
...
- An isolated `block-application-ui-feedback-alerts-02-with-list` story proves the fixture in both renderers.
