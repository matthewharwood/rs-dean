...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/stacked#component-1d5f829319b725c8aeb53f6758123765

Catalog path: Application UI / application-shells / Stacked Layouts / variant 8 of 9

## TPM Outcome

Ship `application-ui-application-shells-stacked-08-with-compact-lighter-page-header` as a registered Rust-first block in the Stacked Layouts family. Preserve
...
- Block index `186` and `application-ui-application-shells-stacked-08-with-compact-lighter-page-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(186)`, or look up `application-ui-application-shells-stacked-08-with-compact-lighter-page-header` with
...
- The registry resolves both block id `186` and slug `application-ui-application-shells-stacked-08-with-compact-lighter-page-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-stacked-08-with-compact-lighter-page-header` story proves the fixture in both renderers.
