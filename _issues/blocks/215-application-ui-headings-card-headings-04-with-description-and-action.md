...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-c8f5fb604fcc6cf6614aab0bfec6a3f2

Catalog path: Application UI / headings / Card Headings / variant 4 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-04-with-description-and-action` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `214` and `application-ui-headings-card-headings-04-with-description-and-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(214)`, or look up `application-ui-headings-card-headings-04-with-description-and-action` with
...
- The registry resolves both block id `214` and slug `application-ui-headings-card-headings-04-with-description-and-action` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-04-with-description-and-action` story proves the fixture in both renderers.
