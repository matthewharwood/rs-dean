...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-2652f5fb050435ca8d767d15a5800198

Catalog path: Marketing / sections / Hero Sections / variant 3 of 12

## TPM Outcome

Ship `marketing-sections-heroes-03-split-with-bordered-screenshot` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Apply the typed `Screenshot` media mode, `Bordered` surface treatment, and
...
- Block index `2` and `marketing-sections-heroes-03-split-with-bordered-screenshot` are the stable registry identity.
...
- Variant behavior is constrained by `Screenshot`, `Bordered`, and `Actions`
...
- Resolve `BlockId::from_index(2)`, or look up `marketing-sections-heroes-03-split-with-bordered-screenshot` with
...
- The registry resolves both block id `2` and slug `marketing-sections-heroes-03-split-with-bordered-screenshot` one-to-one.
...
- An isolated `block-marketing-sections-heroes-03-split-with-bordered-screenshot` story proves the fixture in both renderers.
