...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/pricing-pages#component-26a51e8206f93553482c120828f05656

Catalog path: Marketing / page-examples / Pricing Pages / variant 3 of 3

## TPM Outcome

Ship `marketing-page-examples-pricing-pages-03-with-three-tiers-and-testimonials` as a registered Rust-first block in the Pricing Pages family. Preserve
...
- Block index `175` and `marketing-page-examples-pricing-pages-03-with-three-tiers-and-testimonials` are the stable registry identity.
...
- Resolve `BlockId::from_index(175)`, or look up `marketing-page-examples-pricing-pages-03-with-three-tiers-and-testimonials` with
...
- The registry resolves both block id `175` and slug `marketing-page-examples-pricing-pages-03-with-three-tiers-and-testimonials` one-to-one.
...
- An isolated `block-marketing-page-examples-pricing-pages-03-with-three-tiers-and-testimonials` story proves the fixture in both renderers.
