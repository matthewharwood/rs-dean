...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-eb23a02668400de1e5da7fcb3137793c

Catalog path: Application UI / overlays / Drawers / variant 9 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-09-user-profile-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `444` and `application-ui-overlays-drawers-09-user-profile-example` are the stable registry identity.
...
- Resolve `BlockId::from_index(444)`, or look up `application-ui-overlays-drawers-09-user-profile-example` with
...
- The registry resolves both block id `444` and slug `application-ui-overlays-drawers-09-user-profile-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-09-user-profile-example` story proves the fixture in both renderers.
