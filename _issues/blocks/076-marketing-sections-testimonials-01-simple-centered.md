...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-fd7b8bd425f42f6504b22e1ecc6b43c9

Catalog path: Marketing / sections / Testimonials / variant 1 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-01-simple-centered` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `75` and `marketing-sections-testimonials-01-simple-centered` are the stable registry identity.
...
- Resolve `BlockId::from_index(75)`, or look up `marketing-sections-testimonials-01-simple-centered` with
...
- The registry resolves both block id `75` and slug `marketing-sections-testimonials-01-simple-centered` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-01-simple-centered` story proves the fixture in both renderers.
