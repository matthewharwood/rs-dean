...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/navbars#component-8731614251ceaa0fa262087124b3283b

Catalog path: Application UI / navigation / Navbars / variant 10 of 11

## TPM Outcome

Ship `application-ui-navigation-navbars-10-with-centered-search-and-secondary-links` as a registered Rust-first block in the Navbars family. Preserve
...
- Block index `385` and `application-ui-navigation-navbars-10-with-centered-search-and-secondary-links` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Plain`, and `Search`
...
- Resolve `BlockId::from_index(385)`, or look up `application-ui-navigation-navbars-10-with-centered-search-and-secondary-links` with
...
- The registry resolves both block id `385` and slug `application-ui-navigation-navbars-10-with-centered-search-and-secondary-links` one-to-one.
...
- An isolated `block-application-ui-navigation-navbars-10-with-centered-search-and-secondary-links` story proves the fixture in both renderers.
