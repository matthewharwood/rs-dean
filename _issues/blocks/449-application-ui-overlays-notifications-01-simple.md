...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/notifications#component-a065edf8f08a35f06943b2e266ca9af1

Catalog path: Application UI / overlays / Notifications / variant 1 of 6

## TPM Outcome

Ship `application-ui-overlays-notifications-01-simple` as a registered Rust-first block in the Notifications family. Preserve
...
- Block index `448` and `application-ui-overlays-notifications-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(448)`, or look up `application-ui-overlays-notifications-01-simple` with
...
- The registry resolves both block id `448` and slug `application-ui-overlays-notifications-01-simple` one-to-one.
...
- An isolated `block-application-ui-overlays-notifications-01-simple` story proves the fixture in both renderers.
