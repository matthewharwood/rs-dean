...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-fc28f4a447bdc2cd52811b9888bc5118

Catalog path: Application UI / overlays / Drawers / variant 12 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-12-file-details-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `447` and `application-ui-overlays-drawers-12-file-details-example` are the stable registry identity.
...
- Resolve `BlockId::from_index(447)`, or look up `application-ui-overlays-drawers-12-file-details-example` with
...
- The registry resolves both block id `447` and slug `application-ui-overlays-drawers-12-file-details-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-12-file-details-example` story proves the fixture in both renderers.
