...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-09cfe344f8855fc64bbd7051cb8188e4

Catalog path: Ecommerce / components / Product Lists / variant 7 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-07-with-tall-images-and-cta-link` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `554` and `ecommerce-components-product-lists-07-with-tall-images-and-cta-link` are the stable registry identity.
...
- Variant behavior is constrained by `Image`, `Plain`, and `Static`
...
- Resolve `BlockId::from_index(554)`, or look up `ecommerce-components-product-lists-07-with-tall-images-and-cta-link` with
...
- The registry resolves both block id `554` and slug `ecommerce-components-product-lists-07-with-tall-images-and-cta-link` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-07-with-tall-images-and-cta-link` story proves the fixture in both renderers.
