...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/textareas#component-4dfa34096e750fe0cc9a5086286bc441

Catalog path: Application UI / forms / Textareas / variant 1 of 5

## TPM Outcome

Ship `application-ui-forms-textareas-01-simple` as a registered Rust-first block in the Textareas family. Preserve
...
- Block index `326` and `application-ui-forms-textareas-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(326)`, or look up `application-ui-forms-textareas-01-simple` with
...
- The registry resolves both block id `326` and slug `application-ui-forms-textareas-01-simple` one-to-one.
...
- An isolated `block-application-ui-forms-textareas-01-simple` story proves the fixture in both renderers.
