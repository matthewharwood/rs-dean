...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-3de290cc969415f170748791a9d263a6

Catalog path: Application UI / lists / Tables / variant 1 of 19

## TPM Outcome

Ship `application-ui-lists-tables-01-simple` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `261` and `application-ui-lists-tables-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(261)`, or look up `application-ui-lists-tables-01-simple` with
...
- The registry resolves both block id `261` and slug `application-ui-lists-tables-01-simple` one-to-one.
...
- An isolated `block-application-ui-lists-tables-01-simple` story proves the fixture in both renderers.
