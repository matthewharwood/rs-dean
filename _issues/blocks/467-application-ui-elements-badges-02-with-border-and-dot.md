...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-007ef3476f2ffe8bda7f37965d6ee434

Catalog path: Application UI / elements / Badges / variant 2 of 16

## TPM Outcome

Ship `application-ui-elements-badges-02-with-border-and-dot` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `466` and `application-ui-elements-badges-02-with-border-and-dot` are the stable registry identity.
...
- Resolve `BlockId::from_index(466)`, or look up `application-ui-elements-badges-02-with-border-and-dot` with
...
- The registry resolves both block id `466` and slug `application-ui-elements-badges-02-with-border-and-dot` one-to-one.
...
- An isolated `block-application-ui-elements-badges-02-with-border-and-dot` story proves the fixture in both renderers.
