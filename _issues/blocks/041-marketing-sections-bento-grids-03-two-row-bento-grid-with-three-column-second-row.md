...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/bento-grids#component-bd485a396268b63d0ef7d0cf7988a594

Catalog path: Marketing / sections / Bento Grids / variant 3 of 3

## TPM Outcome

Ship `marketing-sections-bento-grids-03-two-row-bento-grid-with-three-column-second-row` as a registered Rust-first block in the Bento Grids family. Preserve
the source block's Bento composition intent while using original fixture
...
- Block index `40` and `marketing-sections-bento-grids-03-two-row-bento-grid-with-three-column-second-row` are the stable registry identity.
...
- The family maps to the `Bento` composition pattern and the `Card`
...
- Resolve `BlockId::from_index(40)`, or look up `marketing-sections-bento-grids-03-two-row-bento-grid-with-three-column-second-row` with
...
- The registry resolves both block id `40` and slug `marketing-sections-bento-grids-03-two-row-bento-grid-with-three-column-second-row` one-to-one.
...
- An isolated `block-marketing-sections-bento-grids-03-two-row-bento-grid-with-three-column-second-row` story proves the fixture in both renderers.
