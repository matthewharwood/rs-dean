...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-b88d7fac50000088285c185aba85b81a

Catalog path: Marketing / sections / Hero Sections / variant 9 of 12

## TPM Outcome

Ship `marketing-sections-heroes-09-split-with-image` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `8` and `marketing-sections-heroes-09-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(8)`, or look up `marketing-sections-heroes-09-split-with-image` with
...
- The registry resolves both block id `8` and slug `marketing-sections-heroes-09-split-with-image` one-to-one.
...
- An isolated `block-marketing-sections-heroes-09-split-with-image` story proves the fixture in both renderers.
