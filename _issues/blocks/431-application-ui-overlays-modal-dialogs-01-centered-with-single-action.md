...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-9a0cb3f6ddde116e8cc6d018e4852dfd

Catalog path: Application UI / overlays / Modal Dialogs / variant 1 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-01-centered-with-single-action` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `430` and `application-ui-overlays-modal-dialogs-01-centered-with-single-action` are the stable registry identity.
...
- Resolve `BlockId::from_index(430)`, or look up `application-ui-overlays-modal-dialogs-01-centered-with-single-action` with
...
- The registry resolves both block id `430` and slug `application-ui-overlays-modal-dialogs-01-centered-with-single-action` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-01-centered-with-single-action` story proves the fixture in both renderers.
