...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/blog-sections#component-71451303bfa569c95e0f084e67da54f2

Catalog path: Marketing / sections / Blog Sections / variant 4 of 7

## TPM Outcome

Ship `marketing-sections-blog-sections-04-single-column` as a registered Rust-first block in the Blog Sections family. Preserve
...
- Block index `86` and `marketing-sections-blog-sections-04-single-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(86)`, or look up `marketing-sections-blog-sections-04-single-column` with
...
- The registry resolves both block id `86` and slug `marketing-sections-blog-sections-04-single-column` one-to-one.
...
- An isolated `block-marketing-sections-blog-sections-04-single-column` story proves the fixture in both renderers.
