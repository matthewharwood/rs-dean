...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/logo-clouds#component-0b335b8d706c7e91f42206937f0f240c

Catalog path: Marketing / sections / Logo Clouds / variant 3 of 6

## TPM Outcome

Ship `marketing-sections-logo-clouds-03-simple-left-aligned` as a registered Rust-first block in the Logo Clouds family. Preserve
...
- Block index `115` and `marketing-sections-logo-clouds-03-simple-left-aligned` are the stable registry identity.
...
- Resolve `BlockId::from_index(115)`, or look up `marketing-sections-logo-clouds-03-simple-left-aligned` with
...
- The registry resolves both block id `115` and slug `marketing-sections-logo-clouds-03-simple-left-aligned` one-to-one.
...
- An isolated `block-marketing-sections-logo-clouds-03-simple-left-aligned` story proves the fixture in both renderers.
