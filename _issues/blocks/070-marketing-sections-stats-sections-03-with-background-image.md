...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/stats-sections#component-be9be745d8c91cbf74f7f1ea40c45840

Catalog path: Marketing / sections / Stats / variant 3 of 8

## TPM Outcome

Ship `marketing-sections-stats-sections-03-with-background-image` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `69` and `marketing-sections-stats-sections-03-with-background-image` are the stable registry identity.
...
- The family maps to the `Metrics` composition pattern and the `Chart`
...
- Resolve `BlockId::from_index(69)`, or look up `marketing-sections-stats-sections-03-with-background-image` with
...
- The registry resolves both block id `69` and slug `marketing-sections-stats-sections-03-with-background-image` one-to-one.
...
- An isolated `block-marketing-sections-stats-sections-03-with-background-image` story proves the fixture in both renderers.
