...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-1b775efa377ced9b70b1e691316e7ea1

Catalog path: Ecommerce / components / Promo Sections / variant 1 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-01-with-fading-background-image-and-testimonials` as a registered Rust-first block in the Promo Sections family. Preserve
the source block's Three column composition intent while using original fixture
...
- Use the shared Section -> Container -> Grid/GridItem -> Stack/Cluster box
  model with the `Three column` preset.
...
- Block index `594` and `ecommerce-components-promo-sections-01-with-fading-background-image-and-testimonials` are the stable registry identity.
...
- Resolve `BlockId::from_index(594)`, or look up `ecommerce-components-promo-sections-01-with-fading-background-image-and-testimonials` with
...
- The registry resolves both block id `594` and slug `ecommerce-components-promo-sections-01-with-fading-background-image-and-testimonials` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-01-with-fading-background-image-and-testimonials` story proves the fixture in both renderers.
