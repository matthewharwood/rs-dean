...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-eb6b38e5a758ade067d50aae93fa1b96

Catalog path: Application UI / forms / Radio Groups / variant 9 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-09-color-picker` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `339` and `application-ui-forms-radio-groups-09-color-picker` are the stable registry identity.
...
- Resolve `BlockId::from_index(339)`, or look up `application-ui-forms-radio-groups-09-color-picker` with
...
- The registry resolves both block id `339` and slug `application-ui-forms-radio-groups-09-color-picker` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-09-color-picker` story proves the fixture in both renderers.
