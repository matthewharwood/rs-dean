...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-summaries#component-3f2fd7d36b5d2464a445dbbc7233d644

Catalog path: Ecommerce / components / Order Summaries / variant 4 of 4

## TPM Outcome

Ship `ecommerce-components-order-summaries-04-simple-with-full-order-details` as a registered Rust-first block in the Order Summaries family. Preserve
...
- Block index `614` and `ecommerce-components-order-summaries-04-simple-with-full-order-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(614)`, or look up `ecommerce-components-order-summaries-04-simple-with-full-order-details` with
...
- The registry resolves both block id `614` and slug `ecommerce-components-order-summaries-04-simple-with-full-order-details` one-to-one.
...
- An isolated `block-ecommerce-components-order-summaries-04-simple-with-full-order-details` story proves the fixture in both renderers.
