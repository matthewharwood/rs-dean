...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/product-pages#component-cb29ca8a047a5351c6b339cef1b952a7

Catalog path: Ecommerce / page-examples / Product Pages / variant 4 of 5

## TPM Outcome

Ship `ecommerce-page-examples-product-pages-04-with-featured-details` as a registered Rust-first block in the Product Pages family. Preserve
...
- Block index `634` and `ecommerce-page-examples-product-pages-04-with-featured-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(634)`, or look up `ecommerce-page-examples-product-pages-04-with-featured-details` with
...
- The registry resolves both block id `634` and slug `ecommerce-page-examples-product-pages-04-with-featured-details` one-to-one.
...
- An isolated `block-ecommerce-page-examples-product-pages-04-with-featured-details` story proves the fixture in both renderers.
