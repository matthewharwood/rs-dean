...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-8ea0a1bf2b3c2b1d7fc86019674bb55a

Catalog path: Application UI / navigation / Tabs / variant 9 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-09-simple` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `398` and `application-ui-navigation-tabs-09-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(398)`, or look up `application-ui-navigation-tabs-09-simple` with
...
- The registry resolves both block id `398` and slug `application-ui-navigation-tabs-09-simple` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-09-simple` story proves the fixture in both renderers.
