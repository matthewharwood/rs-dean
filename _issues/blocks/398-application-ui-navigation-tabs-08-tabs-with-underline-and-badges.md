...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-70db4dcecc9b8bad86b28ebe23546f27

Catalog path: Application UI / navigation / Tabs / variant 8 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-08-tabs-with-underline-and-badges` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `397` and `application-ui-navigation-tabs-08-tabs-with-underline-and-badges` are the stable registry identity.
...
- Resolve `BlockId::from_index(397)`, or look up `application-ui-navigation-tabs-08-tabs-with-underline-and-badges` with
...
- The registry resolves both block id `397` and slug `application-ui-navigation-tabs-08-tabs-with-underline-and-badges` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-08-tabs-with-underline-and-badges` story proves the fixture in both renderers.
