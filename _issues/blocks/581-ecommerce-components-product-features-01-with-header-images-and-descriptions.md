...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-05950fd10036c215016759b6abdd154e

Catalog path: Ecommerce / components / Product Features / variant 1 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-01-with-header-images-and-descriptions` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `580` and `ecommerce-components-product-features-01-with-header-images-and-descriptions` are the stable registry identity.
...
- Resolve `BlockId::from_index(580)`, or look up `ecommerce-components-product-features-01-with-header-images-and-descriptions` with
...
- The registry resolves both block id `580` and slug `ecommerce-components-product-features-01-with-header-images-and-descriptions` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-01-with-header-images-and-descriptions` story proves the fixture in both renderers.
