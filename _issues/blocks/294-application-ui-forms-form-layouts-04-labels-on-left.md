...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/form-layouts#component-cc5bee94bc88387c2511b0e5c3dfffef

Catalog path: Application UI / forms / Form Layouts / variant 4 of 4

## TPM Outcome

Ship `application-ui-forms-form-layouts-04-labels-on-left` as a registered Rust-first block in the Form Layouts family. Preserve
...
- Block index `293` and `application-ui-forms-form-layouts-04-labels-on-left` are the stable registry identity.
...
- Resolve `BlockId::from_index(293)`, or look up `application-ui-forms-form-layouts-04-labels-on-left` with
...
- The registry resolves both block id `293` and slug `application-ui-forms-form-layouts-04-labels-on-left` one-to-one.
...
- An isolated `block-application-ui-forms-form-layouts-04-labels-on-left` story proves the fixture in both renderers.
