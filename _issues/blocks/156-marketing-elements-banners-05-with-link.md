...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-1ad095c7782d609a536ebf3cd9b7212e

Catalog path: Marketing / elements / Banners / variant 5 of 13

## TPM Outcome

Ship `marketing-elements-banners-05-with-link` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `155` and `marketing-elements-banners-05-with-link` are the stable registry identity.
...
- Resolve `BlockId::from_index(155)`, or look up `marketing-elements-banners-05-with-link` with
...
- The registry resolves both block id `155` and slug `marketing-elements-banners-05-with-link` one-to-one.
...
- An isolated `block-marketing-elements-banners-05-with-link` story proves the fixture in both renderers.
