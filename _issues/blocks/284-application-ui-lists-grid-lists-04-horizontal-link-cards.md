...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-08e8555b844010db1f30cbafc8be6222

Catalog path: Application UI / lists / Grid Lists / variant 4 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-04-horizontal-link-cards` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `283` and `application-ui-lists-grid-lists-04-horizontal-link-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(283)`, or look up `application-ui-lists-grid-lists-04-horizontal-link-cards` with
...
- The registry resolves both block id `283` and slug `application-ui-lists-grid-lists-04-horizontal-link-cards` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-04-horizontal-link-cards` story proves the fixture in both renderers.
