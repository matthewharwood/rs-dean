...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-7b583a008c3fc62c0fe403d10ca042bb

Catalog path: Application UI / forms / Radio Groups / variant 8 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-08-list-with-descriptions-in-panel` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `338` and `application-ui-forms-radio-groups-08-list-with-descriptions-in-panel` are the stable registry identity.
...
- Resolve `BlockId::from_index(338)`, or look up `application-ui-forms-radio-groups-08-list-with-descriptions-in-panel` with
...
- The registry resolves both block id `338` and slug `application-ui-forms-radio-groups-08-list-with-descriptions-in-panel` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-08-list-with-descriptions-in-panel` story proves the fixture in both renderers.
