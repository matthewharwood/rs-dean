...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-e101ace281ff682c4b9f7ecee3a6f5d3

Catalog path: Application UI / lists / Tables / variant 19 of 19

## TPM Outcome

Ship `application-ui-lists-tables-19-full-width-with-avatars` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `279` and `application-ui-lists-tables-19-full-width-with-avatars` are the stable registry identity.
...
- Resolve `BlockId::from_index(279)`, or look up `application-ui-lists-tables-19-full-width-with-avatars` with
...
- The registry resolves both block id `279` and slug `application-ui-lists-tables-19-full-width-with-avatars` one-to-one.
...
- An isolated `block-application-ui-lists-tables-19-full-width-with-avatars` story proves the fixture in both renderers.
