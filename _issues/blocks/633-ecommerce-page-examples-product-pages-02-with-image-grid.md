...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/product-pages#component-58c5a63f9bbdf010b2ba46bb3d500cbb

Catalog path: Ecommerce / page-examples / Product Pages / variant 2 of 5

## TPM Outcome

Ship `ecommerce-page-examples-product-pages-02-with-image-grid` as a registered Rust-first block in the Product Pages family. Preserve
...
- Block index `632` and `ecommerce-page-examples-product-pages-02-with-image-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(632)`, or look up `ecommerce-page-examples-product-pages-02-with-image-grid` with
...
- The registry resolves both block id `632` and slug `ecommerce-page-examples-product-pages-02-with-image-grid` one-to-one.
...
- An isolated `block-ecommerce-page-examples-product-pages-02-with-image-grid` story proves the fixture in both renderers.
