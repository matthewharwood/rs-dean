...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-245cb777f4a9823e97d8b1c2dfb87e0c

Catalog path: Application UI / forms / Radio Groups / variant 11 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-11-small-cards` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `341` and `application-ui-forms-radio-groups-11-small-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(341)`, or look up `application-ui-forms-radio-groups-11-small-cards` with
...
- The registry resolves both block id `341` and slug `application-ui-forms-radio-groups-11-small-cards` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-11-small-cards` story proves the fixture in both renderers.
