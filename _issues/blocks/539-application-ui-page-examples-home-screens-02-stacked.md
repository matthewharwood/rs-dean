...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/page-examples/home-screens#component-03fc6b9c0ebbb5609e996305274d9b95

Catalog path: Application UI / page-examples / Home Screens / variant 2 of 2

## TPM Outcome

Ship `application-ui-page-examples-home-screens-02-stacked` as a registered Rust-first block in the Home Screens family. Preserve
...
- Block index `538` and `application-ui-page-examples-home-screens-02-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(538)`, or look up `application-ui-page-examples-home-screens-02-stacked` with
...
- The registry resolves both block id `538` and slug `application-ui-page-examples-home-screens-02-stacked` one-to-one.
...
- An isolated `block-application-ui-page-examples-home-screens-02-stacked` story proves the fixture in both renderers.
