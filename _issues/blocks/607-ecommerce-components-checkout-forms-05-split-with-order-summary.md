...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/checkout-forms#component-4039d61d0f282837bdeab6864eb41a0a

Catalog path: Ecommerce / components / Checkout Forms / variant 5 of 5

## TPM Outcome

Ship `ecommerce-components-checkout-forms-05-split-with-order-summary` as a registered Rust-first block in the Checkout Forms family. Preserve
...
- Block index `606` and `ecommerce-components-checkout-forms-05-split-with-order-summary` are the stable registry identity.
...
- Resolve `BlockId::from_index(606)`, or look up `ecommerce-components-checkout-forms-05-split-with-order-summary` with
...
- The registry resolves both block id `606` and slug `ecommerce-components-checkout-forms-05-split-with-order-summary` one-to-one.
...
- An isolated `block-ecommerce-components-checkout-forms-05-split-with-order-summary` story proves the fixture in both renderers.
