...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-5a30657598f3154f9bc03a680cea7ff4

Catalog path: Application UI / forms / Radio Groups / variant 3 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-03-list-with-description` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `333` and `application-ui-forms-radio-groups-03-list-with-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(333)`, or look up `application-ui-forms-radio-groups-03-list-with-description` with
...
- The registry resolves both block id `333` and slug `application-ui-forms-radio-groups-03-list-with-description` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-03-list-with-description` story proves the fixture in both renderers.
