...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-69fd3cc3634e02f74717c1046d51aa76

Catalog path: Application UI / navigation / Command Palettes / variant 6 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-06-semi-transparent-with-icons` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `427` and `application-ui-navigation-command-palettes-06-semi-transparent-with-icons` are the stable registry identity.
...
- The family maps to the `Menu` composition pattern and the `Command`
  primary UI component.
- Variant behavior is constrained by `Icon`, `Plain`, and `Menu`
...
- Resolve `BlockId::from_index(427)`, or look up `application-ui-navigation-command-palettes-06-semi-transparent-with-icons` with
...
- The registry resolves both block id `427` and slug `application-ui-navigation-command-palettes-06-semi-transparent-with-icons` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-06-semi-transparent-with-icons` story proves the fixture in both renderers.
