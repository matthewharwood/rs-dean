...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-cea1008f50f1be6ef8487094592cde62

Catalog path: Application UI / lists / Tables / variant 18 of 19

## TPM Outcome

Ship `application-ui-lists-tables-18-with-hidden-headings` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `278` and `application-ui-lists-tables-18-with-hidden-headings` are the stable registry identity.
...
- Resolve `BlockId::from_index(278)`, or look up `application-ui-lists-tables-18-with-hidden-headings` with
...
- The registry resolves both block id `278` and slug `application-ui-lists-tables-18-with-hidden-headings` one-to-one.
...
- An isolated `block-application-ui-lists-tables-18-with-hidden-headings` story proves the fixture in both renderers.
