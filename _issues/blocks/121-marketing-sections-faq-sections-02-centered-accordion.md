...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-8699d80b13ef524eb573e54b4d4b89d1

Catalog path: Marketing / sections / FAQs / variant 2 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-02-centered-accordion` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `120` and `marketing-sections-faq-sections-02-centered-accordion` are the stable registry identity.
...
- Resolve `BlockId::from_index(120)`, or look up `marketing-sections-faq-sections-02-centered-accordion` with
...
- The registry resolves both block id `120` and slug `marketing-sections-faq-sections-02-centered-accordion` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-02-centered-accordion` story proves the fixture in both renderers.
