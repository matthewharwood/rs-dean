...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/breadcrumbs#component-7dc6ffff20237868ddf0e7d21cf17cf1

Catalog path: Application UI / navigation / Breadcrumbs / variant 3 of 4

## TPM Outcome

Ship `application-ui-navigation-breadcrumbs-03-simple-with-chevrons` as a registered Rust-first block in the Breadcrumbs family. Preserve
...
- Block index `412` and `application-ui-navigation-breadcrumbs-03-simple-with-chevrons` are the stable registry identity.
...
- Resolve `BlockId::from_index(412)`, or look up `application-ui-navigation-breadcrumbs-03-simple-with-chevrons` with
...
- The registry resolves both block id `412` and slug `application-ui-navigation-breadcrumbs-03-simple-with-chevrons` one-to-one.
...
- An isolated `block-application-ui-navigation-breadcrumbs-03-simple-with-chevrons` story proves the fixture in both renderers.
