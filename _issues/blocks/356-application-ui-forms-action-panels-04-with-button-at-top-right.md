...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-9710edede7633db7eb6fddb27fd13a24

Catalog path: Application UI / forms / Action Panels / variant 4 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-04-with-button-at-top-right` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `355` and `application-ui-forms-action-panels-04-with-button-at-top-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(355)`, or look up `application-ui-forms-action-panels-04-with-button-at-top-right` with
...
- The registry resolves both block id `355` and slug `application-ui-forms-action-panels-04-with-button-at-top-right` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-04-with-button-at-top-right` story proves the fixture in both renderers.
