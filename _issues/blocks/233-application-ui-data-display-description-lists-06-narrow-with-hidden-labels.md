...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-abf967b89e0df5cf9648be5a30d7660e

Catalog path: Application UI / data-display / Description Lists / variant 6 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-06-narrow-with-hidden-labels` as a registered Rust-first block in the Description Lists family. Preserve
the source block's Centered narrow composition intent while using original fixture
...
- Use the shared Section -> Container -> Grid/GridItem -> Stack/Cluster box
  model with the `Centered narrow` preset.
...
- Block index `232` and `application-ui-data-display-description-lists-06-narrow-with-hidden-labels` are the stable registry identity.
...
- Resolve `BlockId::from_index(232)`, or look up `application-ui-data-display-description-lists-06-narrow-with-hidden-labels` with
...
- The registry resolves both block id `232` and slug `application-ui-data-display-description-lists-06-narrow-with-hidden-labels` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-06-narrow-with-hidden-labels` story proves the fixture in both renderers.
