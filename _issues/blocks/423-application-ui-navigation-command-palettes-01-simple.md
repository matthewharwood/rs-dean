...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-3b1e5d9bec70736c7d1afca2585ec39e

Catalog path: Application UI / navigation / Command Palettes / variant 1 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-01-simple` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `422` and `application-ui-navigation-command-palettes-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(422)`, or look up `application-ui-navigation-command-palettes-01-simple` with
...
- The registry resolves both block id `422` and slug `application-ui-navigation-command-palettes-01-simple` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-01-simple` story proves the fixture in both renderers.
