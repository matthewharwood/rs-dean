...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-4badbd2bd958eef33e7bfe7cefc685f3

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 3 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-03-constrained-three-column` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
...
- Block index `198` and `application-ui-application-shells-multi-column-03-constrained-three-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(198)`, or look up `application-ui-application-shells-multi-column-03-constrained-three-column` with
...
- The registry resolves both block id `198` and slug `application-ui-application-shells-multi-column-03-constrained-three-column` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-03-constrained-three-column` story proves the fixture in both renderers.
