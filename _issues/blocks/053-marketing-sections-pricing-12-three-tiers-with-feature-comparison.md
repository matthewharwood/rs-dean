...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-e9f364b6930367858d888a1d51d39c55

Catalog path: Marketing / sections / Pricing Sections / variant 12 of 12

## TPM Outcome

Ship `marketing-sections-pricing-12-three-tiers-with-feature-comparison` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `52` and `marketing-sections-pricing-12-three-tiers-with-feature-comparison` are the stable registry identity.
...
- Resolve `BlockId::from_index(52)`, or look up `marketing-sections-pricing-12-three-tiers-with-feature-comparison` with
...
- The registry resolves both block id `52` and slug `marketing-sections-pricing-12-three-tiers-with-feature-comparison` one-to-one.
...
- An isolated `block-marketing-sections-pricing-12-three-tiers-with-feature-comparison` story proves the fixture in both renderers.
