...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/landing-pages#component-77f60f231bd54e888b9a10e0f9ecab56

Catalog path: Marketing / page-examples / Landing Pages / variant 4 of 4

## TPM Outcome

Ship `marketing-page-examples-landing-pages-04-with-mobile-screenshot-and-testimonials-grid` as a registered Rust-first block in the Landing Pages family. Preserve
...
- Block index `172` and `marketing-page-examples-landing-pages-04-with-mobile-screenshot-and-testimonials-grid` are the stable registry identity.
...
- Resolve `BlockId::from_index(172)`, or look up `marketing-page-examples-landing-pages-04-with-mobile-screenshot-and-testimonials-grid` with
...
- The registry resolves both block id `172` and slug `marketing-page-examples-landing-pages-04-with-mobile-screenshot-and-testimonials-grid` one-to-one.
...
- An isolated `block-marketing-page-examples-landing-pages-04-with-mobile-screenshot-and-testimonials-grid` story proves the fixture in both renderers.
