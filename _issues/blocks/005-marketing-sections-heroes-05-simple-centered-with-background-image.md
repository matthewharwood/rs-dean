...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-d63f5b5552a3f3d936c6ab970a47899b

Catalog path: Marketing / sections / Hero Sections / variant 5 of 12

## TPM Outcome

Ship `marketing-sections-heroes-05-simple-centered-with-background-image` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `4` and `marketing-sections-heroes-05-simple-centered-with-background-image` are the stable registry identity.
...
- The family maps to the `Hero` composition pattern and the `Aspect Ratio`
...
- Resolve `BlockId::from_index(4)`, or look up `marketing-sections-heroes-05-simple-centered-with-background-image` with
...
- The registry resolves both block id `4` and slug `marketing-sections-heroes-05-simple-centered-with-background-image` one-to-one.
...
- An isolated `block-marketing-sections-heroes-05-simple-centered-with-background-image` story proves the fixture in both renderers.
