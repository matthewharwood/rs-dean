...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-e1d4fc6a75d838708b6bc1a11dd42947

Catalog path: Marketing / sections / Feature Sections / variant 5 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-05-with-product-screenshot-on-left` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `16` and `marketing-sections-feature-sections-05-with-product-screenshot-on-left` are the stable registry identity.
...
- The family maps to the `Feature` composition pattern and the `Card`
  primary UI component.
- Variant behavior is constrained by `Screenshot`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(16)`, or look up `marketing-sections-feature-sections-05-with-product-screenshot-on-left` with
...
- The registry resolves both block id `16` and slug `marketing-sections-feature-sections-05-with-product-screenshot-on-left` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-05-with-product-screenshot-on-left` story proves the fixture in both renderers.
