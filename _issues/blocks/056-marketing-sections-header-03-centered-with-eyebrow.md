...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-8f5b6d408e9691e3336cadf06a8edaf8

Catalog path: Marketing / sections / Header Sections / variant 3 of 8

## TPM Outcome

Ship `marketing-sections-header-03-centered-with-eyebrow` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `55` and `marketing-sections-header-03-centered-with-eyebrow` are the stable registry identity.
...
- Resolve `BlockId::from_index(55)`, or look up `marketing-sections-header-03-centered-with-eyebrow` with
...
- The registry resolves both block id `55` and slug `marketing-sections-header-03-centered-with-eyebrow` one-to-one.
...
- An isolated `block-marketing-sections-header-03-centered-with-eyebrow` story proves the fixture in both renderers.
