...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/reviews#component-d4fb2a774349ca5444645f8468bda069

Catalog path: Ecommerce / components / Reviews / variant 1 of 4

## TPM Outcome

Ship `ecommerce-components-reviews-01-multi-column` as a registered Rust-first block in the Reviews family. Preserve
...
- Block index `607` and `ecommerce-components-reviews-01-multi-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(607)`, or look up `ecommerce-components-reviews-01-multi-column` with
...
- The registry resolves both block id `607` and slug `ecommerce-components-reviews-01-multi-column` one-to-one.
...
- An isolated `block-ecommerce-components-reviews-01-multi-column` story proves the fixture in both renderers.
