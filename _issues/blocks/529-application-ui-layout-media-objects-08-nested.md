...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/media-objects#component-beff34693069b1bc348f2fd0b534cd3e

Catalog path: Application UI / layout / Media Objects / variant 8 of 8

## TPM Outcome

Ship `application-ui-layout-media-objects-08-nested` as a registered Rust-first block in the Media Objects family. Preserve
...
- Block index `528` and `application-ui-layout-media-objects-08-nested` are the stable registry identity.
...
- Resolve `BlockId::from_index(528)`, or look up `application-ui-layout-media-objects-08-nested` with
...
- The registry resolves both block id `528` and slug `application-ui-layout-media-objects-08-nested` one-to-one.
...
- An isolated `block-application-ui-layout-media-objects-08-nested` story proves the fixture in both renderers.
