...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-8904b9d9a9fbb9a2313df3975112f9d7

Catalog path: Marketing / elements / Banners / variant 1 of 13

## TPM Outcome

Ship `marketing-elements-banners-01-with-button` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `151` and `marketing-elements-banners-01-with-button` are the stable registry identity.
...
- Resolve `BlockId::from_index(151)`, or look up `marketing-elements-banners-01-with-button` with
...
- The registry resolves both block id `151` and slug `marketing-elements-banners-01-with-button` one-to-one.
...
- An isolated `block-marketing-elements-banners-01-with-button` story proves the fixture in both renderers.
