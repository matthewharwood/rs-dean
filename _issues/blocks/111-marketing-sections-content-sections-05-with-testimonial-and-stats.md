...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/content-sections#component-f6c39bd93fbb747d288f373cdbc039e3

Catalog path: Marketing / sections / Content Sections / variant 5 of 7

## TPM Outcome

Ship `marketing-sections-content-sections-05-with-testimonial-and-stats` as a registered Rust-first block in the Content Sections family. Preserve
...
- Block index `110` and `marketing-sections-content-sections-05-with-testimonial-and-stats` are the stable registry identity.
...
- Resolve `BlockId::from_index(110)`, or look up `marketing-sections-content-sections-05-with-testimonial-and-stats` with
...
- The registry resolves both block id `110` and slug `marketing-sections-content-sections-05-with-testimonial-and-stats` one-to-one.
...
- An isolated `block-marketing-sections-content-sections-05-with-testimonial-and-stats` story proves the fixture in both renderers.
