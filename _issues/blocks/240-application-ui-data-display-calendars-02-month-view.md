...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-c29139529079ea762f118812bbeaeb9e

Catalog path: Application UI / data-display / Calendars / variant 2 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-02-month-view` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `239` and `application-ui-data-display-calendars-02-month-view` are the stable registry identity.
...
- Resolve `BlockId::from_index(239)`, or look up `application-ui-data-display-calendars-02-month-view` with
...
- The registry resolves both block id `239` and slug `application-ui-data-display-calendars-02-month-view` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-02-month-view` story proves the fixture in both renderers.
