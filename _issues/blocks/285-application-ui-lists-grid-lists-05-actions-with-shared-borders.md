...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-a26a744b444974a4cc73cb5886b8da6a

Catalog path: Application UI / lists / Grid Lists / variant 5 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-05-actions-with-shared-borders` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `284` and `application-ui-lists-grid-lists-05-actions-with-shared-borders` are the stable registry identity.
...
- Resolve `BlockId::from_index(284)`, or look up `application-ui-lists-grid-lists-05-actions-with-shared-borders` with
...
- The registry resolves both block id `284` and slug `application-ui-lists-grid-lists-05-actions-with-shared-borders` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-05-actions-with-shared-borders` story proves the fixture in both renderers.
