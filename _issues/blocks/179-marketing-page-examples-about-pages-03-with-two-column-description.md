...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/about-pages#component-c179c6fd6c39a2670931331a8edd9491

Catalog path: Marketing / page-examples / About Pages / variant 3 of 3

## TPM Outcome

Ship `marketing-page-examples-about-pages-03-with-two-column-description` as a registered Rust-first block in the About Pages family. Preserve
...
- Block index `178` and `marketing-page-examples-about-pages-03-with-two-column-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(178)`, or look up `marketing-page-examples-about-pages-03-with-two-column-description` with
...
- The registry resolves both block id `178` and slug `marketing-page-examples-about-pages-03-with-two-column-description` one-to-one.
...
- An isolated `block-marketing-page-examples-about-pages-03-with-two-column-description` story proves the fixture in both renderers.
