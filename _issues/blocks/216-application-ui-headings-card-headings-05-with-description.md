...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/card-headings#component-db063e3ead0c9a42d8b931c920062e56

Catalog path: Application UI / headings / Card Headings / variant 5 of 6

## TPM Outcome

Ship `application-ui-headings-card-headings-05-with-description` as a registered Rust-first block in the Card Headings family. Preserve
...
- Block index `215` and `application-ui-headings-card-headings-05-with-description` are the stable registry identity.
...
- Resolve `BlockId::from_index(215)`, or look up `application-ui-headings-card-headings-05-with-description` with
...
- The registry resolves both block id `215` and slug `application-ui-headings-card-headings-05-with-description` one-to-one.
...
- An isolated `block-application-ui-headings-card-headings-05-with-description` story proves the fixture in both renderers.
