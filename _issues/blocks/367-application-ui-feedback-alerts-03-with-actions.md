...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/alerts#component-59743e93ed6676a0284e9f2ab10ac8f6

Catalog path: Application UI / feedback / Alerts / variant 3 of 6

## TPM Outcome

Ship `application-ui-feedback-alerts-03-with-actions` as a registered Rust-first block in the Alerts family. Preserve
...
- Block index `366` and `application-ui-feedback-alerts-03-with-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(366)`, or look up `application-ui-feedback-alerts-03-with-actions` with
...
- The registry resolves both block id `366` and slug `application-ui-feedback-alerts-03-with-actions` one-to-one.
...
- An isolated `block-application-ui-feedback-alerts-03-with-actions` story proves the fixture in both renderers.
