...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-dc2a594f10f2d25875943b3efc90131a

Catalog path: Marketing / sections / Feature Sections / variant 9 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-09-with-testimonial` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `20` and `marketing-sections-feature-sections-09-with-testimonial` are the stable registry identity.
...
- Resolve `BlockId::from_index(20)`, or look up `marketing-sections-feature-sections-09-with-testimonial` with
...
- The registry resolves both block id `20` and slug `marketing-sections-feature-sections-09-with-testimonial` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-09-with-testimonial` story proves the fixture in both renderers.
