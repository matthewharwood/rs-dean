...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-e34ad5d8858c895d17d28f188179594c

Catalog path: Application UI / navigation / Command Palettes / variant 5 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-05-with-icons` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `426` and `application-ui-navigation-command-palettes-05-with-icons` are the stable registry identity.
...
- Resolve `BlockId::from_index(426)`, or look up `application-ui-navigation-command-palettes-05-with-icons` with
...
- The registry resolves both block id `426` and slug `application-ui-navigation-command-palettes-05-with-icons` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-05-with-icons` story proves the fixture in both renderers.
