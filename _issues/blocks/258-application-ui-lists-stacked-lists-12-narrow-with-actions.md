...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-6a56f3c03589dfa48dc4e7eec7fbf6d0

Catalog path: Application UI / lists / Stacked Lists / variant 12 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-12-narrow-with-actions` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `257` and `application-ui-lists-stacked-lists-12-narrow-with-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(257)`, or look up `application-ui-lists-stacked-lists-12-narrow-with-actions` with
...
- The registry resolves both block id `257` and slug `application-ui-lists-stacked-lists-12-narrow-with-actions` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-12-narrow-with-actions` story proves the fixture in both renderers.
