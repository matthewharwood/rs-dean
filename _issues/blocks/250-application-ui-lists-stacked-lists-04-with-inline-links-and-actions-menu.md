...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-b54103077fe282f9cb98536080d9bcd0

Catalog path: Application UI / lists / Stacked Lists / variant 4 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-04-with-inline-links-and-actions-menu` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `249` and `application-ui-lists-stacked-lists-04-with-inline-links-and-actions-menu` are the stable registry identity.
...
- Resolve `BlockId::from_index(249)`, or look up `application-ui-lists-stacked-lists-04-with-inline-links-and-actions-menu` with
...
- The registry resolves both block id `249` and slug `application-ui-lists-stacked-lists-04-with-inline-links-and-actions-menu` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-04-with-inline-links-and-actions-menu` story proves the fixture in both renderers.
