...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-784af9855cdd8881ae16194e1482b214

Catalog path: Application UI / elements / Buttons / variant 6 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-06-rounded-primary-buttons` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `491` and `application-ui-elements-buttons-06-rounded-primary-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(491)`, or look up `application-ui-elements-buttons-06-rounded-primary-buttons` with
...
- The registry resolves both block id `491` and slug `application-ui-elements-buttons-06-rounded-primary-buttons` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-06-rounded-primary-buttons` story proves the fixture in both renderers.
