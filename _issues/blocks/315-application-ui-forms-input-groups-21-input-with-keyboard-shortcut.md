...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-3fc95e81175349142e7e2111d303296c

Catalog path: Application UI / forms / Input Groups / variant 21 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-21-input-with-keyboard-shortcut` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `314` and `application-ui-forms-input-groups-21-input-with-keyboard-shortcut` are the stable registry identity.
...
- Resolve `BlockId::from_index(314)`, or look up `application-ui-forms-input-groups-21-input-with-keyboard-shortcut` with
...
- The registry resolves both block id `314` and slug `application-ui-forms-input-groups-21-input-with-keyboard-shortcut` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-21-input-with-keyboard-shortcut` story proves the fixture in both renderers.
