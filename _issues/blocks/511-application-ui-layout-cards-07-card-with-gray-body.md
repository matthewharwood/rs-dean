...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-87a1113483b8baaaedfc5b8db1533e18

Catalog path: Application UI / layout / Cards / variant 7 of 10

## TPM Outcome

Ship `application-ui-layout-cards-07-card-with-gray-body` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `510` and `application-ui-layout-cards-07-card-with-gray-body` are the stable registry identity.
...
- Resolve `BlockId::from_index(510)`, or look up `application-ui-layout-cards-07-card-with-gray-body` with
...
- The registry resolves both block id `510` and slug `application-ui-layout-cards-07-card-with-gray-body` one-to-one.
...
- An isolated `block-application-ui-layout-cards-07-card-with-gray-body` story proves the fixture in both renderers.
