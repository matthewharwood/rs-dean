...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-history#component-60810ad73ac10929b250e2198d7d83ee

Catalog path: Ecommerce / components / Order History / variant 4 of 4

## TPM Outcome

Ship `ecommerce-components-order-history-04-invoice-list-with-quick-actions` as a registered Rust-first block in the Order History family. Preserve
...
- Block index `618` and `ecommerce-components-order-history-04-invoice-list-with-quick-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(618)`, or look up `ecommerce-components-order-history-04-invoice-list-with-quick-actions` with
...
- The registry resolves both block id `618` and slug `ecommerce-components-order-history-04-invoice-list-with-quick-actions` one-to-one.
...
- An isolated `block-ecommerce-components-order-history-04-invoice-list-with-quick-actions` story proves the fixture in both renderers.
