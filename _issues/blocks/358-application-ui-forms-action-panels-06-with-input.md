...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/action-panels#component-8075122173e35cf62fda24f695faa863

Catalog path: Application UI / forms / Action Panels / variant 6 of 8

## TPM Outcome

Ship `application-ui-forms-action-panels-06-with-input` as a registered Rust-first block in the Action Panels family. Preserve
...
- Block index `357` and `application-ui-forms-action-panels-06-with-input` are the stable registry identity.
...
- Resolve `BlockId::from_index(357)`, or look up `application-ui-forms-action-panels-06-with-input` with
...
- The registry resolves both block id `357` and slug `application-ui-forms-action-panels-06-with-input` one-to-one.
...
- An isolated `block-application-ui-forms-action-panels-06-with-input` story proves the fixture in both renderers.
