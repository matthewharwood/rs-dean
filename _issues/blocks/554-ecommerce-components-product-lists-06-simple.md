...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-230be426f17b26e949896d17c505e0d3

Catalog path: Ecommerce / components / Product Lists / variant 6 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-06-simple` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `553` and `ecommerce-components-product-lists-06-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(553)`, or look up `ecommerce-components-product-lists-06-simple` with
...
- The registry resolves both block id `553` and slug `ecommerce-components-product-lists-06-simple` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-06-simple` story proves the fixture in both renderers.
