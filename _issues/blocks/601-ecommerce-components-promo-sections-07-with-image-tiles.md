...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-abf8794a557c496e493e847c71fc90c7

Catalog path: Ecommerce / components / Promo Sections / variant 7 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-07-with-image-tiles` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `600` and `ecommerce-components-promo-sections-07-with-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(600)`, or look up `ecommerce-components-promo-sections-07-with-image-tiles` with
...
- The registry resolves both block id `600` and slug `ecommerce-components-promo-sections-07-with-image-tiles` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-07-with-image-tiles` story proves the fixture in both renderers.
