...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/form-layouts#component-d45bd4ec6e473269c55d3ba084e1988d

Catalog path: Application UI / forms / Form Layouts / variant 2 of 4

## TPM Outcome

Ship `application-ui-forms-form-layouts-02-two-column` as a registered Rust-first block in the Form Layouts family. Preserve
...
- Block index `291` and `application-ui-forms-form-layouts-02-two-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(291)`, or look up `application-ui-forms-form-layouts-02-two-column` with
...
- The registry resolves both block id `291` and slug `application-ui-forms-form-layouts-02-two-column` one-to-one.
...
- An isolated `block-application-ui-forms-form-layouts-02-two-column` story proves the fixture in both renderers.
