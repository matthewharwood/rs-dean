...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-5d72b187beb968e12db89fe49f272b18

Catalog path: Application UI / lists / Grid Lists / variant 2 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-02-contact-cards` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `281` and `application-ui-lists-grid-lists-02-contact-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(281)`, or look up `application-ui-lists-grid-lists-02-contact-cards` with
...
- The registry resolves both block id `281` and slug `application-ui-lists-grid-lists-02-contact-cards` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-02-contact-cards` story proves the fixture in both renderers.
