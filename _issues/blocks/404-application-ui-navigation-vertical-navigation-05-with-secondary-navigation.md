...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-c62ff54939dc62098de8d38ebd671ec3

Catalog path: Application UI / navigation / Vertical Navigation / variant 5 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-05-with-secondary-navigation` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `403` and `application-ui-navigation-vertical-navigation-05-with-secondary-navigation` are the stable registry identity.
...
- Resolve `BlockId::from_index(403)`, or look up `application-ui-navigation-vertical-navigation-05-with-secondary-navigation` with
...
- The registry resolves both block id `403` and slug `application-ui-navigation-vertical-navigation-05-with-secondary-navigation` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-05-with-secondary-navigation` story proves the fixture in both renderers.
