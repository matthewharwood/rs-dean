...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/grid-lists#component-d6b6c178a9f460d37c542870139e940e

Catalog path: Application UI / lists / Grid Lists / variant 6 of 7

## TPM Outcome

Ship `application-ui-lists-grid-lists-06-images-with-details` as a registered Rust-first block in the Grid Lists family. Preserve
...
- Block index `285` and `application-ui-lists-grid-lists-06-images-with-details` are the stable registry identity.
...
- Resolve `BlockId::from_index(285)`, or look up `application-ui-lists-grid-lists-06-images-with-details` with
...
- The registry resolves both block id `285` and slug `application-ui-lists-grid-lists-06-images-with-details` one-to-one.
...
- An isolated `block-application-ui-lists-grid-lists-06-images-with-details` story proves the fixture in both renderers.
