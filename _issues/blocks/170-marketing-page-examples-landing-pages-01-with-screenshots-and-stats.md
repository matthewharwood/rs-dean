...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/landing-pages#component-62d05bbc8f76a3fa971ccf1bd8072b33

Catalog path: Marketing / page-examples / Landing Pages / variant 1 of 4

## TPM Outcome

Ship `marketing-page-examples-landing-pages-01-with-screenshots-and-stats` as a registered Rust-first block in the Landing Pages family. Preserve
...
- Block index `169` and `marketing-page-examples-landing-pages-01-with-screenshots-and-stats` are the stable registry identity.
...
- Resolve `BlockId::from_index(169)`, or look up `marketing-page-examples-landing-pages-01-with-screenshots-and-stats` with
...
- The registry resolves both block id `169` and slug `marketing-page-examples-landing-pages-01-with-screenshots-and-stats` one-to-one.
...
- An isolated `block-marketing-page-examples-landing-pages-01-with-screenshots-and-stats` story proves the fixture in both renderers.
