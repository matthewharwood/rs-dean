...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/textareas#component-784309f82e9913989c2196a2d47eff4a

Catalog path: Application UI / forms / Textareas / variant 2 of 5

## TPM Outcome

Ship `application-ui-forms-textareas-02-with-avatar-and-actions` as a registered Rust-first block in the Textareas family. Preserve
...
- Block index `327` and `application-ui-forms-textareas-02-with-avatar-and-actions` are the stable registry identity.
...
- The family maps to the `Form` composition pattern and the `Textarea`
  primary UI component.
- Variant behavior is constrained by `Avatar`, `Plain`, and `Form`
...
- Resolve `BlockId::from_index(327)`, or look up `application-ui-forms-textareas-02-with-avatar-and-actions` with
...
- The registry resolves both block id `327` and slug `application-ui-forms-textareas-02-with-avatar-and-actions` one-to-one.
...
- An isolated `block-application-ui-forms-textareas-02-with-avatar-and-actions` story proves the fixture in both renderers.
