...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-808cbad18cf839c49d9555882d35c18f

Catalog path: Marketing / sections / Header Sections / variant 6 of 8

## TPM Outcome

Ship `marketing-sections-header-06-simple-with-eyebrow` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `58` and `marketing-sections-header-06-simple-with-eyebrow` are the stable registry identity.
...
- Resolve `BlockId::from_index(58)`, or look up `marketing-sections-header-06-simple-with-eyebrow` with
...
- The registry resolves both block id `58` and slug `marketing-sections-header-06-simple-with-eyebrow` one-to-one.
...
- An isolated `block-marketing-sections-header-06-simple-with-eyebrow` story proves the fixture in both renderers.
