...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-overviews#component-7343b727d03bb437b9617fb26bf35021

Catalog path: Ecommerce / components / Product Overviews / variant 3 of 5

## TPM Outcome

Ship `ecommerce-components-product-overviews-03-split-with-image` as a registered Rust-first block in the Product Overviews family. Preserve
...
- Block index `545` and `ecommerce-components-product-overviews-03-split-with-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(545)`, or look up `ecommerce-components-product-overviews-03-split-with-image` with
...
- The registry resolves both block id `545` and slug `ecommerce-components-product-overviews-03-split-with-image` one-to-one.
...
- An isolated `block-ecommerce-components-product-overviews-03-split-with-image` story proves the fixture in both renderers.
