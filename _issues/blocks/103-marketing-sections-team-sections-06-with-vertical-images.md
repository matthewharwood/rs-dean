...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-38a360f41fbead05a12792c6c884c1df

Catalog path: Marketing / sections / Team Sections / variant 6 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-06-with-vertical-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `102` and `marketing-sections-team-sections-06-with-vertical-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(102)`, or look up `marketing-sections-team-sections-06-with-vertical-images` with
...
- The registry resolves both block id `102` and slug `marketing-sections-team-sections-06-with-vertical-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-06-with-vertical-images` story proves the fixture in both renderers.
