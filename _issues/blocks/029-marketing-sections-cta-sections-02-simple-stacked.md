...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-8f2857c2b9324bb3fe8b1c455438ae07

Catalog path: Marketing / sections / CTA Sections / variant 2 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-02-simple-stacked` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `28` and `marketing-sections-cta-sections-02-simple-stacked` are the stable registry identity.
...
- Resolve `BlockId::from_index(28)`, or look up `marketing-sections-cta-sections-02-simple-stacked` with
...
- The registry resolves both block id `28` and slug `marketing-sections-cta-sections-02-simple-stacked` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-02-simple-stacked` story proves the fixture in both renderers.
