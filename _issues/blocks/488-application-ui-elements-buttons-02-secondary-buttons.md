...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/buttons#component-9fc8ac3ded8cb313876bfa01742a0570

Catalog path: Application UI / elements / Buttons / variant 2 of 8

## TPM Outcome

Ship `application-ui-elements-buttons-02-secondary-buttons` as a registered Rust-first block in the Buttons family. Preserve
...
- Block index `487` and `application-ui-elements-buttons-02-secondary-buttons` are the stable registry identity.
...
- Resolve `BlockId::from_index(487)`, or look up `application-ui-elements-buttons-02-secondary-buttons` with
...
- The registry resolves both block id `487` and slug `application-ui-elements-buttons-02-secondary-buttons` one-to-one.
...
- An isolated `block-application-ui-elements-buttons-02-secondary-buttons` story proves the fixture in both renderers.
