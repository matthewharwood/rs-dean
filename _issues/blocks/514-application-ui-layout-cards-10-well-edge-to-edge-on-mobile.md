...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/cards#component-e66148dd50457260772a862602a7c103

Catalog path: Application UI / layout / Cards / variant 10 of 10

## TPM Outcome

Ship `application-ui-layout-cards-10-well-edge-to-edge-on-mobile` as a registered Rust-first block in the Cards family. Preserve
...
- Block index `513` and `application-ui-layout-cards-10-well-edge-to-edge-on-mobile` are the stable registry identity.
...
- Resolve `BlockId::from_index(513)`, or look up `application-ui-layout-cards-10-well-edge-to-edge-on-mobile` with
...
- The registry resolves both block id `513` and slug `application-ui-layout-cards-10-well-edge-to-edge-on-mobile` one-to-one.
...
- An isolated `block-application-ui-layout-cards-10-well-edge-to-edge-on-mobile` story proves the fixture in both renderers.
