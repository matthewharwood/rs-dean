...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/sidebar-navigation#component-d44069bcf27c14843b14e3d0da32b748

Catalog path: Application UI / navigation / Sidebar Navigation / variant 1 of 5

## TPM Outcome

Ship `application-ui-navigation-sidebar-navigation-01-light` as a registered Rust-first block in the Sidebar Navigation family. Preserve
...
- Block index `405` and `application-ui-navigation-sidebar-navigation-01-light` are the stable registry identity.
...
- Resolve `BlockId::from_index(405)`, or look up `application-ui-navigation-sidebar-navigation-01-light` with
...
- The registry resolves both block id `405` and slug `application-ui-navigation-sidebar-navigation-01-light` one-to-one.
...
- An isolated `block-application-ui-navigation-sidebar-navigation-01-light` story proves the fixture in both renderers.
