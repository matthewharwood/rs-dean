...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-lists#component-adec20dfa6eac091f5bee40e244c6823

Catalog path: Ecommerce / components / Product Lists / variant 1 of 11

## TPM Outcome

Ship `ecommerce-components-product-lists-01-with-inline-price` as a registered Rust-first block in the Product Lists family. Preserve
...
- Block index `548` and `ecommerce-components-product-lists-01-with-inline-price` are the stable registry identity.
...
- Resolve `BlockId::from_index(548)`, or look up `ecommerce-components-product-lists-01-with-inline-price` with
...
- The registry resolves both block id `548` and slug `ecommerce-components-product-lists-01-with-inline-price` one-to-one.
...
- An isolated `block-ecommerce-components-product-lists-01-with-inline-price` story proves the fixture in both renderers.
