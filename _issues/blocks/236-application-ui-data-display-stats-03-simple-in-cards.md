...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/stats#component-b4c225b72dcb3b747e6d6ffcf44b1a9d

Catalog path: Application UI / data-display / Stats / variant 3 of 5

## TPM Outcome

Ship `application-ui-data-display-stats-03-simple-in-cards` as a registered Rust-first block in the Stats family. Preserve
...
- Block index `235` and `application-ui-data-display-stats-03-simple-in-cards` are the stable registry identity.
...
- Resolve `BlockId::from_index(235)`, or look up `application-ui-data-display-stats-03-simple-in-cards` with
...
- The registry resolves both block id `235` and slug `application-ui-data-display-stats-03-simple-in-cards` one-to-one.
...
- An isolated `block-application-ui-data-display-stats-03-simple-in-cards` story proves the fixture in both renderers.
