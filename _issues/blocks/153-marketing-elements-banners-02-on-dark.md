...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/banners#component-1804a38735a4d6d0ade6c2bcf4ee3f6c

Catalog path: Marketing / elements / Banners / variant 2 of 13

## TPM Outcome

Ship `marketing-elements-banners-02-on-dark` as a registered Rust-first block in the Banners family. Preserve
...
- Block index `152` and `marketing-elements-banners-02-on-dark` are the stable registry identity.
...
- Resolve `BlockId::from_index(152)`, or look up `marketing-elements-banners-02-on-dark` with
...
- The registry resolves both block id `152` and slug `marketing-elements-banners-02-on-dark` one-to-one.
...
- An isolated `block-marketing-elements-banners-02-on-dark` story proves the fixture in both renderers.
