...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/faq-sections#component-1c3fc65e9a4924a065d231ea14f07e16

Catalog path: Marketing / sections / FAQs / variant 6 of 7

## TPM Outcome

Ship `marketing-sections-faq-sections-06-two-columns` as a registered Rust-first block in the FAQs family. Preserve
...
- Block index `124` and `marketing-sections-faq-sections-06-two-columns` are the stable registry identity.
...
- Resolve `BlockId::from_index(124)`, or look up `marketing-sections-faq-sections-06-two-columns` with
...
- The registry resolves both block id `124` and slug `marketing-sections-faq-sections-06-two-columns` one-to-one.
...
- An isolated `block-marketing-sections-faq-sections-06-two-columns` story proves the fixture in both renderers.
