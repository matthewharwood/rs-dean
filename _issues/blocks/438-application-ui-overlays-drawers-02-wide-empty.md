...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-5303c236f80366294c9871d49188c725

Catalog path: Application UI / overlays / Drawers / variant 2 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-02-wide-empty` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `437` and `application-ui-overlays-drawers-02-wide-empty` are the stable registry identity.
...
- Resolve `BlockId::from_index(437)`, or look up `application-ui-overlays-drawers-02-wide-empty` with
...
- The registry resolves both block id `437` and slug `application-ui-overlays-drawers-02-wide-empty` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-02-wide-empty` story proves the fixture in both renderers.
