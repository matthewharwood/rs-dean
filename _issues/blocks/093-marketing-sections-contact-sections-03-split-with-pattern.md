...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-d79585443456bd5ff4d0f8915f16458c

Catalog path: Marketing / sections / Contact Sections / variant 3 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-03-split-with-pattern` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `92` and `marketing-sections-contact-sections-03-split-with-pattern` are the stable registry identity.
...
- Resolve `BlockId::from_index(92)`, or look up `marketing-sections-contact-sections-03-split-with-pattern` with
...
- The registry resolves both block id `92` and slug `marketing-sections-contact-sections-03-split-with-pattern` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-03-split-with-pattern` story proves the fixture in both renderers.
