...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-f89a7babb527a1909590ce2fa868a45d

Catalog path: Application UI / overlays / Modal Dialogs / variant 4 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-04-simple-with-dismiss-button` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `433` and `application-ui-overlays-modal-dialogs-04-simple-with-dismiss-button` are the stable registry identity.
...
- Resolve `BlockId::from_index(433)`, or look up `application-ui-overlays-modal-dialogs-04-simple-with-dismiss-button` with
...
- The registry resolves both block id `433` and slug `application-ui-overlays-modal-dialogs-04-simple-with-dismiss-button` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-04-simple-with-dismiss-button` story proves the fixture in both renderers.
