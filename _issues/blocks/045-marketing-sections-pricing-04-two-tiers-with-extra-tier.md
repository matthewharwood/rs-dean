...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-e3a99fa65ed079374994c8d98ac55455

Catalog path: Marketing / sections / Pricing Sections / variant 4 of 12

## TPM Outcome

Ship `marketing-sections-pricing-04-two-tiers-with-extra-tier` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `44` and `marketing-sections-pricing-04-two-tiers-with-extra-tier` are the stable registry identity.
...
- Resolve `BlockId::from_index(44)`, or look up `marketing-sections-pricing-04-two-tiers-with-extra-tier` with
...
- The registry resolves both block id `44` and slug `marketing-sections-pricing-04-two-tiers-with-extra-tier` one-to-one.
...
- An isolated `block-marketing-sections-pricing-04-two-tiers-with-extra-tier` story proves the fixture in both renderers.
