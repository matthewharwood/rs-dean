...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/avatars#component-5451bd1088840221c9cf91dd02afdfbd

Catalog path: Application UI / elements / Avatars / variant 1 of 11

## TPM Outcome

Ship `application-ui-elements-avatars-01-circular-avatars` as a registered Rust-first block in the Avatars family. Preserve
...
- Block index `454` and `application-ui-elements-avatars-01-circular-avatars` are the stable registry identity.
...
- Resolve `BlockId::from_index(454)`, or look up `application-ui-elements-avatars-01-circular-avatars` with
...
- The registry resolves both block id `454` and slug `application-ui-elements-avatars-01-circular-avatars` one-to-one.
...
- An isolated `block-application-ui-elements-avatars-01-circular-avatars` story proves the fixture in both renderers.
