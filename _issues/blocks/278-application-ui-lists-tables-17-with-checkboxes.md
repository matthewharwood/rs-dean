...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/tables#component-390db22a862687fe88b313692989ffaf

Catalog path: Application UI / lists / Tables / variant 17 of 19

## TPM Outcome

Ship `application-ui-lists-tables-17-with-checkboxes` as a registered Rust-first block in the Tables family. Preserve
...
- Block index `277` and `application-ui-lists-tables-17-with-checkboxes` are the stable registry identity.
...
- Resolve `BlockId::from_index(277)`, or look up `application-ui-lists-tables-17-with-checkboxes` with
...
- The registry resolves both block id `277` and slug `application-ui-lists-tables-17-with-checkboxes` one-to-one.
...
- An isolated `block-application-ui-lists-tables-17-with-checkboxes` story proves the fixture in both renderers.
