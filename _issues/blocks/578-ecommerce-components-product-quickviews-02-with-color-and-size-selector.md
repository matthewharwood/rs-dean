...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-quickviews#component-8f33b33d19bbb2608bb5ae6488344e88

Catalog path: Ecommerce / components / Product Quickviews / variant 2 of 4

## TPM Outcome

Ship `ecommerce-components-product-quickviews-02-with-color-and-size-selector` as a registered Rust-first block in the Product Quickviews family. Preserve
...
- Block index `577` and `ecommerce-components-product-quickviews-02-with-color-and-size-selector` are the stable registry identity.
...
- Resolve `BlockId::from_index(577)`, or look up `ecommerce-components-product-quickviews-02-with-color-and-size-selector` with
...
- The registry resolves both block id `577` and slug `ecommerce-components-product-quickviews-02-with-color-and-size-selector` one-to-one.
...
- An isolated `block-ecommerce-components-product-quickviews-02-with-color-and-size-selector` story proves the fixture in both renderers.
