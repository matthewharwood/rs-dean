...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-4f0dd8497283578821e874e83a2de3a1

Catalog path: Ecommerce / components / Product Features / variant 8 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-08-with-square-images` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `587` and `ecommerce-components-product-features-08-with-square-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(587)`, or look up `ecommerce-components-product-features-08-with-square-images` with
...
- The registry resolves both block id `587` and slug `ecommerce-components-product-features-08-with-square-images` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-08-with-square-images` story proves the fixture in both renderers.
