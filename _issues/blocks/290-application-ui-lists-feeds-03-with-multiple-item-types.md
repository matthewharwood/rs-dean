...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/feeds#component-c7f3196b0f47862c91b15b9042d68d86

Catalog path: Application UI / lists / Feeds / variant 3 of 3

## TPM Outcome

Ship `application-ui-lists-feeds-03-with-multiple-item-types` as a registered Rust-first block in the Feeds family. Preserve
...
- Block index `289` and `application-ui-lists-feeds-03-with-multiple-item-types` are the stable registry identity.
...
- Resolve `BlockId::from_index(289)`, or look up `application-ui-lists-feeds-03-with-multiple-item-types` with
...
- The registry resolves both block id `289` and slug `application-ui-lists-feeds-03-with-multiple-item-types` one-to-one.
...
- An isolated `block-application-ui-lists-feeds-03-with-multiple-item-types` story proves the fixture in both renderers.
