...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-4b4787c037a2e3840ff410054004398e

Catalog path: Marketing / sections / CTA Sections / variant 11 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-11-with-image-tiles` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `37` and `marketing-sections-cta-sections-11-with-image-tiles` are the stable registry identity.
...
- Resolve `BlockId::from_index(37)`, or look up `marketing-sections-cta-sections-11-with-image-tiles` with
...
- The registry resolves both block id `37` and slug `marketing-sections-cta-sections-11-with-image-tiles` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-11-with-image-tiles` story proves the fixture in both renderers.
