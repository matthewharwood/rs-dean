...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/textareas#component-c8189b6993ca18e9955b370f741b763b

Catalog path: Application UI / forms / Textareas / variant 4 of 5

## TPM Outcome

Ship `application-ui-forms-textareas-04-with-title-and-pill-actions` as a registered Rust-first block in the Textareas family. Preserve
...
- Block index `329` and `application-ui-forms-textareas-04-with-title-and-pill-actions` are the stable registry identity.
...
- Resolve `BlockId::from_index(329)`, or look up `application-ui-forms-textareas-04-with-title-and-pill-actions` with
...
- The registry resolves both block id `329` and slug `application-ui-forms-textareas-04-with-title-and-pill-actions` one-to-one.
...
- An isolated `block-application-ui-forms-textareas-04-with-title-and-pill-actions` story proves the fixture in both renderers.
