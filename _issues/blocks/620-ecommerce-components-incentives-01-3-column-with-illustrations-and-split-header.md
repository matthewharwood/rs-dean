...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/incentives#component-8872b12a99b750e189f99b92c726ab75

Catalog path: Ecommerce / components / Incentives / variant 1 of 8

## TPM Outcome

Ship `ecommerce-components-incentives-01-3-column-with-illustrations-and-split-header` as a registered Rust-first block in the Incentives family. Preserve
...
- Block index `619` and `ecommerce-components-incentives-01-3-column-with-illustrations-and-split-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(619)`, or look up `ecommerce-components-incentives-01-3-column-with-illustrations-and-split-header` with
...
- The registry resolves both block id `619` and slug `ecommerce-components-incentives-01-3-column-with-illustrations-and-split-header` one-to-one.
...
- An isolated `block-ecommerce-components-incentives-01-3-column-with-illustrations-and-split-header` story proves the fixture in both renderers.
