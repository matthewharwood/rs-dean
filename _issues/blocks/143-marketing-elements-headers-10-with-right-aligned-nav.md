...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-732328363308a2daa1cb32f0247d481f

Catalog path: Marketing / elements / Headers / variant 10 of 11

## TPM Outcome

Ship `marketing-elements-headers-10-with-right-aligned-nav` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `142` and `marketing-elements-headers-10-with-right-aligned-nav` are the stable registry identity.
...
- Resolve `BlockId::from_index(142)`, or look up `marketing-elements-headers-10-with-right-aligned-nav` with
...
- The registry resolves both block id `142` and slug `marketing-elements-headers-10-with-right-aligned-nav` one-to-one.
...
- An isolated `block-marketing-elements-headers-10-with-right-aligned-nav` story proves the fixture in both renderers.
