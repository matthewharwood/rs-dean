...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-history-pages#component-7f9da4e72b3d63e5b35c43829f786ba0

Catalog path: Ecommerce / page-examples / Order History Pages / variant 1 of 5

## TPM Outcome

Ship `ecommerce-page-examples-order-history-pages-01-simple` as a registered Rust-first block in the Order History Pages family. Preserve
...
- Block index `652` and `ecommerce-page-examples-order-history-pages-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(652)`, or look up `ecommerce-page-examples-order-history-pages-01-simple` with
...
- The registry resolves both block id `652` and slug `ecommerce-page-examples-order-history-pages-01-simple` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-history-pages-01-simple` story proves the fixture in both renderers.
