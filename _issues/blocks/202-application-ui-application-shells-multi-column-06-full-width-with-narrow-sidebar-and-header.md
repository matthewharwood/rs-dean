...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-d447e3faf2d20feaf42f06c4cbbcd94a

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 6 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-06-full-width-with-narrow-sidebar-and-header` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
the source block's Shell composition intent while using original fixture
...
- Block index `201` and `application-ui-application-shells-multi-column-06-full-width-with-narrow-sidebar-and-header` are the stable registry identity.
...
- The family maps to the `Application shell` composition pattern and the `Resizable`
...
- Resolve `BlockId::from_index(201)`, or look up `application-ui-application-shells-multi-column-06-full-width-with-narrow-sidebar-and-header` with
...
- The registry resolves both block id `201` and slug `application-ui-application-shells-multi-column-06-full-width-with-narrow-sidebar-and-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-06-full-width-with-narrow-sidebar-and-header` story proves the fixture in both renderers.
