...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-25da9793d85eab488fced233a57c92ac

Catalog path: Application UI / overlays / Drawers / variant 11 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-11-contact-list-example` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `446` and `application-ui-overlays-drawers-11-contact-list-example` are the stable registry identity.
...
- Resolve `BlockId::from_index(446)`, or look up `application-ui-overlays-drawers-11-contact-list-example` with
...
- The registry resolves both block id `446` and slug `application-ui-overlays-drawers-11-contact-list-example` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-11-contact-list-example` story proves the fixture in both renderers.
