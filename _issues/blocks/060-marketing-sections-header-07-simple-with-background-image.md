...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/header#component-e3cd5935c8dfd5c207bed80c1bd04212

Catalog path: Marketing / sections / Header Sections / variant 7 of 8

## TPM Outcome

Ship `marketing-sections-header-07-simple-with-background-image` as a registered Rust-first block in the Header Sections family. Preserve
...
- Block index `59` and `marketing-sections-header-07-simple-with-background-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(59)`, or look up `marketing-sections-header-07-simple-with-background-image` with
...
- The registry resolves both block id `59` and slug `marketing-sections-header-07-simple-with-background-image` one-to-one.
...
- An isolated `block-marketing-sections-header-07-simple-with-background-image` story proves the fixture in both renderers.
