...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-filters#component-78dbef177d9356295464384a7cb39506

Catalog path: Ecommerce / components / Category Filters / variant 2 of 5

## TPM Outcome

Ship `ecommerce-components-category-filters-02-with-dropdown-product-filters` as a registered Rust-first block in the Category Filters family. Preserve
...
- Block index `572` and `ecommerce-components-category-filters-02-with-dropdown-product-filters` are the stable registry identity.
...
- Resolve `BlockId::from_index(572)`, or look up `ecommerce-components-category-filters-02-with-dropdown-product-filters` with
...
- The registry resolves both block id `572` and slug `ecommerce-components-category-filters-02-with-dropdown-product-filters` one-to-one.
...
- An isolated `block-ecommerce-components-category-filters-02-with-dropdown-product-filters` story proves the fixture in both renderers.
