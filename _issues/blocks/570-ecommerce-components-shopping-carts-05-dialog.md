...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/shopping-carts#component-42e57c3e003d7fc442e36e4d8cd3bc04

Catalog path: Ecommerce / components / Shopping Carts / variant 5 of 6

## TPM Outcome

Ship `ecommerce-components-shopping-carts-05-dialog` as a registered Rust-first block in the Shopping Carts family. Preserve
...
- Block index `569` and `ecommerce-components-shopping-carts-05-dialog` are the stable registry identity.
...
- Resolve `BlockId::from_index(569)`, or look up `ecommerce-components-shopping-carts-05-dialog` with
...
- The registry resolves both block id `569` and slug `ecommerce-components-shopping-carts-05-dialog` one-to-one.
...
- An isolated `block-ecommerce-components-shopping-carts-05-dialog` story proves the fixture in both renderers.
