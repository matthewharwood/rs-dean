...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/breadcrumbs#component-cefd3c7f07d7f9bf0d47537df6519f18

Catalog path: Application UI / navigation / Breadcrumbs / variant 1 of 4

## TPM Outcome

Ship `application-ui-navigation-breadcrumbs-01-contained` as a registered Rust-first block in the Breadcrumbs family. Preserve
...
- Block index `410` and `application-ui-navigation-breadcrumbs-01-contained` are the stable registry identity.
...
- Resolve `BlockId::from_index(410)`, or look up `application-ui-navigation-breadcrumbs-01-contained` with
...
- The registry resolves both block id `410` and slug `application-ui-navigation-breadcrumbs-01-contained` one-to-one.
...
- An isolated `block-application-ui-navigation-breadcrumbs-01-contained` story proves the fixture in both renderers.
