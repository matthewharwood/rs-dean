...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-38aa2491bf79a5bf705df14524ab7467

Catalog path: Marketing / sections / Pricing Sections / variant 2 of 12

## TPM Outcome

Ship `marketing-sections-pricing-02-two-tiers-with-emphasized-left-tier` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `42` and `marketing-sections-pricing-02-two-tiers-with-emphasized-left-tier` are the stable registry identity.
...
- Resolve `BlockId::from_index(42)`, or look up `marketing-sections-pricing-02-two-tiers-with-emphasized-left-tier` with
...
- The registry resolves both block id `42` and slug `marketing-sections-pricing-02-two-tiers-with-emphasized-left-tier` one-to-one.
...
- An isolated `block-marketing-sections-pricing-02-two-tiers-with-emphasized-left-tier` story proves the fixture in both renderers.
