...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/containers#component-e704df9a95d4642b3cb165a1b71f5171

Catalog path: Application UI / layout / Containers / variant 4 of 5

## TPM Outcome

Ship `application-ui-layout-containers-04-constrained-to-breakpoint-with-padded-content` as a registered Rust-first block in the Containers family. Preserve
...
- Block index `502` and `application-ui-layout-containers-04-constrained-to-breakpoint-with-padded-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(502)`, or look up `application-ui-layout-containers-04-constrained-to-breakpoint-with-padded-content` with
...
- The registry resolves both block id `502` and slug `application-ui-layout-containers-04-constrained-to-breakpoint-with-padded-content` one-to-one.
...
- An isolated `block-application-ui-layout-containers-04-constrained-to-breakpoint-with-padded-content` story proves the fixture in both renderers.
