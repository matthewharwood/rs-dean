...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/lists/stacked-lists#component-17cb2f5896306c57b00f6ac97fdae2b2

Catalog path: Application UI / lists / Stacked Lists / variant 15 of 15

## TPM Outcome

Ship `application-ui-lists-stacked-lists-15-narrow-with-badges` as a registered Rust-first block in the Stacked Lists family. Preserve
...
- Block index `260` and `application-ui-lists-stacked-lists-15-narrow-with-badges` are the stable registry identity.
...
- Resolve `BlockId::from_index(260)`, or look up `application-ui-lists-stacked-lists-15-narrow-with-badges` with
...
- The registry resolves both block id `260` and slug `application-ui-lists-stacked-lists-15-narrow-with-badges` one-to-one.
...
- An isolated `block-application-ui-lists-stacked-lists-15-narrow-with-badges` story proves the fixture in both renderers.
