...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-a3c09c7a3b8f4bd90d280722eaff9634

Catalog path: Marketing / sections / Hero Sections / variant 10 of 12

## TPM Outcome

Ship `marketing-sections-heroes-10-with-angled-image-on-right` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Block index `9` and `marketing-sections-heroes-10-with-angled-image-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(9)`, or look up `marketing-sections-heroes-10-with-angled-image-on-right` with
...
- The registry resolves both block id `9` and slug `marketing-sections-heroes-10-with-angled-image-on-right` one-to-one.
...
- An isolated `block-marketing-sections-heroes-10-with-angled-image-on-right` story proves the fixture in both renderers.
