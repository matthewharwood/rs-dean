...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-aa8136c1ee543132391e3a1753723305

Catalog path: Marketing / sections / Feature Sections / variant 4 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-04-simple-three-column-with-small-icons` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Block index `15` and `marketing-sections-feature-sections-04-simple-three-column-with-small-icons` are the stable registry identity.
...
- Resolve `BlockId::from_index(15)`, or look up `marketing-sections-feature-sections-04-simple-three-column-with-small-icons` with
...
- The registry resolves both block id `15` and slug `marketing-sections-feature-sections-04-simple-three-column-with-small-icons` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-04-simple-three-column-with-small-icons` story proves the fixture in both renderers.
