...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/tabs#component-aed2acb28998d158d7aa898cb19540e4

Catalog path: Application UI / navigation / Tabs / variant 2 of 9

## TPM Outcome

Ship `application-ui-navigation-tabs-02-tabs-with-underline-and-icons` as a registered Rust-first block in the Tabs family. Preserve
...
- Block index `391` and `application-ui-navigation-tabs-02-tabs-with-underline-and-icons` are the stable registry identity.
...
- Variant behavior is constrained by `Icon`, `Plain`, and `Tabs`
...
- Resolve `BlockId::from_index(391)`, or look up `application-ui-navigation-tabs-02-tabs-with-underline-and-icons` with
...
- The registry resolves both block id `391` and slug `application-ui-navigation-tabs-02-tabs-with-underline-and-icons` one-to-one.
...
- An isolated `block-application-ui-navigation-tabs-02-tabs-with-underline-and-icons` story proves the fixture in both renderers.
