...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/cta-sections#component-211a2608506db0061bc968f07b98d61c

Catalog path: Marketing / sections / CTA Sections / variant 6 of 11

## TPM Outcome

Ship `marketing-sections-cta-sections-06-simple-centered-on-brand` as a registered Rust-first block in the CTA Sections family. Preserve
...
- Block index `32` and `marketing-sections-cta-sections-06-simple-centered-on-brand` are the stable registry identity.
...
- The family maps to the `Call to action` composition pattern and the `Button`
  primary UI component.
- Variant behavior is constrained by `No media`, `Brand`, and `Actions`
...
- Resolve `BlockId::from_index(32)`, or look up `marketing-sections-cta-sections-06-simple-centered-on-brand` with
...
- The registry resolves both block id `32` and slug `marketing-sections-cta-sections-06-simple-centered-on-brand` one-to-one.
...
- An isolated `block-marketing-sections-cta-sections-06-simple-centered-on-brand` story proves the fixture in both renderers.
