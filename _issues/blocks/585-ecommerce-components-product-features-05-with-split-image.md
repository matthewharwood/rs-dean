...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-b0812584bac5ecc4394fec6afd7f3457

Catalog path: Ecommerce / components / Product Features / variant 5 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-05-with-split-image` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `584` and `ecommerce-components-product-features-05-with-split-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(584)`, or look up `ecommerce-components-product-features-05-with-split-image` with
...
- The registry resolves both block id `584` and slug `ecommerce-components-product-features-05-with-split-image` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-05-with-split-image` story proves the fixture in both renderers.
