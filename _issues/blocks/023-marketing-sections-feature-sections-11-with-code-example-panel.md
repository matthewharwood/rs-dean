...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/feature-sections#component-4e23c14650a67ade50d44e1fb670d42a

Catalog path: Marketing / sections / Feature Sections / variant 11 of 15

## TPM Outcome

Ship `marketing-sections-feature-sections-11-with-code-example-panel` as a registered Rust-first block in the Feature Sections family. Preserve
...
- Apply the typed `Code` media mode, `Panel` surface treatment, and
...
- Block index `22` and `marketing-sections-feature-sections-11-with-code-example-panel` are the stable registry identity.
...
- Variant behavior is constrained by `Code`, `Panel`, and `Actions`
...
- Resolve `BlockId::from_index(22)`, or look up `marketing-sections-feature-sections-11-with-code-example-panel` with
...
- The registry resolves both block id `22` and slug `marketing-sections-feature-sections-11-with-code-example-panel` one-to-one.
...
- An isolated `block-marketing-sections-feature-sections-11-with-code-example-panel` story proves the fixture in both renderers.
