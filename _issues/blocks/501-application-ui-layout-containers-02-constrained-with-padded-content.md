...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/layout/containers#component-633983e1e230752e046685c12c72a962

Catalog path: Application UI / layout / Containers / variant 2 of 5

## TPM Outcome

Ship `application-ui-layout-containers-02-constrained-with-padded-content` as a registered Rust-first block in the Containers family. Preserve
...
- Block index `500` and `application-ui-layout-containers-02-constrained-with-padded-content` are the stable registry identity.
...
- Resolve `BlockId::from_index(500)`, or look up `application-ui-layout-containers-02-constrained-with-padded-content` with
...
- The registry resolves both block id `500` and slug `application-ui-layout-containers-02-constrained-with-padded-content` one-to-one.
...
- An isolated `block-application-ui-layout-containers-02-constrained-with-padded-content` story proves the fixture in both renderers.
