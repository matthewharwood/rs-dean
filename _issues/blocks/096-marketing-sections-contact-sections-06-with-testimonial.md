...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-d54ccff38efc93e5d282eac05498ca5d

Catalog path: Marketing / sections / Contact Sections / variant 6 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-06-with-testimonial` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `95` and `marketing-sections-contact-sections-06-with-testimonial` are the stable registry identity.
...
- Resolve `BlockId::from_index(95)`, or look up `marketing-sections-contact-sections-06-with-testimonial` with
...
- The registry resolves both block id `95` and slug `marketing-sections-contact-sections-06-with-testimonial` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-06-with-testimonial` story proves the fixture in both renderers.
