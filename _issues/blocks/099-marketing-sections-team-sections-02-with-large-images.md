...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/team-sections#component-3e122aee81a11936f182380439051844

Catalog path: Marketing / sections / Team Sections / variant 2 of 9

## TPM Outcome

Ship `marketing-sections-team-sections-02-with-large-images` as a registered Rust-first block in the Team Sections family. Preserve
...
- Block index `98` and `marketing-sections-team-sections-02-with-large-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(98)`, or look up `marketing-sections-team-sections-02-with-large-images` with
...
- The registry resolves both block id `98` and slug `marketing-sections-team-sections-02-with-large-images` one-to-one.
...
- An isolated `block-marketing-sections-team-sections-02-with-large-images` story proves the fixture in both renderers.
