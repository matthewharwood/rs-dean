...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/footers#component-de25869ecf8c2903fbede9b3a7602adb

Catalog path: Marketing / sections / Footers / variant 1 of 7

## TPM Outcome

Ship `marketing-sections-footers-01-4-column-with-company-mission` as a registered Rust-first block in the Footers family. Preserve
...
- Block index `126` and `marketing-sections-footers-01-4-column-with-company-mission` are the stable registry identity.
...
- Resolve `BlockId::from_index(126)`, or look up `marketing-sections-footers-01-4-column-with-company-mission` with
...
- The registry resolves both block id `126` and slug `marketing-sections-footers-01-4-column-with-company-mission` one-to-one.
...
- An isolated `block-marketing-sections-footers-01-4-column-with-company-mission` story proves the fixture in both renderers.
