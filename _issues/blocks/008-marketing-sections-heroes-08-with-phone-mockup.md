...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/heroes#component-816bf20fe4e1cd0cc2fefabfa6a6732b

Catalog path: Marketing / sections / Hero Sections / variant 8 of 12

## TPM Outcome

Ship `marketing-sections-heroes-08-with-phone-mockup` as a registered Rust-first block in the Hero Sections family. Preserve
...
- Apply the typed `Mockup` media mode, `Plain` surface treatment, and
...
- Block index `7` and `marketing-sections-heroes-08-with-phone-mockup` are the stable registry identity.
...
- Variant behavior is constrained by `Mockup`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(7)`, or look up `marketing-sections-heroes-08-with-phone-mockup` with
...
- The registry resolves both block id `7` and slug `marketing-sections-heroes-08-with-phone-mockup` one-to-one.
...
- An isolated `block-marketing-sections-heroes-08-with-phone-mockup` story proves the fixture in both renderers.
