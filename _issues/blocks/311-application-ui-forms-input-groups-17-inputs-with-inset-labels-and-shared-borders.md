...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-9d8a37880933ef4ce973cc81853cc959

Catalog path: Application UI / forms / Input Groups / variant 17 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-17-inputs-with-inset-labels-and-shared-borders` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `310` and `application-ui-forms-input-groups-17-inputs-with-inset-labels-and-shared-borders` are the stable registry identity.
...
- Resolve `BlockId::from_index(310)`, or look up `application-ui-forms-input-groups-17-inputs-with-inset-labels-and-shared-borders` with
...
- The registry resolves both block id `310` and slug `application-ui-forms-input-groups-17-inputs-with-inset-labels-and-shared-borders` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-17-inputs-with-inset-labels-and-shared-borders` story proves the fixture in both renderers.
