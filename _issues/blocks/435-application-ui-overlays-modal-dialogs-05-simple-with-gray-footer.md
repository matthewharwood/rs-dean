...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/modal-dialogs#component-b6812b6c13fff16861f2645c4100ae5b

Catalog path: Application UI / overlays / Modal Dialogs / variant 5 of 6

## TPM Outcome

Ship `application-ui-overlays-modal-dialogs-05-simple-with-gray-footer` as a registered Rust-first block in the Modal Dialogs family. Preserve
...
- Block index `434` and `application-ui-overlays-modal-dialogs-05-simple-with-gray-footer` are the stable registry identity.
...
- Resolve `BlockId::from_index(434)`, or look up `application-ui-overlays-modal-dialogs-05-simple-with-gray-footer` with
...
- The registry resolves both block id `434` and slug `application-ui-overlays-modal-dialogs-05-simple-with-gray-footer` one-to-one.
...
- An isolated `block-application-ui-overlays-modal-dialogs-05-simple-with-gray-footer` story proves the fixture in both renderers.
