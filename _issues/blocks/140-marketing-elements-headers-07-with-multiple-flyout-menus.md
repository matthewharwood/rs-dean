...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/elements/headers#component-6f74644bcfda42fc3d6735054d46bbe1

Catalog path: Marketing / elements / Headers / variant 7 of 11

## TPM Outcome

Ship `marketing-elements-headers-07-with-multiple-flyout-menus` as a registered Rust-first block in the Headers family. Preserve
...
- Block index `139` and `marketing-elements-headers-07-with-multiple-flyout-menus` are the stable registry identity.
...
- Resolve `BlockId::from_index(139)`, or look up `marketing-elements-headers-07-with-multiple-flyout-menus` with
...
- The registry resolves both block id `139` and slug `marketing-elements-headers-07-with-multiple-flyout-menus` one-to-one.
...
- An isolated `block-marketing-elements-headers-07-with-multiple-flyout-menus` story proves the fixture in both renderers.
