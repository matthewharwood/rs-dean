...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/pricing#component-4a9182e85945751476472f12356adb68

Catalog path: Marketing / sections / Pricing Sections / variant 1 of 12

## TPM Outcome

Ship `marketing-sections-pricing-01-two-tiers-with-emphasized-right-tier` as a registered Rust-first block in the Pricing Sections family. Preserve
...
- Block index `41` and `marketing-sections-pricing-01-two-tiers-with-emphasized-right-tier` are the stable registry identity.
...
- Resolve `BlockId::from_index(41)`, or look up `marketing-sections-pricing-01-two-tiers-with-emphasized-right-tier` with
...
- The registry resolves both block id `41` and slug `marketing-sections-pricing-01-two-tiers-with-emphasized-right-tier` one-to-one.
...
- An isolated `block-marketing-sections-pricing-01-two-tiers-with-emphasized-right-tier` story proves the fixture in both renderers.
