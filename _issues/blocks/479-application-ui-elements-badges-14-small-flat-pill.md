...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/elements/badges#component-5b4600a7bccf95d0114406dafe3e6a99

Catalog path: Application UI / elements / Badges / variant 14 of 16

## TPM Outcome

Ship `application-ui-elements-badges-14-small-flat-pill` as a registered Rust-first block in the Badges family. Preserve
...
- Block index `478` and `application-ui-elements-badges-14-small-flat-pill` are the stable registry identity.
...
- Resolve `BlockId::from_index(478)`, or look up `application-ui-elements-badges-14-small-flat-pill` with
...
- The registry resolves both block id `478` and slug `application-ui-elements-badges-14-small-flat-pill` one-to-one.
...
- An isolated `block-application-ui-elements-badges-14-small-flat-pill` story proves the fixture in both renderers.
