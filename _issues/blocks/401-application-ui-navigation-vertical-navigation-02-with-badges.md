...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-2f1545962f702a1dd6c9b697238fcae3

Catalog path: Application UI / navigation / Vertical Navigation / variant 2 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-02-with-badges` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `400` and `application-ui-navigation-vertical-navigation-02-with-badges` are the stable registry identity.
...
- Resolve `BlockId::from_index(400)`, or look up `application-ui-navigation-vertical-navigation-02-with-badges` with
...
- The registry resolves both block id `400` and slug `application-ui-navigation-vertical-navigation-02-with-badges` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-02-with-badges` story proves the fixture in both renderers.
