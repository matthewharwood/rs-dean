...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/sidebar#component-c91f624f7c6bcae840b9d674e343cc04

Catalog path: Application UI / application-shells / Sidebar Layouts / variant 3 of 8

## TPM Outcome

Ship `application-ui-application-shells-sidebar-03-sidebar-with-header` as a registered Rust-first block in the Sidebar Layouts family. Preserve
...
- Block index `190` and `application-ui-application-shells-sidebar-03-sidebar-with-header` are the stable registry identity.
...
- Resolve `BlockId::from_index(190)`, or look up `application-ui-application-shells-sidebar-03-sidebar-with-header` with
...
- The registry resolves both block id `190` and slug `application-ui-application-shells-sidebar-03-sidebar-with-header` one-to-one.
...
- An isolated `block-application-ui-application-shells-sidebar-03-sidebar-with-header` story proves the fixture in both renderers.
