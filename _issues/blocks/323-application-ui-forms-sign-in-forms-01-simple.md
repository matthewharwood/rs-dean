...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/sign-in-forms#component-766a0bf1b8800d383b6c5b77ef9c626c

Catalog path: Application UI / forms / Sign-in and Registration / variant 1 of 4

## TPM Outcome

Ship `application-ui-forms-sign-in-forms-01-simple` as a registered Rust-first block in the Sign-in and Registration family. Preserve
...
- Block index `322` and `application-ui-forms-sign-in-forms-01-simple` are the stable registry identity.
...
- Resolve `BlockId::from_index(322)`, or look up `application-ui-forms-sign-in-forms-01-simple` with
...
- The registry resolves both block id `322` and slug `application-ui-forms-sign-in-forms-01-simple` one-to-one.
...
- An isolated `block-application-ui-forms-sign-in-forms-01-simple` story proves the fixture in both renderers.
