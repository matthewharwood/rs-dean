...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/promo-sections#component-ee14c0a9f10545dd1890a634f8e9e586

Catalog path: Ecommerce / components / Promo Sections / variant 4 of 8

## TPM Outcome

Ship `ecommerce-components-promo-sections-04-with-background-image` as a registered Rust-first block in the Promo Sections family. Preserve
...
- Block index `597` and `ecommerce-components-promo-sections-04-with-background-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(597)`, or look up `ecommerce-components-promo-sections-04-with-background-image` with
...
- The registry resolves both block id `597` and slug `ecommerce-components-promo-sections-04-with-background-image` one-to-one.
...
- An isolated `block-ecommerce-components-promo-sections-04-with-background-image` story proves the fixture in both renderers.
