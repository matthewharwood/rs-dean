...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/order-summaries#component-185f77841af956ad40cacf1595ea51ed

Catalog path: Ecommerce / components / Order Summaries / variant 3 of 4

## TPM Outcome

Ship `ecommerce-components-order-summaries-03-with-large-images-and-progress-bars` as a registered Rust-first block in the Order Summaries family. Preserve
...
- Block index `613` and `ecommerce-components-order-summaries-03-with-large-images-and-progress-bars` are the stable registry identity.
...
- The family maps to the `Commerce summary` composition pattern and the `Table`
...
- Resolve `BlockId::from_index(613)`, or look up `ecommerce-components-order-summaries-03-with-large-images-and-progress-bars` with
...
- The registry resolves both block id `613` and slug `ecommerce-components-order-summaries-03-with-large-images-and-progress-bars` one-to-one.
...
- An isolated `block-ecommerce-components-order-summaries-03-with-large-images-and-progress-bars` story proves the fixture in both renderers.
