...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/feedback/alerts#component-2839a6e6678180cc64af7d5a1c96dae2

Catalog path: Application UI / feedback / Alerts / variant 5 of 6

## TPM Outcome

Ship `application-ui-feedback-alerts-05-with-accent-border` as a registered Rust-first block in the Alerts family. Preserve
...
- Block index `368` and `application-ui-feedback-alerts-05-with-accent-border` are the stable registry identity.
...
- Resolve `BlockId::from_index(368)`, or look up `application-ui-feedback-alerts-05-with-accent-border` with
...
- The registry resolves both block id `368` and slug `application-ui-feedback-alerts-05-with-accent-border` one-to-one.
...
- An isolated `block-application-ui-feedback-alerts-05-with-accent-border` story proves the fixture in both renderers.
