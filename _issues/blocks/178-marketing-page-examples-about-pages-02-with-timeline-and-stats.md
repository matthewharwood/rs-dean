...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/page-examples/about-pages#component-b99f4e0ab650993f48cbf8f990ceb030

Catalog path: Marketing / page-examples / About Pages / variant 2 of 3

## TPM Outcome

Ship `marketing-page-examples-about-pages-02-with-timeline-and-stats` as a registered Rust-first block in the About Pages family. Preserve
...
- Block index `177` and `marketing-page-examples-about-pages-02-with-timeline-and-stats` are the stable registry identity.
...
- Resolve `BlockId::from_index(177)`, or look up `marketing-page-examples-about-pages-02-with-timeline-and-stats` with
...
- The registry resolves both block id `177` and slug `marketing-page-examples-about-pages-02-with-timeline-and-stats` one-to-one.
...
- An isolated `block-marketing-page-examples-about-pages-02-with-timeline-and-stats` story proves the fixture in both renderers.
