...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/application-shells/multi-column#component-aa0e4b496e24d741e984c820f5e938ba

Catalog path: Application UI / application-shells / Multi-Column Layouts / variant 1 of 6

## TPM Outcome

Ship `application-ui-application-shells-multi-column-01-full-width-three-column` as a registered Rust-first block in the Multi-Column Layouts family. Preserve
...
- Block index `196` and `application-ui-application-shells-multi-column-01-full-width-three-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(196)`, or look up `application-ui-application-shells-multi-column-01-full-width-three-column` with
...
- The registry resolves both block id `196` and slug `application-ui-application-shells-multi-column-01-full-width-three-column` one-to-one.
...
- An isolated `block-application-ui-application-shells-multi-column-01-full-width-three-column` story proves the fixture in both renderers.
