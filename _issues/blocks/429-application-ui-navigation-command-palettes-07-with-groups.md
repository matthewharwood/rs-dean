...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/command-palettes#component-16ca10c78340e94c4075a7c7d8af3c73

Catalog path: Application UI / navigation / Command Palettes / variant 7 of 8

## TPM Outcome

Ship `application-ui-navigation-command-palettes-07-with-groups` as a registered Rust-first block in the Command Palettes family. Preserve
...
- Block index `428` and `application-ui-navigation-command-palettes-07-with-groups` are the stable registry identity.
...
- Resolve `BlockId::from_index(428)`, or look up `application-ui-navigation-command-palettes-07-with-groups` with
...
- The registry resolves both block id `428` and slug `application-ui-navigation-command-palettes-07-with-groups` one-to-one.
...
- An isolated `block-application-ui-navigation-command-palettes-07-with-groups` story proves the fixture in both renderers.
