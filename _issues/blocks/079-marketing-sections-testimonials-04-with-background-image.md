...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/testimonials#component-c0a962fe19bbce39773ad989fe2d672e

Catalog path: Marketing / sections / Testimonials / variant 4 of 8

## TPM Outcome

Ship `marketing-sections-testimonials-04-with-background-image` as a registered Rust-first block in the Testimonials family. Preserve
...
- Block index `78` and `marketing-sections-testimonials-04-with-background-image` are the stable registry identity.
...
- Resolve `BlockId::from_index(78)`, or look up `marketing-sections-testimonials-04-with-background-image` with
...
- The registry resolves both block id `78` and slug `marketing-sections-testimonials-04-with-background-image` one-to-one.
...
- An isolated `block-marketing-sections-testimonials-04-with-background-image` story proves the fixture in both renderers.
