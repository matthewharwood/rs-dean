...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/checkboxes#component-28fc3a7039fe5a86455d33e8e988aa8c

Catalog path: Application UI / forms / Checkboxes / variant 3 of 4

## TPM Outcome

Ship `application-ui-forms-checkboxes-03-list-with-checkbox-on-right` as a registered Rust-first block in the Checkboxes family. Preserve
...
- Block index `345` and `application-ui-forms-checkboxes-03-list-with-checkbox-on-right` are the stable registry identity.
...
- Resolve `BlockId::from_index(345)`, or look up `application-ui-forms-checkboxes-03-list-with-checkbox-on-right` with
...
- The registry resolves both block id `345` and slug `application-ui-forms-checkboxes-03-list-with-checkbox-on-right` one-to-one.
...
- An isolated `block-application-ui-forms-checkboxes-03-list-with-checkbox-on-right` story proves the fixture in both renderers.
