...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/navigation/vertical-navigation#component-d6311f175e19add0c4342eb7602ec96c

Catalog path: Application UI / navigation / Vertical Navigation / variant 4 of 6

## TPM Outcome

Ship `application-ui-navigation-vertical-navigation-04-with-icons` as a registered Rust-first block in the Vertical Navigation family. Preserve
...
- Block index `402` and `application-ui-navigation-vertical-navigation-04-with-icons` are the stable registry identity.
...
- Resolve `BlockId::from_index(402)`, or look up `application-ui-navigation-vertical-navigation-04-with-icons` with
...
- The registry resolves both block id `402` and slug `application-ui-navigation-vertical-navigation-04-with-icons` one-to-one.
...
- An isolated `block-application-ui-navigation-vertical-navigation-04-with-icons` story proves the fixture in both renderers.
