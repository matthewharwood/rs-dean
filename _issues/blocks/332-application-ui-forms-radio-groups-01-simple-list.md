...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/radio-groups#component-3e0576bb094c36161a958147cc707087

Catalog path: Application UI / forms / Radio Groups / variant 1 of 12

## TPM Outcome

Ship `application-ui-forms-radio-groups-01-simple-list` as a registered Rust-first block in the Radio Groups family. Preserve
...
- Block index `331` and `application-ui-forms-radio-groups-01-simple-list` are the stable registry identity.
...
- Resolve `BlockId::from_index(331)`, or look up `application-ui-forms-radio-groups-01-simple-list` with
...
- The registry resolves both block id `331` and slug `application-ui-forms-radio-groups-01-simple-list` one-to-one.
...
- An isolated `block-application-ui-forms-radio-groups-01-simple-list` story proves the fixture in both renderers.
