...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/order-detail-pages#component-89683d365a02eb6471d273845e344403

Catalog path: Ecommerce / page-examples / Order Detail Pages / variant 1 of 3

## TPM Outcome

Ship `ecommerce-page-examples-order-detail-pages-01-with-progress-bars` as a registered Rust-first block in the Order Detail Pages family. Preserve
...
- Block index `649` and `ecommerce-page-examples-order-detail-pages-01-with-progress-bars` are the stable registry identity.
...
- Resolve `BlockId::from_index(649)`, or look up `ecommerce-page-examples-order-detail-pages-01-with-progress-bars` with
...
- The registry resolves both block id `649` and slug `ecommerce-page-examples-order-detail-pages-01-with-progress-bars` one-to-one.
...
- An isolated `block-ecommerce-page-examples-order-detail-pages-01-with-progress-bars` story proves the fixture in both renderers.
