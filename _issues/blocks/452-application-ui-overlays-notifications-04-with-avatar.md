...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/notifications#component-c1ce1d3e4b7269f8da91ec959046c395

Catalog path: Application UI / overlays / Notifications / variant 4 of 6

## TPM Outcome

Ship `application-ui-overlays-notifications-04-with-avatar` as a registered Rust-first block in the Notifications family. Preserve
...
- Block index `451` and `application-ui-overlays-notifications-04-with-avatar` are the stable registry identity.
...
- Variant behavior is constrained by `Avatar`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(451)`, or look up `application-ui-overlays-notifications-04-with-avatar` with
...
- The registry resolves both block id `451` and slug `application-ui-overlays-notifications-04-with-avatar` one-to-one.
...
- An isolated `block-application-ui-overlays-notifications-04-with-avatar` story proves the fixture in both renderers.
