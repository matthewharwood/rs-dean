...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/page-examples/shopping-cart-pages#component-892edc8837628a6df55b8d42a4a5dbbf

Catalog path: Ecommerce / page-examples / Shopping Cart Pages / variant 1 of 3

## TPM Outcome

Ship `ecommerce-page-examples-shopping-cart-pages-01-with-related-products` as a registered Rust-first block in the Shopping Cart Pages family. Preserve
...
- Block index `641` and `ecommerce-page-examples-shopping-cart-pages-01-with-related-products` are the stable registry identity.
...
- Resolve `BlockId::from_index(641)`, or look up `ecommerce-page-examples-shopping-cart-pages-01-with-related-products` with
...
- The registry resolves both block id `641` and slug `ecommerce-page-examples-shopping-cart-pages-01-with-related-products` one-to-one.
...
- An isolated `block-ecommerce-page-examples-shopping-cart-pages-01-with-related-products` story proves the fixture in both renderers.
