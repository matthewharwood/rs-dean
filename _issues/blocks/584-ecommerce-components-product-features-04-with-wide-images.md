...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/product-features#component-62a074f00354815a5363c0bd268d64c6

Catalog path: Ecommerce / components / Product Features / variant 4 of 9

## TPM Outcome

Ship `ecommerce-components-product-features-04-with-wide-images` as a registered Rust-first block in the Product Features family. Preserve
...
- Block index `583` and `ecommerce-components-product-features-04-with-wide-images` are the stable registry identity.
...
- Resolve `BlockId::from_index(583)`, or look up `ecommerce-components-product-features-04-with-wide-images` with
...
- The registry resolves both block id `583` and slug `ecommerce-components-product-features-04-with-wide-images` one-to-one.
...
- An isolated `block-ecommerce-components-product-features-04-with-wide-images` story proves the fixture in both renderers.
