...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/description-lists#component-28307805860d15f5b930e5adbdf7287a

Catalog path: Application UI / data-display / Description Lists / variant 3 of 6

## TPM Outcome

Ship `application-ui-data-display-description-lists-03-left-aligned-striped` as a registered Rust-first block in the Description Lists family. Preserve
...
- Block index `229` and `application-ui-data-display-description-lists-03-left-aligned-striped` are the stable registry identity.
...
- Resolve `BlockId::from_index(229)`, or look up `application-ui-data-display-description-lists-03-left-aligned-striped` with
...
- The registry resolves both block id `229` and slug `application-ui-data-display-description-lists-03-left-aligned-striped` one-to-one.
...
- An isolated `block-application-ui-data-display-description-lists-03-left-aligned-striped` story proves the fixture in both renderers.
