...
Source: https://tailwindcss.com/plus/ui-blocks/ecommerce/components/category-previews#component-2ddbae849fc5ea4b75d75509101c14f5

Catalog path: Ecommerce / components / Category Previews / variant 4 of 6

## TPM Outcome

Ship `ecommerce-components-category-previews-04-three-column-with-description` as a registered Rust-first block in the Category Previews family. Preserve
...
- Block index `562` and `ecommerce-components-category-previews-04-three-column-with-description` are the stable registry identity.
...
- Variant behavior is constrained by `No media`, `Plain`, and `Actions`
...
- Resolve `BlockId::from_index(562)`, or look up `ecommerce-components-category-previews-04-three-column-with-description` with
...
- The registry resolves both block id `562` and slug `ecommerce-components-category-previews-04-three-column-with-description` one-to-one.
...
- An isolated `block-ecommerce-components-category-previews-04-three-column-with-description` story proves the fixture in both renderers.
