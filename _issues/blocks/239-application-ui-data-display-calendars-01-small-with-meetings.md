...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/data-display/calendars#component-c6e8b2bf7f65e8987b7012d3bbe5caf1

Catalog path: Application UI / data-display / Calendars / variant 1 of 8

## TPM Outcome

Ship `application-ui-data-display-calendars-01-small-with-meetings` as a registered Rust-first block in the Calendars family. Preserve
...
- Block index `238` and `application-ui-data-display-calendars-01-small-with-meetings` are the stable registry identity.
...
- Resolve `BlockId::from_index(238)`, or look up `application-ui-data-display-calendars-01-small-with-meetings` with
...
- The registry resolves both block id `238` and slug `application-ui-data-display-calendars-01-small-with-meetings` one-to-one.
...
- An isolated `block-application-ui-data-display-calendars-01-small-with-meetings` story proves the fixture in both renderers.
