...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/overlays/drawers#component-0f117af9905c6bf010968e396f2c7583

Catalog path: Application UI / overlays / Drawers / variant 4 of 12

## TPM Outcome

Ship `application-ui-overlays-drawers-04-with-close-button-on-outside` as a registered Rust-first block in the Drawers family. Preserve
...
- Block index `439` and `application-ui-overlays-drawers-04-with-close-button-on-outside` are the stable registry identity.
...
- Resolve `BlockId::from_index(439)`, or look up `application-ui-overlays-drawers-04-with-close-button-on-outside` with
...
- The registry resolves both block id `439` and slug `application-ui-overlays-drawers-04-with-close-button-on-outside` one-to-one.
...
- An isolated `block-application-ui-overlays-drawers-04-with-close-button-on-outside` story proves the fixture in both renderers.
