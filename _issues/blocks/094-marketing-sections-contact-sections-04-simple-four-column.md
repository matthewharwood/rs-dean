...
Source: https://tailwindcss.com/plus/ui-blocks/marketing/sections/contact-sections#component-1a48413a7b6b49af32a9b2a75de4c0e8

Catalog path: Marketing / sections / Contact Sections / variant 4 of 7

## TPM Outcome

Ship `marketing-sections-contact-sections-04-simple-four-column` as a registered Rust-first block in the Contact Sections family. Preserve
...
- Block index `93` and `marketing-sections-contact-sections-04-simple-four-column` are the stable registry identity.
...
- Resolve `BlockId::from_index(93)`, or look up `marketing-sections-contact-sections-04-simple-four-column` with
...
- The registry resolves both block id `93` and slug `marketing-sections-contact-sections-04-simple-four-column` one-to-one.
...
- An isolated `block-marketing-sections-contact-sections-04-simple-four-column` story proves the fixture in both renderers.
