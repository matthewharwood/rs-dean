...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/headings/page-headings#component-8a687a46760e105177d4a4ed39ae6d27

Catalog path: Application UI / headings / Page Headings / variant 2 of 9

## TPM Outcome

Ship `application-ui-headings-page-headings-02-with-actions-and-breadcrumbs` as a registered Rust-first block in the Page Headings family. Preserve
...
- Block index `203` and `application-ui-headings-page-headings-02-with-actions-and-breadcrumbs` are the stable registry identity.
...
- Resolve `BlockId::from_index(203)`, or look up `application-ui-headings-page-headings-02-with-actions-and-breadcrumbs` with
...
- The registry resolves both block id `203` and slug `application-ui-headings-page-headings-02-with-actions-and-breadcrumbs` one-to-one.
...
- An isolated `block-application-ui-headings-page-headings-02-with-actions-and-breadcrumbs` story proves the fixture in both renderers.
