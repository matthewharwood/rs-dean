...
Source: https://tailwindcss.com/plus/ui-blocks/application-ui/forms/input-groups#component-474bd025b849b44eb3c46df09a496b7a

Catalog path: Application UI / forms / Input Groups / variant 8 of 21

## TPM Outcome

Ship `application-ui-forms-input-groups-08-input-with-trailing-icon` as a registered Rust-first block in the Input Groups family. Preserve
...
- Block index `301` and `application-ui-forms-input-groups-08-input-with-trailing-icon` are the stable registry identity.
...
- Resolve `BlockId::from_index(301)`, or look up `application-ui-forms-input-groups-08-input-with-trailing-icon` with
...
- The registry resolves both block id `301` and slug `application-ui-forms-input-groups-08-input-with-trailing-icon` one-to-one.
...
- An isolated `block-application-ui-forms-input-groups-08-input-with-trailing-icon` story proves the fixture in both renderers.
