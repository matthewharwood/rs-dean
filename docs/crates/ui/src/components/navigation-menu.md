...
isolated story route so this page only shows Navigation Menu examples.

<iframe title="Navigation Menu live story fixtures" src="../../../stories/?story=ui-navigation-menu" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
