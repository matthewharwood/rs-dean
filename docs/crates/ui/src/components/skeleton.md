...
isolated story route so this page only shows Skeleton examples.

<iframe title="Skeleton live story fixtures" src="../../../stories/?story=ui-skeleton" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>

Open the [full stories page](../../../stories/#ui-skeleton) when a wider canvas is
needed.
