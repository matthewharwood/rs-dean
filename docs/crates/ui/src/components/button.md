...
<iframe title="Button live story fixtures" src="../../../stories/#ui-button" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
