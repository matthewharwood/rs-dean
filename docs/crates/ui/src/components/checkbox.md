...
isolated story route so this page only shows Checkbox examples.

<iframe title="Checkbox live story fixtures" src="../../../stories/?story=ui-checkbox" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>

Open the [full stories page](../../../stories/#ui-checkbox) when a wider canvas is
needed.
