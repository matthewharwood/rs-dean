...
isolated story route so this page only shows Message Scroller examples.

<iframe title="Message Scroller live story fixtures" src="../../../stories/?story=ui-message-scroller" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
