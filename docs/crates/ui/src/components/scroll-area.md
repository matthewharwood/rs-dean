...
isolated story route so this page only shows Scroll Area examples.

<iframe title="Scroll Area live story fixtures" src="../../../stories/?story=ui-scroll-area" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
