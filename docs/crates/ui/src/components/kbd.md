...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(20rem, 1fr)); gap: 1rem; align-items: start;">
  <section>
    ...
    <iframe title="Kbd Leptos live story fixtures" src="../../../stories/?story=ui-kbd" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
  </section>
  <section>
    <h3>Bevy Primitive Story</h3>
    <iframe title="Kbd Bevy primitive story fixtures" src="../../../ui-bevy-stories/?story=ui-kbd" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
  </section>
</div>

Open the [full Leptos stories page](../../../stories/#ui-kbd) or the
[full Bevy story page](../../../ui-bevy-stories/?story=ui-kbd) when a wider
canvas is needed.
