...
isolated story route so this page only shows Marker examples.

<iframe title="Marker live story fixtures" src="../../../stories/?story=ui-marker" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
