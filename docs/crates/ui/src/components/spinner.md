...
isolated story route so this page only shows Spinner examples.

<iframe title="Spinner live story fixtures" src="../../../stories/?story=ui-spinner" loading="lazy" style="width: 100%; min-height: 44rem; border: 1px solid #d0d7de; border-radius: 8px;"></iframe>
